...
/*  94 */     ManagedObjectManager result = stringCons.create(new Object[] { domain });
/*  95 */     if (result == null) {
...
/* 116 */     ManagedObjectManager result = objectNameCons.create(new Object[] { rootParentName });
/* 117 */     if (result == null) {
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\org\glassfish\gmbal\ManagedObjectManagerFactory.class
