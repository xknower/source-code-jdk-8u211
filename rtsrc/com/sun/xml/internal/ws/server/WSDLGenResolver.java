...
/* 100 */     this.concreteWsdlSource = SDDocumentSource.create(url, xsb);
...
/* 134 */       filename.value = (T)this.abstractWsdl.getURL().toString();
/* 135 */       return null;
/*     */     } 
...
/* 140 */     SDDocumentSource abstractWsdlSource = SDDocumentSource.create(url, xsb);
...
/*     */       }
/*     */       
/* 162 */       filename.value = (T)((SDDocumentImpl)schemas.get(0)).getURL().toExternalForm();
/* 163 */       return null;
/*     */     } 
/*     */     
...
/* 169 */     SDDocumentSource sd = SDDocumentSource.create(url, xsb);
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\ws\server\WSDLGenResolver.class
