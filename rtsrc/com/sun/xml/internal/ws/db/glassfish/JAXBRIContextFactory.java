...
/*  65 */     Class[] classes = (Class[])bi.contentClasses().<Class<?>[]>toArray((Class<?>[][])new Class[bi.contentClasses().size()]);
...
/*     */     
/*     */     try {
/*  83 */       JAXBRIContext context = (jaxbContextFactory != null) ? jaxbContextFactory.createJAXBContext(bi.getSEIModel(), toList(classes), toList(typeInfoMappings.values())) : ContextFactory.createContext(classes, typeInfoMappings
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\ws\db\glassfish\JAXBRIContextFactory.class
