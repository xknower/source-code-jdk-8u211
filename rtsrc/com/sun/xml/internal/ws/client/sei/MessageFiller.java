...
/* 126 */       Attachment att = new ByteArrayAttachment(contentId, (byte[])obj, this.mimeType);
...
/* 151 */       Attachment att = new JAXBAttachment(contentId, obj, this.param.getXMLBridge(), this.mimeType);
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\ws\client\sei\MessageFiller.class
