...
/*  85 */       return new WsaTubeHelperImpl(wsdlPort, seiModel, binding);
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public WsaTubeHelper getWsaHelper(WSDLPort wsdlPort, SEIModel seiModel, WSBinding binding) {
/* 166 */       return new WsaTubeHelperImpl(wsdlPort, seiModel, binding);
/*     */     }
/*     */ 
/*     */     
/*     */     String getMapRequiredLocalName() {
...
/* 475 */     if (binding.isFeatureEnabled((Class)AddressingFeature.class)) {
/* 476 */       return W3C;
/*     */     }
/* 478 */     if (binding.isFeatureEnabled((Class)MemberSubmissionAddressingFeature.class)) {
/* 479 */       return MEMBER;
/*     */     }
/* 481 */     return null;
/*     */   }
...
/* 492 */       return null;
/*     */     }
/* 494 */     WebServiceFeature wsf = port.getFeature((Class)AddressingFeature.class);
/* 495 */     if (wsf == null) {
/* 496 */       wsf = port.getFeature((Class)MemberSubmissionAddressingFeature.class);
/*     */     }
/* 498 */     if (wsf == null) {
/* 499 */       return null;
/*     */     }
...
/* 701 */     AddressingFeature af = binding.<AddressingFeature>getFeature(AddressingFeature.class);
/* 702 */     if (af != null)
/* 703 */       return af.isRequired(); 
/* 704 */     MemberSubmissionAddressingFeature msaf = binding.<MemberSubmissionAddressingFeature>getFeature(MemberSubmissionAddressingFeature.class);
/* 705 */     if (msaf != null) {
...
/* 719 */     return (binding.isFeatureEnabled((Class)MemberSubmissionAddressingFeature.class) || binding
/* 720 */       .isFeatureEnabled((Class)AddressingFeature.class));
/*     */   }
/*     */ 
/*     */   
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\ws\api\addressing\AddressingVersion.class
