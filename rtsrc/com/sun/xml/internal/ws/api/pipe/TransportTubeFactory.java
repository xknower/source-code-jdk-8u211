...
/* 117 */     for (TransportTubeFactory factory : ServiceFinder.<TransportTubeFactory>find(TransportTubeFactory.class, classLoader, context.getContainer())) {
...
/* 132 */     for (TransportPipeFactory factory : ServiceFinder.<TransportPipeFactory>find(TransportPipeFactory.class, classLoader)) {
...
/* 156 */     return new HttpTransportPipe(context.getCodec(), context.getBinding());
/*     */   }
/*     */   
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\ws\api\pipe\TransportTubeFactory.class
