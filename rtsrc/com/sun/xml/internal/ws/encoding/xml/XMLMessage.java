...
/* 304 */       return getMessage().readPayloadAsJAXB(unmarshaller);
/*     */     }
/*     */     
...
/* 358 */       this.feature = f.<StreamingAttachmentFeature>get(StreamingAttachmentFeature.class);
/* 359 */       this.features = f;
/*     */     }
/*     */     
/*     */     private Message getMessage() {
...
/* 372 */         assert in != null;
/* 373 */         this.delegate = new PayloadSourceMessage(this.headerList, new StreamSource(in), new MimeAttachmentSet(mpp), SOAPVersion.SOAP_11);
/*     */       } 
...
/*     */     
/*     */     public <T> T readPayloadAsJAXB(Unmarshaller unmarshaller) throws JAXBException {
/* 428 */       return getMessage().readPayloadAsJAXB(unmarshaller);
/*     */     }
/*     */     
/*     */     public <T> T readPayloadAsJAXB(Bridge<T> bridge) throws JAXBException {
...
/* 580 */         ContentType ct = codec.getStaticContentType(packet);
/* 581 */         codec.encode(packet, byteArrayBuffer);
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\ws\encoding\xml\XMLMessage.class
