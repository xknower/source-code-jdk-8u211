...
/*  71 */     this._contentType = retainState ? new ContentTypeImpl("application/vnd.sun.stateful.fastinfoset") : new ContentTypeImpl("application/fastinfoset");
/*     */   }
/*     */ 
/*     */   
...
/* 114 */     if (in != null) {
/* 115 */       message = Messages.createUsingPayload(new FastInfosetSource(in), SOAPVersion.SOAP_11);
/*     */     } else {
/*     */       
...
/* 131 */       return this._serializer;
/*     */     } 
/* 133 */     return this._serializer = createNewStreamWriter(out, this._retainState);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\ws\encoding\fastinfoset\FastInfosetCodec.class
