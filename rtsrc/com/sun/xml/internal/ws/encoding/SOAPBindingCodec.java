...
/*     */     
/* 160 */     this.xmlSwaCodec = new SwACodec(this.version, features, xmlSoapCodec);
/*     */ 
/*     */     
/* 163 */     String clientAcceptedContentTypes = xmlSoapCodec.getMimeType() + ", " + this.xmlMtomCodec.getMimeType();
/*     */     
/* 165 */     WebServiceFeature fi = features.get((Class)FastInfosetFeature.class);
...
/*     */ 
/*     */         
/* 180 */         WebServiceFeature select = features.get((Class)SelectOptimalEncodingFeature.class);
/* 181 */         if (select != null) {
...
/* 270 */     if (this.features.isEnabled((Class)MTOMFeature.class)) p.checkMtomAcceptable();
/*     */     
/* 272 */     MTOMFeature mtomFeature = this.features.<MTOMFeature>get(MTOMFeature.class);
...
/* 442 */       if (message == null || message.getAttachments().isEmpty() || this.features.isEnabled((Class)MTOMFeature.class)) {
...
/* 452 */       p.setMtomFeature(this.features.<MTOMFeature>get(MTOMFeature.class));
/*     */     }
/*     */ 
/*     */     
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\ws\encoding\SOAPBindingCodec.class
