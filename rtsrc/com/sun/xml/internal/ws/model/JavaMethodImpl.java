...
/*  90 */     Action action = (metadataReader != null) ? metadataReader.<Action>getAnnotation(Action.class, this.seiMethod) : this.seiMethod.<Action>getAnnotation(Action.class);
/*  91 */     if (action != null) {
...
/*     */ 
/*     */     
/*  97 */     WebMethod webMethod = (metadataReader != null) ? metadataReader.<WebMethod>getAnnotation(WebMethod.class, this.seiMethod) : this.seiMethod.<WebMethod>getAnnotation(WebMethod.class);
/*  98 */     this.soapAction = "";
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\ws\model\JavaMethodImpl.class
