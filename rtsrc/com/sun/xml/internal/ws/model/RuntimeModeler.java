...
/*  162 */       if (this.binding != null) this.wsBinding.getFeatures().mergeFeatures(this.binding.getFeatures(), false); 
/*  163 */       this.features = WebServiceFeatureList.toList(this.wsBinding.getFeatures());
/*      */     } else {
...
/*  169 */       if (!this.features.contains((Class)MTOMFeature.class)) {
/*  170 */         MTOM mtomAn = getAnnotation(this.portClass, MTOM.class);
/*  171 */         if (mtomAn != null) this.features.add(WebServiceFeatureList.getFeature(mtomAn)); 
/*      */       } 
/*  173 */       if (!this.features.contains((Class)EnvelopeStyleFeature.class)) {
/*  174 */         EnvelopeStyle es = getAnnotation(this.portClass, EnvelopeStyle.class);
/*  175 */         if (es != null) this.features.add(WebServiceFeatureList.getFeature(es)); 
/*      */       } 
/*  177 */       this.wsBinding = this.bindingId.createBinding(this.features);
/*      */     } 
/*      */   }
/*      */   
...
/*  184 */     SOAPVersion ver = WebServiceFeatureList.getSoapVersion(this.features);
/*  185 */     boolean mtomEnabled = this.features.isEnabled((Class)MTOMFeature.class);
...
/*  211 */     return this.metadataReader.getAnnotation(T, clazz);
/*      */   }
/*      */   
/*      */   private <T extends Annotation> T getAnnotation(Method method, Class<T> T) {
/*  215 */     return this.metadataReader.getAnnotation(T, method);
/*      */   }
/*      */   
...
/*      */     } else {
/*  703 */       SOAPBindingImpl sb = new SOAPBindingImpl(this.defaultBinding);
/*  704 */       if (action != null) {
...
/* 1571 */     return (reader == null) ? cls.<A>getAnnotation(t) : reader.<A>getAnnotation(t, cls);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\ws\model\RuntimeModeler.class
