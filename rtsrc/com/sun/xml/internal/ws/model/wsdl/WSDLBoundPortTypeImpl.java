...
/*     */   }
/* 131 */   public QName getName() { return this.name; } @NotNull public EditableWSDLModel getOwner() { return this.owner; } public EditableWSDLBoundOperation get(QName operationName) { return this.bindingOperations.get(operationName); } public void put(QName opName, EditableWSDLBoundOperation ptOp) { this.bindingOperations.put(opName, ptOp); } public void setStyle(SOAPBinding.Style style) { this.style = style; }
...
/* 135 */   public BindingID getBindingId() { return (this.bindingId == null) ? BindingID.SOAP11_HTTP : this.bindingId; } public void setBindingId(BindingID bindingId) { this.bindingId = bindingId; } public SOAPBinding.Style getStyle() { return this.style; }
/*     */ 
/*     */   
...
/*     */     }
/* 171 */     return this.payloadMap.get((namespaceUri == null) ? "" : namespaceUri, localName);
/*     */   }
/*     */ 
/*     */   
/*     */   public void freeze() {
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\ws\model\wsdl\WSDLBoundPortTypeImpl.class
