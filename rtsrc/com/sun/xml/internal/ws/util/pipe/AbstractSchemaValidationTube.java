...
/*  94 */     this.feature = binding.<SchemaValidationFeature>getFeature(SchemaValidationFeature.class);
...
/*     */     try {
/* 123 */       doc.writeTo((PortAddressResolver)null, this.resolver, bab);
...
/*     */       try {
/* 165 */         XMLStreamBufferResult xsbr = XmlUtil.<XMLStreamBufferResult>identityTransform(schema, new XMLStreamBufferResult());
...
/* 168 */         this.docs.put(systemId, sdoc);
/* 169 */         this.nsMapping.put(((SDDocument.Schema)sdoc).getTargetNamespace(), sdoc);
...
/* 192 */         this.docs.put(systemId, sdi);
/*     */       } 
/* 194 */       return sdi;
/*     */     }
/*     */ 
...
/*     */                 try {
/* 229 */                   doc.writeTo((PortAddressResolver)null, AbstractSchemaValidationTube.this.resolver, bab);
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\w\\util\pipe\AbstractSchemaValidationTube.class
