...
/*  60 */     this.name = name;
/*     */     
/*  62 */     Module module = endpoint.getContainer().<Module>getSPI(Module.class);
/*  63 */     if (module == null) {
...
/*  82 */     WebModule webModule = this.endpoint.getContainer().<WebModule>getSPI(WebModule.class);
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\ws\transport\http\server\ServerAdapter.class
