...
/*     */     
/*     */     try {
/* 162 */       reader = new TidyXMLStreamReader(XMLStreamReaderFactory.create(systemId, is, true), is);
...
/* 276 */           binding.getFeatures().mergeFeatures(new WebServiceFeature[] { externalMetadataFeature }, true);
/*     */         }
/*     */ 
/*     */         
...
/*     */       
/* 329 */       if (checkMtomConflict(features.<MTOMFeature>get(MTOMFeature.class), mtomfeature)) {
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\ws\transport\http\DeploymentDescriptorParser.class
