...
/* 170 */         v.add((E)h.getValue());
/*     */       }
/*     */     } 
/* 173 */     if (v.size() == 0) {
/* 174 */       return null;
/*     */     }
/* 176 */     return v.<String>toArray(new String[v.size()]);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 257 */         this.headers.add(i + 1, (E)new hdr(name, value));
/*     */         
/*     */         return;
/*     */       } 
...
/* 262 */         pos = i; 
/*     */     } 
/* 264 */     this.headers.add(pos, (E)new hdr(name, value));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 306 */         h.line += "\r\n" + line; }
/*     */       else
/* 308 */       { this.headers.add((E)new hdr(line)); } 
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\messaging\saaj\packaging\mime\internet\InternetHeaders.class
