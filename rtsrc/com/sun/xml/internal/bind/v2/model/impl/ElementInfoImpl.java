...
/*     */     
/* 242 */     this.method = m;
/* 243 */     this.anno = reader().<XmlElementDecl>getMethodAnnotation(XmlElementDecl.class, m, this);
...
/* 248 */     T baseClass = nav().getBaseClass(this.elementType, nav().asDecl(JAXBElement.class));
...
/* 260 */       XmlJavaTypeAdapter adapter = reader().<XmlJavaTypeAdapter>getMethodAnnotation(XmlJavaTypeAdapter.class, m, this);
/* 261 */       if (adapter != null) {
/* 262 */         a = new Adapter<>(adapter, reader(), nav());
/*     */       } else {
/* 264 */         XmlAttachmentRef xsa = reader().<XmlAttachmentRef>getMethodAnnotation(XmlAttachmentRef.class, m, this);
/* 265 */         if (xsa != null) {
...
/* 274 */     this
/*     */       
/* 276 */       .tOfJAXBElementT = (methodParams.length > 0) ? methodParams[0] : nav().getTypeArgument(baseClass, 0);
/*     */     
/* 278 */     if (this.adapter == null) {
/* 279 */       T list = nav().getBaseClass(this.tOfJAXBElementT, nav().asDecl(List.class));
/* 280 */       if (list == null) {
...
/*     */ 
/*     */     
/* 294 */     T s = reader().getClassValue(this.anno, "scope");
...
/* 313 */     this.inlineBinary = reader().hasMethodAnnotation((Class)XmlInlineBinaryData.class, this.method);
...
/*     */       
/* 323 */       XmlSchema xs = reader().<XmlSchema>getPackageAnnotation(XmlSchema.class, 
...
/*     */   
/*     */   private ID calcId() {
/* 375 */     if (reader().hasMethodAnnotation((Class)XmlID.class, this.method)) {
/* 376 */       return ID.ID;
/*     */     }
/* 378 */     if (reader().hasMethodAnnotation((Class)XmlIDREF.class, this.method)) {
/* 379 */       return ID.IDREF;
/*     */     }
/* 381 */     return ID.NONE;
/*     */   }
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\bind\v2\model\impl\ElementInfoImpl.class
