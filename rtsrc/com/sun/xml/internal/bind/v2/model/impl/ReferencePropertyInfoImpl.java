...
/*     */     
/*  87 */     XmlAnyElement xae = seed.<XmlAnyElement>readAnnotation(XmlAnyElement.class);
/*  88 */     if (xae == null) {
...
/* 121 */     XmlElementRefs refs = this.seed.<XmlElementRefs>readAnnotation(XmlElementRefs.class);
/* 122 */     XmlElementRef ref = this.seed.<XmlElementRef>readAnnotation(XmlElementRef.class);
/*     */     
...
/*     */       
/* 147 */       T defaultType = nav.ref(XmlElementRef.DEFAULT.class);
/* 148 */       C je = nav.asDecl(JAXBElement.class);
/*     */       
...
/* 191 */       refs = sd.<XmlElementRefs>readAnnotation(XmlElementRefs.class);
/* 192 */       ref = sd.<XmlElementRef>readAnnotation(XmlElementRef.class);
/*     */       
...
/*     */         
/* 216 */         T defaultType = nav.ref(XmlElementRef.DEFAULT.class);
/* 217 */         C je = nav.asDecl(JAXBElement.class);
/*     */         
...
/*     */     
/* 308 */     XmlSchema xs = reader().<XmlSchema>getPackageAnnotation(XmlSchema.class, this.parent.getClazz(), this);
...
/*     */ 
/*     */     
/* 332 */     NonElement<T, C> t = this.parent.builder.getClassInfo(nav.asDecl(type), this);
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\bind\v2\model\impl\ReferencePropertyInfoImpl.class
