...
/*     */ 
/*     */     
/* 249 */     Map map = DataTransferer.getInstance().getFlavorsForFormats(this.currentT, 
/* 250 */         DataTransferer.adaptFlavorMap(this.currentDT.getFlavorMap()));
/*     */     
/* 252 */     long_ = (Long)map.get(paramDataFlavor);
/* 253 */     if (long_ == null) {
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\sun\awt\dnd\SunDropTargetContextPeer.class
