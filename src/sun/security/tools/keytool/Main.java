...
/*      */     
/* 2331 */     X509CRLSelector x509CRLSelector = certStoreHelper.wrap(new X509CRLSelector(), (Collection<X500Principal>)null, str);
...
/* 3073 */     if (DISABLED_CHECK.permits(SIG_PRIMITIVE_SET, paramString, null)) {
...
/* 4355 */     if (paramString2 != null && !DISABLED_CHECK.permits(SIG_PRIMITIVE_SET, paramString2, null))
/*      */     {
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\sun\security\tools\keytool\Main.class
