...
/* 163 */     return getAnnotationString(this.providerType, (Class)ModuleName.class, "java_tracing");
/*     */   }
/*     */ 
/*     */   
/*     */   static String getProbeName(Method paramMethod) {
/* 168 */     return getAnnotationString(paramMethod, (Class)ProbeName.class, paramMethod
/* 169 */         .getName());
/*     */   }
/*     */   
/*     */   static String getFunctionName(Method paramMethod) {
/* 173 */     return getAnnotationString(paramMethod, (Class)FunctionName.class, "unspecified");
/*     */   }
/*     */ 
/*     */   
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\sun\tracing\dtrace\DTraceProvider.class
