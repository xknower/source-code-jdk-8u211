...
/*      */           try {
/* 1828 */             checkPermission(permissionCollection, new ExecOptionPermission(str3));
/*      */           }
/* 1830 */           catch (AccessControlException accessControlException) {
/* 1831 */             if (str2.equals("")) {
/* 1832 */               checkPermission(permissionCollection, new ExecOptionPermission("-D" + str1));
/*      */               continue;
/*      */             } 
...
/* 1864 */         if (str1 != null) {
/* 1865 */           checkPermission(permissionCollection, new ExecPermission(str1));
/*      */         }
/*      */         
...
/* 1871 */             checkPermission(permissionCollection, new ExecOptionPermission(str2));
/*      */           }
/*      */         }
/*      */       } 
/*      */     }
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\sun\rmi\server\Activation.class
