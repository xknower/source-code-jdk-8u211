...
/*      */         return;
/*      */       }
/* 3030 */       (new TextLayout(new String(paramArrayOfchar, paramInt1, paramInt2), this.font, 
/* 3031 */           getFontRenderContext())).draw(this, paramInt3, paramInt4);
/*      */       
/*      */       return;
/*      */     } 
/*      */     try {
/* 3036 */       this.textpipe.drawChars(this, paramArrayOfchar, paramInt1, paramInt2, paramInt3, paramInt4);
/* 3037 */     } catch (InvalidPipeException invalidPipeException) {
/*      */       try {
/* 3039 */         revalidateAll();
/* 3040 */         this.textpipe.drawChars(this, paramArrayOfchar, paramInt1, paramInt2, paramInt3, paramInt4);
/* 3041 */       } catch (InvalidPipeException invalidPipeException1) {}
/*      */     
/*      */     }
/*      */     finally {
/*      */ 
...
/*      */         return;
/*      */       }
/* 3067 */       (new TextLayout(new String(arrayOfChar), this.font, 
/* 3068 */           getFontRenderContext())).draw(this, paramInt3, paramInt4);
/*      */       
/*      */       return;
/*      */     } 
/*      */     try {
/* 3073 */       this.textpipe.drawChars(this, arrayOfChar, 0, paramInt2, paramInt3, paramInt4);
/* 3074 */     } catch (InvalidPipeException invalidPipeException) {
/*      */       try {
/* 3076 */         revalidateAll();
/* 3077 */         this.textpipe.drawChars(this, arrayOfChar, 0, paramInt2, paramInt3, paramInt4);
/* 3078 */       } catch (InvalidPipeException invalidPipeException1) {}
/*      */     
/*      */     }
/*      */     finally {
/*      */ 
...
/* 3100 */       int i = SurfaceManager.getImageScale(paramImage);
...
/*      */ 
/*      */       
/* 3108 */       int i = paramImage.getWidth(paramImageObserver);
/* 3109 */       int j = paramImage.getHeight(paramImageObserver);
/*      */       
/* 3111 */       Image image = getResolutionVariant((MultiResolutionImage)paramImage, i, j, paramInt1, paramInt2, paramInt3, paramInt4, paramInt5, paramInt6, paramInt7, paramInt8);
/*      */ 
/*      */ 
/*      */       
/* 3115 */       if (image != paramImage && image != null) {
/*      */ 
/*      */ 
/*      */         
/* 3119 */         ImageObserver imageObserver = MultiResolutionToolkitImage.getResolutionVariantObserver(paramImage, paramImageObserver, i, j, -1, -1);
/*      */ 
/*      */         
/* 3122 */         int k = image.getWidth(imageObserver);
/* 3123 */         int m = image.getHeight(imageObserver);
/*      */         
...
/*      */           
/* 3135 */           paramImageObserver = imageObserver;
/* 3136 */           paramImage = image;
/*      */         } 
/*      */       } 
/*      */     } 
/*      */     
...
/*      */     }
/* 3144 */     catch (InvalidPipeException invalidPipeException) {
/*      */       try {
/* 3146 */         revalidateAll();
...
/*      */       }
/* 3149 */       catch (InvalidPipeException invalidPipeException1) {
/*      */ 
/*      */ 
/*      */         
/* 3153 */         return false;
...
/*      */ 
/*      */     
/* 3198 */     Image image = paramMultiResolutionImage.getResolutionVariant(i1, i2);
/*      */     
/* 3200 */     if (image instanceof ToolkitImage && ((ToolkitImage)image)
/* 3201 */       .hasError()) {
/* 3202 */       return null;
/*      */     }
/*      */     
...
/*      */     }
/* 3231 */     catch (InvalidPipeException invalidPipeException) {
/*      */       try {
/* 3233 */         revalidateAll();
...
/*      */       }
/* 3236 */       catch (InvalidPipeException invalidPipeException1) {
/*      */ 
/*      */ 
/*      */         
/* 3240 */         return false;
...
/*      */     }
/* 3276 */     catch (InvalidPipeException invalidPipeException) {
/*      */       try {
/* 3278 */         revalidateAll();
...
/*      */       }
/* 3281 */       catch (InvalidPipeException invalidPipeException1) {
/*      */ 
/*      */ 
/*      */         
/* 3285 */         return false;
...
/* 3319 */     } catch (InvalidPipeException invalidPipeException) {
/*      */       try {
/* 3321 */         revalidateAll();
/* 3322 */         return this.imagepipe.copyImage(this, paramImage, paramInt1, paramInt2, paramColor, paramImageObserver);
/* 3323 */       } catch (InvalidPipeException invalidPipeException1) {
/*      */ 
/*      */ 
/*      */         
/* 3327 */         return false;
...
/*      */     
/*      */     }
/* 3401 */     catch (InvalidPipeException invalidPipeException) {
/*      */       try {
/* 3403 */         revalidateAll();
...
/*      */       
/*      */       }
/* 3407 */       catch (InvalidPipeException invalidPipeException1) {
/*      */ 
/*      */ 
/*      */         
/* 3411 */         return false;
...
/* 3451 */       AffineTransform affineTransform = new AffineTransform(this.transform);
/* 3452 */       transform(paramAffineTransform);
/* 3453 */       boolean bool = drawHiDPIImage(paramImage, 0, 0, i, j, 0, 0, i, j, null, paramImageObserver);
/*      */       
/* 3455 */       this.transform.setTransform(affineTransform);
...
/* 3462 */     } catch (InvalidPipeException invalidPipeException) {
/*      */       try {
/* 3464 */         revalidateAll();
/* 3465 */         return this.imagepipe.transformImage(this, paramImage, paramAffineTransform, paramImageObserver);
/* 3466 */       } catch (InvalidPipeException invalidPipeException1) {
/*      */ 
/*      */ 
/*      */         
/* 3470 */         return false;
...
/* 3488 */     } catch (InvalidPipeException invalidPipeException) {
/*      */       try {
/* 3490 */         revalidateAll();
/* 3491 */         this.imagepipe.transformImage(this, paramBufferedImage, paramBufferedImageOp, paramInt1, paramInt2);
/* 3492 */       } catch (InvalidPipeException invalidPipeException1) {}
/*      */     
/*      */     }
/*      */     finally {
/*      */ 
...
/*      */       }
/*      */       
/* 3514 */       AffineTransform affineTransform = null;
/* 3515 */       if (this.transformState >= 3) {
/* 3516 */         if (this.transform.getTranslateX() == 0.0D && this.transform
/* 3517 */           .getTranslateY() == 0.0D) {
/* 3518 */           affineTransform = this.transform;
/*      */         
/*      */         }
/*      */         else {
/*      */           
/* 3523 */           affineTransform = new AffineTransform(this.transform.getScaleX(), this.transform.getShearY(), this.transform.getShearX(), this.transform.getScaleY(), 0.0D, 0.0D);
/*      */         } 
/*      */       }
/*      */       
/* 3527 */       this
/*      */         
/* 3529 */         .cachedFRC = new FontRenderContext(affineTransform, SunHints.Value.get(2, i), SunHints.Value.get(3, this.fractionalMetricsHint));
/*      */     } 
/*      */     
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\sun\java2d\SunGraphics2D.class
