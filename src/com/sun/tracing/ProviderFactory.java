...
/* 105 */       return new NullProviderFactory(); 
/* 106 */     if (hashSet.size() == 1) {
/* 107 */       return ((ProviderFactory[])hashSet.toArray((Object[])new ProviderFactory[1]))[0];
/*     */     }
/* 109 */     return new MultiplexProviderFactory((Set)hashSet);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\tracing\ProviderFactory.class
