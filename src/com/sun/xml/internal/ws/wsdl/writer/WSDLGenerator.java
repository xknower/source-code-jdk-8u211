...
/*  256 */       WSDLGeneratorExtension[] wsdlGeneratorExtensions = container.<WSDLGeneratorExtension[]>getSPI((Class)WSDLGeneratorExtension[].class);
...
/*  302 */       absWSDLName.value = (T)(wsdlName + ".wsdl");
...
/*  398 */     this.serviceDefinitions = TXW.<Definitions>create(Definitions.class, serviceStream);
...
/*  408 */     WSDLGenExtnContext serviceCtx = new WSDLGenExtnContext(this.serviceDefinitions, this.model, this.binding, this.container, this.implType);
/*  409 */     this.extension.start(serviceCtx);
/*  410 */     if (serviceStream != portStream && portStream != null) {
/*      */       
/*  412 */       this.portDefinitions = TXW.<Definitions>create(Definitions.class, portStream);
...
/*      */     } 
/*  432 */     this.extension.addDefinitionsExtension(this.serviceDefinitions);
/*      */     
...
/*  471 */           SAXResult sax = new SAXResult(new TXWContentHandler(this.types));
...
/*      */       } 
/*  512 */       Element e = xsd.<Element>_element(Element.class);
/*  513 */       e._attribute("name", wp.getName().getLocalPart());
/*  514 */       e.type(wp.getName());
/*  515 */       ComplexType ct = xsd.<ComplexType>_element(ComplexType.class);
...
/*  558 */     this.extension.addInputMessageExtension(message, method);
/*      */     
...
/*  583 */       this.extension.addOutputMessageExtension(message, method);
/*      */       
...
/*      */       
/*  611 */       this.extension.addFaultMessageExtension(message, method, exception);
...
/*  624 */     this.extension.addPortTypeExtension(portType);
...
/*  628 */       this.extension.addOperationExtension(operation, method);
...
/*  646 */         this.extension.addOperationFaultExtension(paramType, method, exception);
/*      */       } 
/*      */     } 
/*      */   }
/*      */ 
...
/*  838 */     this.extension.addBindingExtension(newBinding);
...
/*  871 */     this.extension.addBindingOperationExtension(operation, method);
...
/*  882 */     this.extension.addBindingOperationInputExtension(input, method);
/*  883 */     BodyType body = input.<BodyType>_element((Class)Body.class);
...
/*  921 */       this.extension.addBindingOperationOutputExtension(output, method);
/*  922 */       body = output.<BodyType>_element((Class)Body.class);
...
/*  952 */       this.extension.addBindingOperationFaultExtension(fault, method, exception);
/*  953 */       SOAPFault soapFault = ((SOAPFault)fault.<SOAPFault>_element(SOAPFault.class)).name(exception.getMessageName());
...
/*  960 */     this.extension.addBindingOperationExtension(operation, method);
...
/*  975 */     this.extension.addBindingOperationInputExtension(input, method);
/*  976 */     BodyType body = input.<BodyType>_element((Class)Body.class);
...
/* 1014 */       this.extension.addBindingOperationOutputExtension(output, method);
/* 1015 */       body = output.<BodyType>_element((Class)Body.class);
...
/* 1045 */       this.extension.addBindingOperationFaultExtension(fault, method, exception);
/* 1046 */       SOAPFault soapFault = ((SOAPFault)fault.<SOAPFault>_element(SOAPFault.class)).name(exception.getMessageName());
...
/* 1064 */       Header header = writer.<Header>_element(Header.class);
...
/* 1074 */       Header header = writer.<Header>_element(Header.class);
...
/* 1108 */     this.extension.addOperationInputExtension(paramType, method);
/*      */     
...
/* 1115 */     this.extension.addOperationOutputExtension(paramType, method);
/*      */     
...
/* 1135 */     fileNameHolder.value = (T)(this.schemaPrefix + suggestedFileName);
...
/*      */ 
/*      */     
/* 1168 */     Result result = new TXWResult(this.types);
...
/* 1253 */       this.nonGlassfishSchemas = null;
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\ws\wsdl\writer\WSDLGenerator.class
