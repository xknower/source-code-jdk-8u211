...
/*  55 */     this.enabled = binding.isFeatureEnabled((Class)AddressingFeature.class);
/*  56 */     if (!this.enabled)
/*     */       return; 
/*  58 */     AddressingFeature ftr = binding.<AddressingFeature>getFeature(AddressingFeature.class);
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\ws\wsdl\writer\W3CAddressingWSDLGeneratorExtension.class
