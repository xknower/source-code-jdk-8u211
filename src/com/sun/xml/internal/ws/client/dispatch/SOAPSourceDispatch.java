...
/*     */ 
/*     */           
/* 102 */           return new Packet(message);case MESSAGE: message = Messages.create(msg, this.soapVersion); return new Packet(message); }  throw new WebServiceException("Unrecognized message mode"); }  return new Packet(message);
/*     */   }
/*     */ }


/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\ws\client\dispatch\SOAPSourceDispatch.class
