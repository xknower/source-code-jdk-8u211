...
/*     */     
/* 252 */     ComponentFeature cf = this.features.<ComponentFeature>get(ComponentFeature.class);
/* 253 */     if (cf != null) {
...
/*     */       } 
/*     */     }
/* 265 */     ComponentsFeature csf = this.features.<ComponentsFeature>get(ComponentsFeature.class);
/* 266 */     if (csf != null) {
...
/* 283 */     ServiceInterceptor si = this.container.<ServiceInterceptor>getSPI(ServiceInterceptor.class);
/* 284 */     if (si != null) {
...
/* 349 */           getContainer(), serviceClass, ServiceFinder.<WSDLParserExtension>find(WSDLParserExtension.class).toArray());
...
/* 422 */     ComponentFeature cf = features.<ComponentFeature>get(ComponentFeature.class);
/* 423 */     if (cf != null && !ComponentFeature.Target.STUB.equals(cf.getTarget())) {
/* 424 */       throw new IllegalArgumentException();
/*     */     }
/* 426 */     ComponentsFeature csf = features.<ComponentsFeature>get(ComponentsFeature.class);
/* 427 */     if (csf != null)
...
/*     */     
/* 489 */     ComponentFeature cf = features.<ComponentFeature>get(ComponentFeature.class);
/* 490 */     if (cf != null && !ComponentFeature.Target.STUB.equals(cf.getTarget())) {
/* 491 */       throw new IllegalArgumentException();
/*     */     }
/* 493 */     ComponentsFeature csf = features.<ComponentsFeature>get(ComponentsFeature.class);
/* 494 */     if (csf != null)
...
/* 516 */     AddressingFeature af = features.<AddressingFeature>get(AddressingFeature.class);
/* 517 */     if (af == null) {
/* 518 */       af = this.features.<AddressingFeature>get(AddressingFeature.class);
/*     */     }
/* 520 */     if (af != null && af.isEnabled())
/* 521 */       isAddressingEnabled = true; 
/* 522 */     MemberSubmissionAddressingFeature msa = features.<MemberSubmissionAddressingFeature>get(MemberSubmissionAddressingFeature.class);
/* 523 */     if (msa == null) {
/* 524 */       msa = this.features.<MemberSubmissionAddressingFeature>get(MemberSubmissionAddressingFeature.class);
/*     */     }
...
/*     */     
/* 579 */     ComponentFeature cf = features.<ComponentFeature>get(ComponentFeature.class);
/* 580 */     if (cf != null && !ComponentFeature.Target.STUB.equals(cf.getTarget())) {
/* 581 */       throw new IllegalArgumentException();
/*     */     }
/* 583 */     ComponentsFeature csf = features.<ComponentsFeature>get(ComponentsFeature.class);
/* 584 */     if (csf != null)
...
/* 594 */     Dispatch<Object> dispatch = Stubs.createJAXBDispatch(port, binding, jaxbContext, mode, wsepr);
/*     */     
...
/* 612 */     AddressingFeature af = features.<AddressingFeature>get(AddressingFeature.class);
/* 613 */     if (af == null) {
/* 614 */       af = this.features.<AddressingFeature>get(AddressingFeature.class);
/*     */     }
/* 616 */     if (af != null && af.isEnabled())
/* 617 */       isAddressingEnabled = true; 
/* 618 */     MemberSubmissionAddressingFeature msa = features.<MemberSubmissionAddressingFeature>get(MemberSubmissionAddressingFeature.class);
/* 619 */     if (msa == null) {
/* 620 */       msa = this.features.<MemberSubmissionAddressingFeature>get(MemberSubmissionAddressingFeature.class);
/*     */     }
...
/*     */     
/* 883 */     ExternalMetadataFeature ef = features.<ExternalMetadataFeature>get(ExternalMetadataFeature.class);
/*     */     
/* 885 */     if (ef != null)
...
/* 898 */     return features.contains((Class)UsesJAXBContextFeature.class);
/*     */   }
/*     */   
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\ws\client\WSServiceDelegate.class
