...
/*     */       
/* 263 */       ComponentFeature cf = binding.<ComponentFeature>getFeature(ComponentFeature.class);
/* 264 */       if (cf != null && ComponentFeature.Target.STUB.equals(cf.getTarget())) {
/* 265 */         this.components.add(cf.getComponent());
/*     */       }
/* 267 */       ComponentsFeature csf = binding.<ComponentsFeature>getFeature(ComponentsFeature.class);
/* 268 */       if (csf != null) {
...
/* 283 */       this.wsdlProperties = (wsdlPort == null) ? new WSDLDirectProperties(owner.getServiceName(), portname) : new WSDLPortProperties(wsdlPort);
/*     */       
...
/*     */       
/* 292 */       if (master != null) {
/* 293 */         this.tubes = new Pool.TubePool(master);
/*     */       } else {
/* 295 */         this.tubes = new Pool.TubePool(createPipeline(portInfo, binding));
/*     */       } 
/*     */       
...
/* 332 */           .getContainer(), ((BindingImpl)binding).createCodec(), seiModel, sei));
/*     */   }
/*     */   
...
/* 355 */     if (port.getPort() != null && binding.isFeatureEnabled((Class)RespectBindingFeature.class)) {
...
/* 373 */       this.operationDispatcher = new OperationDispatcher(this.wsdlPort, this.binding, null);
/*     */     }
...
/* 478 */     packet.addSatellite(this.wsdlProperties);
/*     */     
/* 480 */     if (this.addrVersion != null) {
/*     */       
/* 482 */       MessageHeaders headerList = packet.getMessage().getHeaders();
/* 483 */       AddressingUtils.fillRequestAddressingHeaders(headerList, this.wsdlPort, this.binding, packet);
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */     }
/*     */     
/* 533 */     FiberContextSwitchInterceptorFactory fcsif = this.owner.<FiberContextSwitchInterceptorFactory>getSPI(FiberContextSwitchInterceptorFactory.class);
/* 534 */     if (fcsif != null) {
...
/* 559 */         getBinding().isFeatureEnabled((Class)SyncStartForAsyncFeature.class) && 
...
/*     */       }
/*     */     } 
/* 746 */     return this.owner.getSPI(spiType);
/*     */   }
/*     */ 
/*     */   
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\ws\client\Stub.class
