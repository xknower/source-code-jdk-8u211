...
/*  96 */     Marshaller m = this.context.marshallerPool.take();
...
/* 130 */     Marshaller m = this.context.marshallerPool.take();
...
/* 145 */     Marshaller m = this.context.marshallerPool.take();
...
/* 167 */     Marshaller m = this.context.marshallerPool.take();
...
/* 182 */     Marshaller m = this.context.marshallerPool.take();
...
/* 222 */     Unmarshaller u = this.context.unmarshallerPool.take();
...
/* 254 */     Unmarshaller u = this.context.unmarshallerPool.take();
...
/* 280 */     Unmarshaller u = this.context.unmarshallerPool.take();
...
/* 309 */     Unmarshaller u = this.context.unmarshallerPool.take();
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\ws\spi\db\OldBridge.class
