...
/* 124 */       return this;
/*     */     }
/* 126 */     return new TypeInfo(this.tagName, Utils.REFLECTION_NAVIGATOR.getTypeArgument(base, 0), new Annotation[0]);
/*     */   }
/*     */   
...
/* 191 */     if (base != null) {
/* 192 */       return new TypeInfo(this.tagName, Utils.REFLECTION_NAVIGATOR.getTypeArgument(base, 0), this.annotations);
/*     */     }
/* 194 */     return null;
/*     */   }
/*     */ }
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\ws\spi\db\TypeInfo.class
