...
/*  73 */     this.soap = msg;
/*  74 */     this.currentElement = this.soap.getSOAPPart().getEnvelope();
...
/* 101 */           this.currentElement = this.soap.getSOAPPart().getEnvelope();
/* 102 */           fixPrefix(prefix); return;
/*     */         } 
/* 104 */         if ("Header".equals(ln)) {
/* 105 */           this.currentElement = this.soap.getSOAPHeader();
/* 106 */           fixPrefix(prefix); return;
/*     */         } 
/* 108 */         if ("Body".equals(ln)) {
/* 109 */           this.currentElement = this.soap.getSOAPBody();
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\ws\api\message\saaj\SaajStaxWriter.class
