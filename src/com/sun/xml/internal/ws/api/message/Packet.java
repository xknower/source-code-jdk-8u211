...
/*  223 */       this.message = new MessageWrapper(this, this.message);
/*      */     }
...
/* 1342 */       return binding.<MTOMFeature>getFeature(MTOMFeature.class);
/*      */     }
...
/* 1353 */       this.contentType = getCodec().getStaticContentType(this);
/*      */     }
...
/* 1450 */     addSatellite(keyClass, satellite);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1464 */     removeSatellite(satellite);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\ws\api\message\Packet.class
