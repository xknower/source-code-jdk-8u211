...
/*  160 */     this(XMLStreamReaderFactory.create((String)null, infoset, false), version);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     } 
/*      */     
/*  637 */     return new WSEndpointReference(xsb, this.version);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  820 */     return new StreamReaderBufferProcessor(this.infoset)
/*      */       {
...
/*  873 */     this.infoset.writeToXMLStreamWriter(new XMLStreamWriterFilter(w)
/*      */         {
...
/*      */ 
/*      */         
/* 1085 */         XMLStreamReaderUtil.skipElement(xsr); continue;
/*      */       } 
...
/* 1187 */                 this.wsdlSource = new XMLStreamBufferSource(mark); continue;
/*      */               } 
...
/*      */           }
/*      */         
/* 1198 */         } while (XMLStreamReaderUtil.nextElementContent(xsr) == 1);
/*      */         
...
/* 1219 */                   this.wsdlSource = new XMLStreamBufferSource(mark); continue;
/*      */                 } 
...
/*      */           }
/*      */         
/* 1239 */         } while (XMLStreamReaderUtil.nextElementContent(xsr) == 1);
/*      */       } 
/*      */     }
/*      */     
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\ws\api\addressing\WSEndpointReference.class
