...
/* 170 */     ServerPipelineHook hook = this.endpoint.getContainer().<ServerPipelineHook>getSPI(ServerPipelineHook.class);
/* 171 */     if (hook != null) {
...
/* 182 */     ServerPipelineHook hook = this.endpoint.getContainer().<ServerPipelineHook>getSPI(ServerPipelineHook.class);
/* 183 */     if (hook != null) {
...
/* 201 */     if (this.binding instanceof javax.xml.ws.soap.SOAPBinding && this.binding.isFeatureEnabled((Class)SchemaValidationFeature.class) && this.wsdlModel != null) {
...
/* 211 */     if (this.binding instanceof javax.xml.ws.soap.SOAPBinding && AddressingVersion.isEnabled(this.binding)) {
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\ws\api\pipe\ServerTubeAssemblerContext.class
