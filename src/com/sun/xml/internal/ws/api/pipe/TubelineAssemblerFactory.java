...
/*     */       
/*  86 */       TubelineAssemblerFactory taf = container.<TubelineAssemblerFactory>getSPI(TubelineAssemblerFactory.class);
/*  87 */       if (taf != null) {
...
/*     */     } 
/*     */     
/*  95 */     for (TubelineAssemblerFactory factory : ServiceFinder.<TubelineAssemblerFactory>find(TubelineAssemblerFactory.class, classLoader)) {
...
/*     */ 
/*     */     
/* 104 */     for (PipelineAssemblerFactory factory : ServiceFinder.<PipelineAssemblerFactory>find(PipelineAssemblerFactory.class, classLoader)) {
...
/*     */ 
/*     */     
/* 113 */     return new MetroTubelineAssembler(bindingId, MetroTubelineAssembler.JAXWS_TUBES_CONFIG_NAMES);
/*     */   }
/*     */   
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\ws\api\pipe\TubelineAssemblerFactory.class
