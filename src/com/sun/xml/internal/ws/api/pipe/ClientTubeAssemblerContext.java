...
/* 240 */     ClientPipelineHook hook = this.container.<ClientPipelineHook>getSPI(ClientPipelineHook.class);
/* 241 */     if (hook != null) {
...
/* 255 */         return new MemberSubmissionWsaClientTube(this.wsdlModel, this.binding, next);
/*     */       }
/* 257 */       return new W3CWsaClientTube(this.wsdlModel, this.binding, next);
/*     */     } 
/*     */     
/* 260 */     return next;
/*     */   }
...
/*     */       
/* 271 */       HandlerTube messageHandlerTube = new ClientMessageHandlerTube(this.seiModel, this.binding, this.wsdlModel, next);
/* 272 */       next = cousinHandlerTube = messageHandlerTube;
/*     */ 
/*     */       
/* 275 */       HandlerTube soapHandlerTube = new ClientSOAPHandlerTube(this.binding, next, cousinHandlerTube);
/* 276 */       next = cousinHandlerTube = soapHandlerTube;
/*     */     } 
/* 278 */     return new ClientLogicalHandlerTube(this.binding, this.seiModel, next, cousinHandlerTube);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 287 */       return new ClientMUTube(this.binding, next);
/*     */     }
/* 289 */     return next;
/*     */   }
/*     */ 
...
/* 296 */     if (this.binding instanceof javax.xml.ws.soap.SOAPBinding && this.binding.isFeatureEnabled((Class)SchemaValidationFeature.class) && this.wsdlModel != null) {
/* 297 */       return new ClientSchemaValidationTube(this.binding, this.wsdlModel, next);
/*     */     }
/* 299 */     return next;
/*     */   }
/*     */ 
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\ws\api\pipe\ClientTubeAssemblerContext.class
