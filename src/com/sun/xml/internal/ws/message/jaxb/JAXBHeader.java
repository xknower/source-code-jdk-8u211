...
/*     */     try {
/* 112 */       this.bridge.marshal(this.jaxbObject, sniffer, (AttachmentMarshaller)null);
...
/* 149 */       this.infoset = buffer;
/*     */     } 
/* 151 */     return this.infoset.readAsXMLStreamReader();
/*     */   }
/*     */   
...
/* 172 */     return bond.unmarshal(new JAXBBridgeSource(this.bridge, this.jaxbObject), (AttachmentUnmarshaller)null);
/*     */   }
/*     */ 
/*     */   
...
/*     */       } else {
/* 185 */         this.bridge.marshal(this.jaxbObject, sw, (AttachmentMarshaller)null);
/*     */       } 
...
/* 197 */       this.bridge.marshal(this.jaxbObject, header);
...
/*     */     try {
/* 205 */       this.bridge.marshal(this.jaxbObject, contentHandler, (AttachmentMarshaller)null);
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\ws\message\jaxb\JAXBHeader.class
