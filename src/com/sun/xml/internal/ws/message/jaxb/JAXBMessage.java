...
/*     */ 
/*     */   
/*     */   public static Message create(XMLBridge<Object> bridge, Object jaxbObject, SOAPVersion soapVer) {
...
/* 253 */       this.headers = new HeaderList(getSOAPVersion()); 
...
/* 285 */         m.marshal(this.jaxbObject, sniffer); }
/*     */       else
/* 287 */       { this.bridge.marshal(this.jaxbObject, sniffer, (AttachmentMarshaller)null); } 
...
/* 314 */         m.marshal(this.jaxbObject, out);
/*     */       } else {
/* 316 */         this.bridge.marshal(this.jaxbObject, out);
...
/* 332 */           m.marshal(this.jaxbObject, sbr);
/* 333 */           this.infoset = sbr.getXMLStreamBuffer();
/*     */         } else {
/* 335 */           MutableXMLStreamBuffer buffer = new MutableXMLStreamBuffer();
/* 336 */           writePayloadTo(buffer.createFromXMLStreamWriter());
/* 337 */           this.infoset = buffer;
/*     */         } 
/*     */       }
/* 340 */       XMLStreamReader reader = this.infoset.readAsXMLStreamReader();
/* 341 */       if (reader.getEventType() == 7)
...
/* 363 */         m.marshal(this.jaxbObject, contentHandler);
/*     */       } else {
/* 365 */         this.bridge.marshal(this.jaxbObject, contentHandler, am);
/* 366 */       }  am.cleanup();
...
/* 435 */       soapHeader = new XMLReaderComposite(hdrElem, hReaders.<XMLStreamReader>toArray(new XMLStreamReader[hReaders.size()]));
/*     */     } 
/*     */     try {
...
/* 440 */       (new XMLStreamReader[2])[0] = soapHeader; (new XMLStreamReader[2])[1] = soapBody; (new XMLStreamReader[1])[0] = soapBody; XMLStreamReader[] soapContent = (soapHeader != null) ? new XMLStreamReader[2] : new XMLStreamReader[1];
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\ws\message\jaxb\JAXBMessage.class
