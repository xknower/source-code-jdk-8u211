...
/*     */         } 
/*     */       } 
/* 142 */       XMLStreamReader soapHeader = (hdrElem != null) ? new XMLReaderComposite(hdrElem, hReaders.<XMLStreamReader>toArray(new XMLStreamReader[hReaders.size()])) : null;
/* 143 */       XMLStreamReader[] payload = { readPayload() };
/* 144 */       XMLStreamReader soapBody = new XMLReaderComposite(bdyElem, payload);
/* 145 */       (new XMLStreamReader[2])[0] = soapHeader; (new XMLStreamReader[2])[1] = soapBody; (new XMLStreamReader[1])[0] = soapBody; XMLStreamReader[] soapContent = (soapHeader != null) ? new XMLStreamReader[2] : new XMLStreamReader[1];
...
/* 248 */       this.headers = new HeaderList(getSOAPVersion());
/*     */     }
...
/* 271 */       return new StAXSource(this.reader, true, getInscopeNamespaces());
/*     */     } 
/* 273 */     return null;
/*     */   }
/*     */ 
...
/* 326 */     T r = bridge.unmarshal(this.reader, 
...
/* 338 */     T r = bridge.unmarshal(this.reader, 
...
/*     */       
/* 546 */       this.reader = xsb.readAsXMLStreamReader();
...
/*     */       
/* 553 */       return new StreamMessage(this.envelopeTag, this.headerTag, this.attachmentSet, HeaderList.copy(this.headers), this.bodyPrologue, this.bodyTag, this.bodyEpilogue, clone, this.soapVersion);
...
/* 714 */     message.init(envelopeTag, headerTag, message.attachmentSet, headers, bodyPrologue, bodyTag, (String)null, reader, soapVersion);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\ws\message\stream\StreamMessage.class
