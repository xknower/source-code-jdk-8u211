...
/* 119 */           this.headers = new HeaderList(getSOAPVersion()); 
...
/* 125 */             this.headers.add(new SAAJHeader(iter.next()));
/*     */           }
/*     */         } 
...
/* 141 */         Node body = this.sm.getSOAPBody();
/* 142 */         this.bodyAttrs = body.getAttributes();
/* 143 */         this.soapVersion = SOAPVersion.fromNsUri(body.getNamespaceURI());
/*     */         
/* 145 */         this.bodyParts = DOMUtil.getChildElements(body);
/*     */         
...
/* 317 */       return bridge.unmarshal(this.payload, hasAttachments() ? new AttachmentUnmarshallerImpl(getAttachments()) : null); 
/* 318 */     return null;
/*     */   }
/*     */   public <T> T readPayloadAsJAXB(XMLBridge<T> bridge) throws JAXBException {
/* 321 */     access();
/* 322 */     if (this.payload != null)
/* 323 */       return bridge.unmarshal(this.payload, hasAttachments() ? new AttachmentUnmarshallerImpl(getAttachments()) : null); 
/* 324 */     return null;
/*     */   }
/*     */   
...
/* 345 */         DOMUtil.serializeNode(this.sm.getSOAPPart().getEnvelope(), writer);
/*     */       } else {
...
/*     */         } 
/*     */         
/* 361 */         DOMUtil.serializeNode(this.sm.getSOAPBody(), writer);
...
/* 377 */       ds.scan(this.sm.getSOAPPart());
/*     */     } else {
...
/*     */       } 
/* 505 */       addAttributes(newBody, this.bodyAttrs);
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\ws\message\saaj\SAAJMessage.class
