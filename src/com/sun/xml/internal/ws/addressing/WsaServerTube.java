...
/*     */ 
/*     */     
/* 106 */     request.addSatellite(new WsaPropertyBag(this.addressingVersion, this.soapVersion, request));
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */       
/* 120 */       LOGGER.log(Level.WARNING, this.addressingVersion.getInvalidMapText() + ", Problem header:" + e.getProblemHeader() + ", Reason: " + e.getSubsubcode(), e);
/*     */ 
/*     */       
...
/* 128 */         Packet packet = request.createServerResponse((Message)null, this.wsdlPort, (SEIModel)null, this.binding);
...
/*     */       } 
/*     */       
/* 138 */       Packet response = request.createServerResponse(m, this.wsdlPort, (SEIModel)null, this.binding);
...
/* 201 */     ThrowableContainerPropertySet tc = response.<ThrowableContainerPropertySet>getSatellite(ThrowableContainerPropertySet.class);
/* 202 */     if (tc == null) {
...
/*     */       
/* 257 */       response.setMessage((Message)null);
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\ws\addressing\WsaServerTube.class
