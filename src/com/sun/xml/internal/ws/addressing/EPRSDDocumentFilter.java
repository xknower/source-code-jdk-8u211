...
/*     */       
/*  71 */       Module module = this.endpoint.getContainer().<Module>getSPI(Module.class);
/*  72 */       if (module != null) {
...
/*     */           } 
/* 141 */           WSEndpoint endpoint = EPRSDDocumentFilter.this.getEndpoint(this.serviceName, this.portName);
/*     */ 
/*     */           
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\ws\addressing\EPRSDDocumentFilter.class
