...
/* 162 */       if (index < sz) {
/* 163 */         Attr attr = this.currentNamespaces.get(index);
...
/*     */       } 
/* 170 */       return this.additionalNamespaces.get((index - sz) * 2);
/*     */     }
/*     */ 
/*     */     
...
/*     */       }
/* 179 */       return this.additionalNamespaces.get((index - sz) * 2 + 1);
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 190 */           String result = DOMStreamReader.getPrefixForAttr(sp.currentNamespaces.get(i), nsUri);
/* 191 */           if (result != null)
/* 192 */             return result; 
/*     */         } 
...
/* 274 */       Attr a = this._currentAttributes.get(i);
...
/* 356 */       Node attr = this._currentAttributes.get(index);
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\ws\streaming\DOMStreamReader.class
