...
/* 126 */       if (obj != null) {
/* 127 */         Attachment att = new ByteArrayAttachment(contentId, (byte[])obj, this.mimeType);
/* 128 */         msg.getAttachments().add(att);
/*     */       } 
/*     */     }
/*     */   }
/*     */   
...
/* 142 */       Attachment att = new DataHandlerAttachment(contentId, dh);
/* 143 */       msg.getAttachments().add(att);
/*     */     }
/*     */   }
/*     */   
...
/* 155 */       Attachment att = new JAXBAttachment(contentId, obj, this.param.getXMLBridge(), this.mimeType);
/* 156 */       msg.getAttachments().add(att);
/*     */     }
/*     */   }
/*     */ 
/*     */   
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\ws\server\sei\MessageFiller.class
