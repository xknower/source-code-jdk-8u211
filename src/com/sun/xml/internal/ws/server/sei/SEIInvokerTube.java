...
/* 67 */     JavaCallInfo call = this.model.getDatabinding().deserializeRequest(req);
...
/* 82 */       return doReturnWith(req.createServerResponse(e.fault, this.model.getPort(), (SEIModel)null, this.binding));
/*    */     } 
/* 84 */     Packet res = (Packet)this.model.getDatabinding().serializeResponse(call);
/* 85 */     res = req.relateServerResponse(res, req.endpoint.getPort(), this.model, req.endpoint.getBinding());
/* 86 */     assert res != null;
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\ws\server\sei\SEIInvokerTube.class
