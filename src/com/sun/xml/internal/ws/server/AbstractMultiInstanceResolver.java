...
/* 55 */     this.clazz = clazz;
/*    */     
/* 57 */     this.postConstructMethod = findAnnotatedMethod(clazz, (Class)PostConstruct.class);
/* 58 */     this.preDestroyMethod = findAnnotatedMethod(clazz, (Class)PreDestroy.class);
/*    */   }
/*    */ 
/*    */ 
/*    */ 
...
/* 76 */     T t = createNewInstance(this.clazz);
/* 77 */     prepare(t);
/* 78 */     return t;
/*    */   }
/*    */ 
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\ws\server\AbstractMultiInstanceResolver.class
