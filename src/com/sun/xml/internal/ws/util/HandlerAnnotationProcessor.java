...
/*     */ 
/*     */     
/* 100 */     HandlerChain handlerChain = metadataReader.<HandlerChain>getAnnotation(HandlerChain.class, clazz);
/* 101 */     if (handlerChain == null) {
/* 102 */       clazz = getSEI(clazz, metadataReader);
/* 103 */       if (clazz != null)
/* 104 */         handlerChain = metadataReader.<HandlerChain>getAnnotation(HandlerChain.class, clazz); 
...
/*     */     
/* 115 */     XMLStreamReader reader = XMLStreamReaderFactory.create((String)null, iStream, true);
...
/*     */     
/* 142 */     XMLStreamReader reader = XMLStreamReaderFactory.create((String)null, iStream, true);
...
/*     */     }
/*     */     
/* 182 */     WebService webService = metadataReader.<WebService>getAnnotation(WebService.class, clazz);
...
/* 190 */       WebService ws = metadataReader.<WebService>getAnnotation(WebService.class, clazz);
/* 191 */       if (ws == null) {
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\w\\util\HandlerAnnotationProcessor.class
