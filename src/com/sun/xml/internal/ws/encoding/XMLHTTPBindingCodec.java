...
/*     */     
/* 113 */     this.xmlCodec = new XMLCodec(f);
/*     */     
...
/* 170 */       packet.setMessage(new XMLMessage.XMLMultiPart(contentType, in, this.features));
...
/*     */     } else {
/* 181 */       packet.setMessage(new XMLMessage.UnknownContent(contentType, in));
/*     */     } 
/*     */     
...
/* 314 */         ContentType ct = codec.encode(p, bos);
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\ws\encoding\XMLHTTPBindingCodec.class
