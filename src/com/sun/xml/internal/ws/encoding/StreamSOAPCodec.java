...
/*  98 */     this(binding.getSOAPVersion(), binding.<SerializationFeature>getFeature(SerializationFeature.class));
/*     */   }
/*     */   
/*     */   StreamSOAPCodec(WSFeatureList features) {
/* 102 */     this(WebServiceFeatureList.getSoapVersion(features), features.<SerializationFeature>get(SerializationFeature.class));
/*     */   }
/*     */   
...
/* 112 */     Iterator<StreamDecoder> iterator = ServiceFinder.<StreamDecoder>find(StreamDecoder.class).iterator(); if (iterator.hasNext()) { StreamDecoder sd = iterator.next();
/* 113 */       return sd; }
/*     */ 
/*     */     
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\ws\encoding\StreamSOAPCodec.class
