...
/*  95 */     this.codec = codec;
/*  96 */     this.sf = features.<SerializationFeature>get(SerializationFeature.class);
/*  97 */     MTOMFeature mtom = features.<MTOMFeature>get(MTOMFeature.class);
/*  98 */     if (mtom == null) {
...
/*     */ 
/*     */     
/* 301 */     XMLStreamReader mtomReader = new MtomXMLStreamReaderEx(mpp, XMLStreamReaderFactory.create(null, mpp.getRootPart().asInputStream(), charset, true));
/*     */ 
/*     */     
/* 304 */     packet.setMessage(this.codec.decode(mtomReader, new MimeAttachmentSet(mpp)));
...
/*     */         return;
/*     */       } 
/* 348 */       MtomCodec.ByteArrayBuffer bab = new MtomCodec.ByteArrayBuffer(new DataHandler(new ByteArrayDataSource(data, start, len, contentType)), this.boundary);
/* 349 */       writeBinary(bab);
/*     */     }
/*     */ 
/*     */ 
...
/* 426 */               return null;
/*     */             }
/* 428 */             MtomCodec.ByteArrayBuffer bab = new MtomCodec.ByteArrayBuffer(new DataHandler(new ByteArrayDataSource(data, offset, length, mimeType)), MtomCodec.MtomStreamWriterImpl.this.boundary);
...
/*     */     
/*     */     public NamespaceContextEx getNamespaceContext() {
/* 520 */       return new NamespaceContextExAdaper(this.reader.getNamespaceContext());
/*     */     }
/*     */ 
/*     */     
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\ws\encoding\MtomCodec.class
