...
/*  99 */       spiResourceLoader = container.<ResourceLoader>getSPI(ResourceLoader.class);
/*     */     }
/*     */ 
/*     */ 
/*     */     
...
/* 112 */       MetroConfigName mcn = container.<MetroConfigName>getSPI(MetroConfigName.class);
/* 113 */       if (mcn != null) {
...
/* 294 */       this((container != null) ? container.<ResourceLoader>getSPI(ResourceLoader.class) : null);
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\ws\assembler\MetroConfigLoader.class
