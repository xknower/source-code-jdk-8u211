...
/*  94 */     Marshaller m = this.context.marshallerPool.take();
...
/* 128 */     Marshaller m = this.context.marshallerPool.take();
...
/* 143 */     Marshaller m = this.context.marshallerPool.take();
...
/* 165 */     Marshaller m = this.context.marshallerPool.take();
...
/* 180 */     Marshaller m = this.context.marshallerPool.take();
...
/* 220 */     Unmarshaller u = this.context.unmarshallerPool.take();
...
/* 252 */     Unmarshaller u = this.context.unmarshallerPool.take();
...
/* 278 */     Unmarshaller u = this.context.unmarshallerPool.take();
...
/* 307 */     Unmarshaller u = this.context.unmarshallerPool.take();
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\bind\api\Bridge.class
