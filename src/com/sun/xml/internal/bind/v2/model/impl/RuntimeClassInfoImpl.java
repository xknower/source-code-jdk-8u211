...
/*     */     XmlAccessorFactory factoryAnn = reader().<XmlAccessorFactory>getClassAnnotation(XmlAccessorFactory.class, clazz, this);
/*     */     if (factoryAnn == null)
/*     */       factoryAnn = reader().<XmlAccessorFactory>getPackageAnnotation(XmlAccessorFactory.class, clazz, this); 
/*     */     return factoryAnn;
/*     */   }
/*     */   
...
/* 199 */     this.xducer = null; this.accessorFactory = createAccessorFactory(clazz);
...
/* 228 */       return null;
/*     */     }
/* 230 */     return new TransducerImpl(getClazz(), TransducedAccessor.get(((RuntimeModelBuilder)this.builder).context, valuep)); }
/*     */   
...
/* 278 */     if (reader().hasFieldAnnotation((Class)XmlLocation.class, f))
/*     */     {
/*     */       
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\bind\v2\model\impl\RuntimeClassInfoImpl.class
