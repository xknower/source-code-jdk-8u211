...
/*  99 */     XmlRootElement e = reader().<XmlRootElement>getClassAnnotation(XmlRootElement.class, clazz, this);
/* 100 */     if (e == null) {
/* 101 */       return null;
/*     */     }
...
/*     */       
/* 111 */       XmlSchema xs = reader().<XmlSchema>getPackageAnnotation(XmlSchema.class, clazz, this);
/* 112 */       if (xs != null) {
...
/* 123 */     return parseTypeName(clazz, reader().<XmlType>getClassAnnotation(XmlType.class, clazz, this));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */       
/* 155 */       XmlSchema xs = reader().<XmlSchema>getPackageAnnotation(XmlSchema.class, clazz, this);
/* 156 */       if (xs != null) {
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\bind\v2\model\impl\TypeInfoImpl.class
