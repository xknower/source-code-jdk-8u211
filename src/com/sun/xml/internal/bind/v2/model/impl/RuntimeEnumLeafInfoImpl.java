...
/*     */ 
/*     */       
/*  88 */       enum_ = (Enum)constant.get((Object)null);
...
/*  99 */             .format(new Object[] { literal, ((Type)this.baseType.getType()).toString() }, ), e, new FieldLocatable<>(this, constant, 
/* 100 */               nav())));
/*     */     } 
/*     */     
...
/*     */     String str;
/* 137 */     B b = this.baseXducer.parse(lexical);
/*     */     
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\bind\v2\model\impl\RuntimeEnumLeafInfoImpl.class
