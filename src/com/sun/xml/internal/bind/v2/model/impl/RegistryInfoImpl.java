...
/*  82 */       ElementInfoImpl<T, C, F, M> ei; XmlElementDecl em = builder.reader.<XmlElementDecl>getMethodAnnotation(XmlElementDecl.class, m, this);
/*     */ 
/*     */       
/*  85 */       if (em == null) {
/*  86 */         if (this.nav.getMethodName(m).startsWith("create"))
/*     */         {
/*  88 */           this.references.add(builder
/*  89 */               .getTypeInfo(this.nav.getReturnType(m), new MethodLocatable<>(this, m, this.nav)));
/*     */         }
/*     */ 
/*     */         
/*     */         continue;
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\bind\v2\model\impl\RegistryInfoImpl.class
