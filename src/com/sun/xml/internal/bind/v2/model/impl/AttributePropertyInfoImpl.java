...
/*  49 */     XmlAttribute att = seed.<XmlAttribute>readAnnotation(XmlAttribute.class);
/*  50 */     assert att != null;
/*     */     
/*  52 */     if (att.required())
...
/*  70 */       XmlSchema xs = reader().<XmlSchema>getPackageAnnotation(XmlSchema.class, this.parent.getClazz(), this);
/*     */ 
/*     */       
/*  73 */       if (xs != null) {
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\bind\v2\model\impl\AttributePropertyInfoImpl.class
