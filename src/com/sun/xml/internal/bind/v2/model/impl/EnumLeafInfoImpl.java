...
/*     */ 
/*     */     
/* 104 */     XmlEnum xe = builder.reader.<XmlEnum>getClassAnnotation(XmlEnum.class, clazz, this);
/* 105 */     if (xe != null) {
...
/* 123 */         XmlSchemaType schemaTypeAnnotation = this.builder.reader.<XmlSchemaType>getFieldAnnotation(XmlSchemaType.class, f, this);
...
/*     */       } 
/*     */     } 
/* 132 */     F[] constants = nav().getEnumConstants(this.clazz);
/* 133 */     for (int i = constants.length - 1; i >= 0; i--) {
/* 134 */       String literal; F constant = constants[i];
/* 135 */       String name = nav().getFieldName(constant);
/* 136 */       XmlEnumValue xev = this.builder.reader.<XmlEnumValue>getFieldAnnotation(XmlEnumValue.class, constant, this);
/*     */ 
/*     */       
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\bind\v2\model\impl\EnumLeafInfoImpl.class
