...
/*     */     } 
/*     */     
/* 225 */     List<AttributeProperty> attProps = new FinalArrayList<>();
/* 226 */     List<Property> uriProps = new FinalArrayList<>();
...
/*     */     } else {
/* 242 */       this.attributeProperties = attProps.<AttributeProperty<BeanT>>toArray((AttributeProperty<BeanT>[])new AttributeProperty[attProps.size()]);
/*     */     } 
/* 244 */     if (uriProps.isEmpty()) {
/* 245 */       this.uriProperties = (Property<BeanT>[])EMPTY_PROPERTIES;
/*     */     } else {
/* 247 */       this.uriProperties = uriProps.<Property<BeanT>>toArray((Property<BeanT>[])new Property[uriProps.size()]);
/*     */     } 
/*     */   }
/*     */   
/*     */   public void wrapUp() {
...
/* 270 */       bean = ClassFactory.create0(this.jaxbType);
/*     */     } else {
...
/*     */       
/*     */       try {
/* 283 */         this.xmlLocatorField.set(bean, new LocatorImpl(context.getLocator()));
...
/*     */       } 
/* 323 */       target.reportError(new ValidationEventImpl(1, message, null, null));
/*     */     } else {
...
/* 379 */         Map<QName, String> map = this.inheritedAttWildcard.get(bean);
...
/* 402 */         Map<QName, String> map = this.inheritedAttWildcard.get(bean);
...
/* 417 */         this.loaderWithTypeSubst = new XsiTypeLoader(this);
/*     */       } else {
/*     */         
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\bind\v2\runtime\ClassBeanInfoImpl.class
