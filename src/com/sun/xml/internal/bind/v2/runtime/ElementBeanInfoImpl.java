...
/*  78 */     super(grammar, rei, (Class)rei.getType(), true, false, true);
/*     */     
...
/*  84 */     this.scope = (rei.getScope() == null) ? JAXBElement.GlobalScope.class : rei.getScope().getClazz();
/*     */     
...
/* 242 */       JAXBElement<Object> e = (JAXBElement)state.getTarget();
...
/*     */     try {
/* 317 */       this.property.serializeBody(element, target, (Object)null);
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\bind\v2\runtime\ElementBeanInfoImpl.class
