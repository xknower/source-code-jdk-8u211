...
/*      */ 
/*      */     
/*  133 */     Name name = (nsUri == null || nsUri.isEmpty()) ? NameImpl.createFromUnqualifiedName(localName) : NameImpl.createFromQualifiedName(localName, nsUri);
...
/*  914 */     Name encodingStyleAttributeName = NameImpl.create("encodingStyle", soapNamespacePrefix, soapNamespace);
/*      */ 
/*      */ 
/*      */     
/*  918 */     this.encodingStyleAttribute.setName(encodingStyleAttributeName);
/*      */   }
/*      */   
...
/*      */             {
/* 1138 */               this
/* 1139 */                 .last = ((ElementImpl)element).convertToSoapElement((Element)this.last);
/*      */             }
/*      */ 
/*      */             
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\messaging\saaj\soap\impl\ElementImpl.class
