...
/* 1051 */           Iterator<E> eachAttachment = this.attachments.iterator();
/* 1052 */           while (eachAttachment.hasNext()) {
/* 1053 */             headerAndBody.addBodyPart(((AttachmentPartImpl)eachAttachment
/* 1054 */                 .next())
/* 1055 */                 .getMimePart());
/*      */           }
/*      */         } 
...
/* 1062 */           ((BMMimeMultipart)headerAndBody).setBoundary(((BMMimeMultipart)this.multiPart)
/* 1063 */               .getBoundary());
...
/* 1394 */     this.attachments.add((E)attachmentPart);
/*      */   }
/*      */ 
/*      */   
...
/*      */     
/* 1415 */     List<Header> headers = soapMessagePart.getAllHeaders();
/* 1416 */     int sz = headers.size();
/* 1417 */     for (int i = 0; i < sz; i++) {
/* 1418 */       Header h = headers.get(i);
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\messaging\saaj\soap\MessageImpl.class
