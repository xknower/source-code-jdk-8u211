...
/*     */       
/* 182 */       reasonText = this.faultStringElement.addChildElement(
...
/*     */       } else {
/*     */         
/* 191 */         reasonText = this.faultStringElement.addChildElement(
...
/* 321 */     this
/* 322 */       .faultActorElement = createSOAPFaultElement(getFaultActorName());
...
/*     */     
/* 441 */     Iterator<ElementImpl> subcodeElements = currentCodeElement.getChildElements(this.subcodeName);
/* 442 */     while (subcodeElements.hasNext()) {
/* 443 */       currentCodeElement = subcodeElements.next();
/*     */       
/* 445 */       Iterator<SOAPElement> valueElements = currentCodeElement.getChildElements(this.valueName);
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\messaging\saaj\soap\ver1_2\Fault1_2Impl.class
