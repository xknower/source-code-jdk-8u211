...
/*     */     
/* 228 */     SOAPHeaderElement upgradeHeaderElement = (SOAPHeaderElement)addChildElement(upgradeName);
/* 229 */     Name supportedEnvelopeName = getSupportedEnvelopeName();
/* 230 */     int i = 0;
/* 231 */     while (supportedSoapUris.hasNext()) {
/*     */       
/* 233 */       SOAPElement subElement = upgradeHeaderElement.addChildElement(supportedEnvelopeName);
/* 234 */       String ns = "ns" + Integer.toString(i);
/* 235 */       subElement.addAttribute(
/* 236 */           NameImpl.createFromUnqualifiedName("qname"), ns + ":Envelope");
/*     */       
...
/*     */     
/* 264 */     SOAPHeaderElement upgradeHeaderElement = (SOAPHeaderElement)addChildElement(upgradeName);
/* 265 */     Name supportedEnvelopeName = getSupportedEnvelopeName();
/* 266 */     for (int i = 0; i < supportedSoapUris.length; i++) {
/*     */       
/* 268 */       SOAPElement subElement = upgradeHeaderElement.addChildElement(supportedEnvelopeName);
/* 269 */       String ns = "ns" + Integer.toString(i);
/* 270 */       subElement.addAttribute(
/* 271 */           NameImpl.createFromUnqualifiedName("qname"), ns + ":Envelope");
/*     */       
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\messaging\saaj\soap\impl\HeaderImpl.class
