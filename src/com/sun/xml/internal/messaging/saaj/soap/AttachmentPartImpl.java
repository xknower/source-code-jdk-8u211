...
/*     */     try {
/* 317 */       List<Header> hdr = mbp.getAllHeaders();
/* 318 */       int sz = hdr.size();
/* 319 */       for (int i = 0; i < sz; i++) {
/* 320 */         Header h = hdr.get(i);
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\messaging\saaj\soap\AttachmentPartImpl.class
