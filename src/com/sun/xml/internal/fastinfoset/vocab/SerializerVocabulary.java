...
/*  64 */     this.tables[0] = this.restrictedAlphabet = new StringIntMap(4);
/*  65 */     this.tables[1] = this.encodingAlgorithm = new StringIntMap(4);
/*  66 */     this.tables[2] = this.prefix = new FixedEntryStringIntMap("xml", 8);
/*  67 */     this.tables[3] = this.namespaceName = new FixedEntryStringIntMap("http://www.w3.org/XML/1998/namespace", 8);
/*  68 */     this.tables[4] = this.localName = new StringIntMap();
/*  69 */     this.tables[5] = this.otherNCName = new StringIntMap(4);
/*  70 */     this.tables[6] = this.otherURI = new StringIntMap(4);
/*  71 */     this.tables[7] = this.attributeValue = new StringIntMap();
/*  72 */     this.tables[8] = this.otherString = new CharArrayIntMap(4);
/*  73 */     this.tables[9] = this.characterContentChunk = new CharArrayIntMap();
/*  74 */     this.tables[10] = this.elementName = new LocalNameQualifiedNamesMap();
/*  75 */     this.tables[11] = this.attributeName = new LocalNameQualifiedNamesMap();
/*     */   }
/*     */ 
/*     */   
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\fastinfoset\vocab\SerializerVocabulary.class
