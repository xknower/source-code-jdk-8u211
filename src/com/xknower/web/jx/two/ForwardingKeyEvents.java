...
/**
 * JxBrowser API provides functionality that allows forwarding keyboard events to
 * the currently focused element on the currently loaded web page.
 * <p>
 * This functionality is useful when you need to programmatically send keyboard events to a web page.
 * For example, if you develop a Web-base Kiosk Java application that should run on a terminal/PC
 * with a touch screen monitor and no physical keyboard,
 * you might want to display your own screen keyboard.
 * The end user will use this screen keyboard to type on the loaded web page.
 * In this case the screen keyboard can programmatically forward the appropriate key events
 * to the currently loaded web page using this functionality.
 * <p>
 * The following example demonstrates how to programmatically send keyboard events to type text
 * and press Enter in the currently focused textarea on the loaded web page:
 * <p>
 ...
 */
public class ForwardingKeyEvents {
