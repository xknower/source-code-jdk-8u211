...
/**
 * JxBrowser provides functionality that allows injecting Java object into JavaScript code.
 * By default, all public fields and methods of the injected Java object is accessible from JavaScript,
 * so JavaScript code can access them. To tell JavaScript code what public fields/methods
 * of the injected Java object can be accessible from JavaScript you can use @JSAccessible annotation.
 * If you need to let JavaScript code to access only specific public fields/methods,
 * then you must mark them with the @JSAccessible annotation. For example:
 * <p>
 * Java
 * public class JavaObject {
 *
 * @JSAccessible public String accessibleField;
 * public String nonAccessibleField;
 * <p>
 * public void doAction() {
 * }
 * @JSAccessible public void doAccessibleAction() {
 * }
 * }
 */

/**
 * If you inject the JavaObject into JavaScript code, then JavaScript will be able to access only the accessibleField public field
 * and the doAccessibleAction() public method. If JavaScript tries to access other public fields or methods,
 * an exception in JavaScript code will be thrown.
 * <p>
 * Complete example:
 * <p>
 ...
 */
public class JSAccessibleSimple {
