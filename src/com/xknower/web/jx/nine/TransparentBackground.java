...
/**
 * In JxBrowser 6.10 and higher, there's functionality that allows enabling support of transparent background
 * on the web page. The following example demonstrates how to enable support of transparent background:
 * <p>
