...
/**
 * Heavyweight
 * In the default, heavyweight rendering mode, full screen video is enabled and supported.
 * <p>
 * Lightweight
 * In the lightweight rendering mode full screen functionality is disabled by default.
 * To enable it, you must implement and register FullScreenHandler where you must track full screen enter/exit events
 * and show/hide full screen window using appropriate Swing or JavaFX functionality.
 * <p>
