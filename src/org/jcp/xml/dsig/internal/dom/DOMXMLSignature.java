...
/*     */     
/* 352 */     List<? extends Reference> list = this.si.getReferences();
...
/*     */       
/* 359 */       List list1 = xMLObject.getContent();
...
/*     */           
/* 365 */           List list2 = manifest.getReferences();
...
/* 474 */           List<DOMReference> list = manifest.getReferences(); byte b; int i;
/* 475 */           for (b = 0, i = list.size(); b < i; b++) {
/* 476 */             digestReference(list.get(b), paramXMLSignContext);
/*     */           }
/*     */         } 
/*     */       } 
/*     */ 
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\org\jcp\xml\dsig\internal\dom\DOMXMLSignature.class
