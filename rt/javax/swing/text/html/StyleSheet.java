...
/*      */     
/*      */     CssParser() {
/* 3297 */       this.selectors = (Vector)new Vector<>();
/* 3298 */       this.selectorTokens = new Vector<>();
/*      */ 
/*      */       
/* 3301 */       this.declaration = new SimpleAttributeSet();
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */       
/* 3309 */       this.parser = new CSSParser();
/*      */     } public AttributeSet parseDeclaration(String param1String) { try { return parseDeclaration(new StringReader(param1String)); } catch (IOException iOException) { return null; }  } public AttributeSet parseDeclaration(Reader param1Reader) throws IOException { parse(this.base, param1Reader, true, false); return this.declaration.copyAttributes(); } public void parse(URL param1URL, Reader param1Reader, boolean param1Boolean1, boolean param1Boolean2) throws IOException { this.base = param1URL; this.isLink = param1Boolean2; this.parsingDeclaration = param1Boolean1; this.declaration.removeAttributes(this.declaration); this.selectorTokens.removeAllElements(); this.selectors.removeAllElements(); this.propertyName = null; this.parser.parse(param1Reader, this, param1Boolean1); } public void handleImport(String param1String) { URL uRL = CSS.getURL(this.base, param1String); if (uRL != null) StyleSheet.this.importStyleSheet(uRL);  } public void handleSelector(String param1String) { if (!param1String.startsWith(".") && !param1String.startsWith("#")) param1String = param1String.toLowerCase();  int i = param1String.length(); if (param1String.endsWith(",")) { if (i > 1) { param1String = param1String.substring(0, i - 1); this.selectorTokens.addElement(param1String); }  addSelector(); } else if (i > 0) { this.selectorTokens.addElement(param1String); }  } public void startRule() { if (this.selectorTokens.size() > 0) addSelector();  this.propertyName = null; } public void handleProperty(String param1String) { this.propertyName = param1String; }
/*      */     public void handleValue(String param1String) { if (this.propertyName != null && param1String != null && param1String.length() > 0) { CSS.Attribute attribute = CSS.getAttribute(this.propertyName); if (attribute != null) { if (attribute == CSS.Attribute.LIST_STYLE_IMAGE && param1String != null && !param1String.equals("none")) { URL uRL = CSS.getURL(this.base, param1String); if (uRL != null) param1String = uRL.toString();  }  StyleSheet.this.addCSSAttribute(this.declaration, attribute, param1String); }  this.propertyName = null; }  }
/*      */     public void endRule() { int i = this.selectors.size(); for (byte b = 0; b < i; b++) { String[] arrayOfString = this.selectors.elementAt(b); if (arrayOfString.length > 0) StyleSheet.this.addRule(arrayOfString, this.declaration, this.isLink);  }  this.declaration.removeAttributes(this.declaration); this.selectors.removeAllElements(); }
/*      */     private void addSelector() { String[] arrayOfString = new String[this.selectorTokens.size()]; this.selectorTokens.copyInto((Object[])arrayOfString); this.selectors.addElement(arrayOfString); this.selectorTokens.removeAllElements(); } }
/* 3314 */   void rebaseSizeMap(int paramInt) { this.sizeMap = new int[sizeMapDefault.length];
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\javax\swing\text\html\StyleSheet.class
