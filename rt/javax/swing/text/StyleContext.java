...
/* 1591 */       this.listenerList = new EventListenerList();
/*      */ 
/*      */ 
/*      */ 
/*      */ 
/*      */ 
/*      */       
/* 1598 */       this.changeEvent = null; this.attributes = StyleContext.this.getEmptySet(); if (param1String != null) setName(param1String);  if (param1Style != null) setResolveParent(param1Style);  } public NamedStyle(Style param1Style) { this(null, param1Style); } public NamedStyle() { this.listenerList = new EventListenerList(); this.changeEvent = null; this.attributes = StyleContext.this.getEmptySet(); } public String toString() { return "NamedStyle:" + getName() + " " + this.attributes; } public String getName() { if (isDefined(StyleConstants.NameAttribute)) return getAttribute(StyleConstants.NameAttribute).toString();  return null; } public void setName(String param1String) { if (param1String != null) addAttribute(StyleConstants.NameAttribute, param1String);  } public void addChangeListener(ChangeListener param1ChangeListener) { this.listenerList.add(ChangeListener.class, param1ChangeListener); } public void removeChangeListener(ChangeListener param1ChangeListener) { this.listenerList.remove(ChangeListener.class, param1ChangeListener); } public ChangeListener[] getChangeListeners() { return this.listenerList.<ChangeListener>getListeners(ChangeListener.class); } protected void fireStateChanged() { Object[] arrayOfObject = this.listenerList.getListenerList(); for (int i = arrayOfObject.length - 2; i >= 0; i -= 2) { if (arrayOfObject[i] == ChangeListener.class) { if (this.changeEvent == null) this.changeEvent = new ChangeEvent(this);  ((ChangeListener)arrayOfObject[i + 1]).stateChanged(this.changeEvent); }  }  } public <T extends java.util.EventListener> T[] getListeners(Class<T> param1Class) { return this.listenerList.getListeners(param1Class); } public int getAttributeCount() { return this.attributes.getAttributeCount(); } public boolean isDefined(Object param1Object) { return this.attributes.isDefined(param1Object); } public boolean isEqual(AttributeSet param1AttributeSet) { return this.attributes.isEqual(param1AttributeSet); } public AttributeSet copyAttributes() { NamedStyle namedStyle = new NamedStyle(); namedStyle.attributes = this.attributes.copyAttributes(); return namedStyle; } public Object getAttribute(Object param1Object) { return this.attributes.getAttribute(param1Object); }
...
/*      */     public void addAttribute(Object param1Object1, Object param1Object2) { StyleContext styleContext = StyleContext.this; this.attributes = styleContext.addAttribute(this.attributes, param1Object1, param1Object2); fireStateChanged(); }
/*      */     public void addAttributes(AttributeSet param1AttributeSet) { StyleContext styleContext = StyleContext.this; this.attributes = styleContext.addAttributes(this.attributes, param1AttributeSet); fireStateChanged(); }
/*      */     public void removeAttribute(Object param1Object) { StyleContext styleContext = StyleContext.this; this.attributes = styleContext.removeAttribute(this.attributes, param1Object); fireStateChanged(); }
/*      */     public void removeAttributes(Enumeration<?> param1Enumeration) { StyleContext styleContext = StyleContext.this; this.attributes = styleContext.removeAttributes(this.attributes, param1Enumeration); fireStateChanged(); }
/*      */     public void removeAttributes(AttributeSet param1AttributeSet) { StyleContext styleContext = StyleContext.this; if (param1AttributeSet == this) { this.attributes = styleContext.getEmptySet(); } else { this.attributes = styleContext.removeAttributes(this.attributes, param1AttributeSet); }  fireStateChanged(); }
/*      */     public void setResolveParent(AttributeSet param1AttributeSet) { if (param1AttributeSet != null) { addAttribute(StyleConstants.ResolveAttribute, param1AttributeSet); } else { removeAttribute(StyleConstants.ResolveAttribute); }  }
/*      */     private void writeObject(ObjectOutputStream param1ObjectOutputStream) throws IOException { param1ObjectOutputStream.defaultWriteObject(); StyleContext.writeAttributeSet(param1ObjectOutputStream, this.attributes); }
/*      */     private void readObject(ObjectInputStream param1ObjectInputStream) throws ClassNotFoundException, IOException { param1ObjectInputStream.defaultReadObject(); this.attributes = SimpleAttributeSet.EMPTY; StyleContext.readAttributeSet(param1ObjectInputStream, this); } }
/* 1611 */   static { try { int i = StyleConstants.keys.length;
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\javax\swing\text\StyleContext.class
