...
/* 8282 */         AccessibleContext accessibleContext = getCurrentAccessibleContext();
/* 8283 */         if (accessibleContext instanceof AccessibleComponent) {
/* 8284 */           return ((AccessibleComponent)accessibleContext).getBackground();
/*      */         }
/* 8286 */         Component component = getCurrentComponent();
/* 8287 */         if (component != null) {
/* 8288 */           return component.getBackground();
/*      */         }
/* 8290 */         return null;
/*      */       }
/*      */ 
...
/* 8301 */         AccessibleContext accessibleContext = getCurrentAccessibleContext();
/* 8302 */         if (accessibleContext instanceof AccessibleComponent) {
/* 8303 */           ((AccessibleComponent)accessibleContext).setBackground(param2Color);
/*      */         } else {
/* 8305 */           Component component = getCurrentComponent();
/* 8306 */           if (component != null) {
/* 8307 */             component.setBackground(param2Color);
/*      */           }
/*      */         } 
/*      */       }
/*      */ 
...
/* 8319 */         AccessibleContext accessibleContext = getCurrentAccessibleContext();
/* 8320 */         if (accessibleContext instanceof AccessibleComponent) {
/* 8321 */           return ((AccessibleComponent)accessibleContext).getForeground();
/*      */         }
/* 8323 */         Component component = getCurrentComponent();
/* 8324 */         if (component != null) {
/* 8325 */           return component.getForeground();
/*      */         }
/* 8327 */         return null;
/*      */       }
/*      */ 
...
/* 8338 */         AccessibleContext accessibleContext = getCurrentAccessibleContext();
/* 8339 */         if (accessibleContext instanceof AccessibleComponent) {
/* 8340 */           ((AccessibleComponent)accessibleContext).setForeground(param2Color);
/*      */         } else {
/* 8342 */           Component component = getCurrentComponent();
/* 8343 */           if (component != null) {
/* 8344 */             component.setForeground(param2Color);
/*      */           }
/*      */         } 
/*      */       }
/*      */ 
...
/* 8356 */         AccessibleContext accessibleContext = getCurrentAccessibleContext();
/* 8357 */         if (accessibleContext instanceof AccessibleComponent) {
/* 8358 */           return ((AccessibleComponent)accessibleContext).getCursor();
/*      */         }
/* 8360 */         Component component = getCurrentComponent();
/* 8361 */         if (component != null) {
/* 8362 */           return component.getCursor();
/*      */         }
/* 8364 */         Accessible accessible = getAccessibleParent();
/* 8365 */         if (accessible instanceof AccessibleComponent) {
/* 8366 */           return ((AccessibleComponent)accessible).getCursor();
/*      */         }
/* 8368 */         return null;
/*      */       }
/*      */ 
...
/* 8380 */         AccessibleContext accessibleContext = getCurrentAccessibleContext();
/* 8381 */         if (accessibleContext instanceof AccessibleComponent) {
/* 8382 */           ((AccessibleComponent)accessibleContext).setCursor(param2Cursor);
/*      */         } else {
/* 8384 */           Component component = getCurrentComponent();
/* 8385 */           if (component != null) {
/* 8386 */             component.setCursor(param2Cursor);
/*      */           }
/*      */         } 
/*      */       }
/*      */ 
...
/*      */       
/*      */       public Font getFont() {
/* 8398 */         AccessibleContext accessibleContext = getCurrentAccessibleContext();
/* 8399 */         if (accessibleContext instanceof AccessibleComponent) {
/* 8400 */           return ((AccessibleComponent)accessibleContext).getFont();
/*      */         }
/* 8402 */         Component component = getCurrentComponent();
/* 8403 */         if (component != null) {
/* 8404 */           return component.getFont();
/*      */         }
/* 8406 */         return null;
/*      */       }
/*      */ 
...
/* 8417 */         AccessibleContext accessibleContext = getCurrentAccessibleContext();
/* 8418 */         if (accessibleContext instanceof AccessibleComponent) {
/* 8419 */           ((AccessibleComponent)accessibleContext).setFont(param2Font);
/*      */         } else {
/* 8421 */           Component component = getCurrentComponent();
/* 8422 */           if (component != null) {
/* 8423 */             component.setFont(param2Font);
/*      */           }
/*      */         } 
/*      */       }
/*      */ 
...
/* 8439 */           return ((AccessibleComponent)accessibleContext).getFontMetrics(param2Font);
/*      */         }
/* 8441 */         Component component = getCurrentComponent();
/* 8442 */         if (component != null) {
/* 8443 */           return component.getFontMetrics(param2Font);
/*      */         }
/* 8445 */         return null;
/*      */       }
/*      */ 
...
/* 8456 */         AccessibleContext accessibleContext = getCurrentAccessibleContext();
/* 8457 */         if (accessibleContext instanceof AccessibleComponent) {
/* 8458 */           return ((AccessibleComponent)accessibleContext).isEnabled();
/*      */         }
/* 8460 */         Component component = getCurrentComponent();
/* 8461 */         if (component != null) {
/* 8462 */           return component.isEnabled();
/*      */         }
/* 8464 */         return false;
/*      */       }
/*      */ 
...
/* 8475 */         AccessibleContext accessibleContext = getCurrentAccessibleContext();
/* 8476 */         if (accessibleContext instanceof AccessibleComponent) {
/* 8477 */           ((AccessibleComponent)accessibleContext).setEnabled(param2Boolean);
/*      */         } else {
/* 8479 */           Component component = getCurrentComponent();
/* 8480 */           if (component != null) {
/* 8481 */             component.setEnabled(param2Boolean);
/*      */           }
/*      */         } 
/*      */       }
/*      */ 
...
/* 8496 */         AccessibleContext accessibleContext = getCurrentAccessibleContext();
/* 8497 */         if (accessibleContext instanceof AccessibleComponent) {
/* 8498 */           return ((AccessibleComponent)accessibleContext).isVisible();
/*      */         }
/* 8500 */         Component component = getCurrentComponent();
/* 8501 */         if (component != null) {
/* 8502 */           return component.isVisible();
/*      */         }
/* 8504 */         return false;
/*      */       }
/*      */ 
...
/* 8515 */         AccessibleContext accessibleContext = getCurrentAccessibleContext();
/* 8516 */         if (accessibleContext instanceof AccessibleComponent) {
/* 8517 */           ((AccessibleComponent)accessibleContext).setVisible(param2Boolean);
/*      */         } else {
/* 8519 */           Component component = getCurrentComponent();
/* 8520 */           if (component != null) {
/* 8521 */             component.setVisible(param2Boolean);
/*      */           }
/*      */         } 
/*      */       }
/*      */ 
...
/* 8536 */         AccessibleContext accessibleContext = getCurrentAccessibleContext();
/* 8537 */         if (accessibleContext instanceof AccessibleComponent) {
/* 8538 */           if (accessibleContext.getAccessibleParent() != null) {
/* 8539 */             return ((AccessibleComponent)accessibleContext).isShowing();
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/*      */         } 
/*      */         
/* 8547 */         Component component = getCurrentComponent();
/* 8548 */         if (component != null) {
/* 8549 */           return component.isShowing();
/*      */         }
/* 8551 */         return false;
/*      */       }
/*      */ 
...
/* 8568 */         AccessibleContext accessibleContext = getCurrentAccessibleContext();
/* 8569 */         if (accessibleContext instanceof AccessibleComponent) {
/* 8570 */           Rectangle rectangle = ((AccessibleComponent)accessibleContext).getBounds();
/* 8571 */           return rectangle.contains(param2Point);
/*      */         } 
/* 8573 */         Component component = getCurrentComponent();
/* 8574 */         if (component != null) {
/* 8575 */           Rectangle rectangle = component.getBounds();
/* 8576 */           return rectangle.contains(param2Point);
/*      */         } 
/* 8578 */         return getBounds().contains(param2Point);
/*      */       }
/*      */ 
/*      */ 
/*      */ 
...
/* 8590 */         if (this.parent != null && this.parent.isShowing()) {
/* 8591 */           Point point1 = this.parent.getLocationOnScreen();
/* 8592 */           Point point2 = getLocation();
/* 8593 */           point2.translate(point1.x, point1.y);
/* 8594 */           return point2;
/*      */         } 
/* 8596 */         return null;
/*      */       }
...
/* 8611 */         if (this.parent != null) {
/* 8612 */           Rectangle rectangle = this.parent.getCellRect(this.row, this.column, false);
/* 8613 */           if (rectangle != null) {
/* 8614 */             return rectangle.getLocation();
/*      */           }
/*      */         } 
/* 8617 */         return null;
/*      */       }
...
/* 8630 */         if (this.parent != null) {
/* 8631 */           return this.parent.getCellRect(this.row, this.column, false);
/*      */         }
/* 8633 */         return null;
/*      */       }
/*      */ 
...
/* 8638 */         AccessibleContext accessibleContext = getCurrentAccessibleContext();
/* 8639 */         if (accessibleContext instanceof AccessibleComponent) {
/* 8640 */           ((AccessibleComponent)accessibleContext).setBounds(param2Rectangle);
/*      */         } else {
/* 8642 */           Component component = getCurrentComponent();
/* 8643 */           if (component != null) {
/* 8644 */             component.setBounds(param2Rectangle);
/*      */           }
/*      */         } 
/*      */       }
/*      */       
...
/* 8651 */           Rectangle rectangle = this.parent.getCellRect(this.row, this.column, false);
/* 8652 */           if (rectangle != null) {
/* 8653 */             return rectangle.getSize();
/*      */           }
/*      */         } 
/* 8656 */         return null;
/*      */       }
...
/* 8660 */         AccessibleContext accessibleContext = getCurrentAccessibleContext();
/* 8661 */         if (accessibleContext instanceof AccessibleComponent) {
/* 8662 */           ((AccessibleComponent)accessibleContext).setSize(param2Dimension);
/*      */         } else {
/* 8664 */           Component component = getCurrentComponent();
/* 8665 */           if (component != null) {
/* 8666 */             component.setSize(param2Dimension);
/*      */           }
/*      */         } 
/*      */       }
/*      */       
/*      */       public Accessible getAccessibleAt(Point param2Point) {
/* 8672 */         AccessibleContext accessibleContext = getCurrentAccessibleContext();
/* 8673 */         if (accessibleContext instanceof AccessibleComponent) {
/* 8674 */           return ((AccessibleComponent)accessibleContext).getAccessibleAt(param2Point);
/*      */         }
/* 8676 */         return null;
/*      */       }
/*      */ 
...
/* 8681 */         AccessibleContext accessibleContext = getCurrentAccessibleContext();
/* 8682 */         if (accessibleContext instanceof AccessibleComponent) {
/* 8683 */           return ((AccessibleComponent)accessibleContext).isFocusTraversable();
/*      */         }
/* 8685 */         Component component = getCurrentComponent();
/* 8686 */         if (component != null) {
/* 8687 */           return component.isFocusTraversable();
/*      */         }
/* 8689 */         return false;
/*      */       }
/*      */ 
...
/* 8695 */         AccessibleContext accessibleContext = getCurrentAccessibleContext();
/* 8696 */         if (accessibleContext instanceof AccessibleComponent) {
/* 8697 */           ((AccessibleComponent)accessibleContext).requestFocus();
/*      */         } else {
/* 8699 */           Component component = getCurrentComponent();
/* 8700 */           if (component != null) {
/* 8701 */             component.requestFocus();
/*      */           }
/*      */         } 
/*      */       }
/*      */       
/*      */       public void addFocusListener(FocusListener param2FocusListener) {
/* 8707 */         AccessibleContext accessibleContext = getCurrentAccessibleContext();
/* 8708 */         if (accessibleContext instanceof AccessibleComponent) {
/* 8709 */           ((AccessibleComponent)accessibleContext).addFocusListener(param2FocusListener);
/*      */         } else {
/* 8711 */           Component component = getCurrentComponent();
/* 8712 */           if (component != null) {
/* 8713 */             component.addFocusListener(param2FocusListener);
/*      */           }
/*      */         } 
/*      */       }
/*      */       
/*      */       public void removeFocusListener(FocusListener param2FocusListener) {
/* 8719 */         AccessibleContext accessibleContext = getCurrentAccessibleContext();
/* 8720 */         if (accessibleContext instanceof AccessibleComponent) {
/* 8721 */           ((AccessibleComponent)accessibleContext).removeFocusListener(param2FocusListener);
/*      */         } else {
/* 8723 */           Component component = getCurrentComponent();
/* 8724 */           if (component != null) {
/* 8725 */             component.removeFocusListener(param2FocusListener);
/*      */           }
/*      */         } 
/*      */       }
/*      */     }
...
/* 8756 */         this.row = param2Int1;
/* 8757 */         this.column = param2Int2;
/* 8758 */         this.parent = param2JTableHeader;
/* 8759 */         this.rendererComponent = param2Component;
/* 8760 */         setAccessibleParent(param2JTableHeader);
/*      */       }
/*      */ 
/*      */ 
/*      */ 
...
/* 8780 */         return this.rendererComponent.getAccessibleContext();
/*      */       }
/*      */ 
/*      */ 
/*      */ 
...
/* 8787 */         return this.rendererComponent;
/*      */       }
/*      */ 
/*      */ 
/*      */ 
...
/*      */       
/*      */       public String getAccessibleName() {
/* 8799 */         AccessibleContext accessibleContext = getCurrentAccessibleContext();
/* 8800 */         if (accessibleContext != null) {
/* 8801 */           String str = accessibleContext.getAccessibleName();
/* 8802 */           if (str != null && str != "") {
/* 8803 */             return accessibleContext.getAccessibleName();
/*      */           }
/*      */         } 
/* 8806 */         if (this.accessibleName != null && this.accessibleName != "") {
/* 8807 */           return this.accessibleName;
/*      */         }
/* 8809 */         return null;
/*      */       }
/*      */ 
...
/* 8821 */           accessibleContext.setAccessibleName(param2String);
/*      */         } else {
/* 8823 */           super.setAccessibleName(param2String);
/*      */         } 
/*      */       }
/*      */ 
/*      */ 
...
/*      */       
/*      */       public String getAccessibleDescription() {
/* 8835 */         AccessibleContext accessibleContext = getCurrentAccessibleContext();
/* 8836 */         if (accessibleContext != null) {
/* 8837 */           return accessibleContext.getAccessibleDescription();
/*      */         }
...
/*      */       
/*      */       public void setAccessibleDescription(String param2String) {
/* 8849 */         AccessibleContext accessibleContext = getCurrentAccessibleContext();
/* 8850 */         if (accessibleContext != null) {
/* 8851 */           accessibleContext.setAccessibleDescription(param2String);
/*      */         } else {
/* 8853 */           super.setAccessibleDescription(param2String);
/*      */         } 
/*      */       }
/*      */ 
/*      */ 
...
/*      */       
/*      */       public AccessibleRole getAccessibleRole() {
/* 8865 */         AccessibleContext accessibleContext = getCurrentAccessibleContext();
/* 8866 */         if (accessibleContext != null) {
/* 8867 */           return accessibleContext.getAccessibleRole();
/*      */         }
...
/*      */       
/*      */       public AccessibleStateSet getAccessibleStateSet() {
/* 8881 */         AccessibleContext accessibleContext = getCurrentAccessibleContext();
/* 8882 */         AccessibleStateSet accessibleStateSet = null;
/*      */         
/* 8884 */         if (accessibleContext != null) {
/* 8885 */           accessibleStateSet = accessibleContext.getAccessibleStateSet();
/*      */         }
/* 8887 */         if (accessibleStateSet == null) {
/* 8888 */           accessibleStateSet = new AccessibleStateSet();
/*      */         }
/* 8890 */         Rectangle rectangle1 = JTable.this.getVisibleRect();
/* 8891 */         Rectangle rectangle2 = JTable.this.getCellRect(this.row, this.column, false);
/* 8892 */         if (rectangle1.intersects(rectangle2)) {
/* 8893 */           accessibleStateSet.add(AccessibleState.SHOWING);
/*      */         }
/* 8895 */         else if (accessibleStateSet.contains(AccessibleState.SHOWING)) {
/* 8896 */           accessibleStateSet.remove(AccessibleState.SHOWING);
/*      */         } 
/*      */         
/* 8899 */         if (JTable.this.isCellSelected(this.row, this.column)) {
/* 8900 */           accessibleStateSet.add(AccessibleState.SELECTED);
/* 8901 */         } else if (accessibleStateSet.contains(AccessibleState.SELECTED)) {
/* 8902 */           accessibleStateSet.remove(AccessibleState.SELECTED);
/*      */         } 
/* 8904 */         if (this.row == JTable.this.getSelectedRow() && this.column == JTable.this.getSelectedColumn()) {
/* 8905 */           accessibleStateSet.add(AccessibleState.ACTIVE);
/*      */         }
/* 8907 */         accessibleStateSet.add(AccessibleState.TRANSIENT);
/* 8908 */         return accessibleStateSet;
/*      */       }
/*      */ 
/*      */ 
/*      */ 
...
/*      */       
/*      */       public int getAccessibleChildrenCount() {
/* 8939 */         AccessibleContext accessibleContext = getCurrentAccessibleContext();
/* 8940 */         if (accessibleContext != null) {
/* 8941 */           return accessibleContext.getAccessibleChildrenCount();
/*      */         }
/* 8943 */         return 0;
/*      */       }
/*      */ 
...
/*      */       
/*      */       public Accessible getAccessibleChild(int param2Int) {
/* 8955 */         AccessibleContext accessibleContext = getCurrentAccessibleContext();
/* 8956 */         if (accessibleContext != null) {
/* 8957 */           Accessible accessible = accessibleContext.getAccessibleChild(param2Int);
/* 8958 */           accessibleContext.setAccessibleParent(this);
/* 8959 */           return accessible;
/*      */         } 
/* 8961 */         return null;
/*      */       }
/*      */ 
...
/*      */       
/*      */       public Locale getLocale() {
/* 8980 */         AccessibleContext accessibleContext = getCurrentAccessibleContext();
/* 8981 */         if (accessibleContext != null) {
/* 8982 */           return accessibleContext.getLocale();
/*      */         }
/* 8984 */         return null;
/*      */       }
/*      */ 
...
/*      */       
/*      */       public void addPropertyChangeListener(PropertyChangeListener param2PropertyChangeListener) {
/* 8996 */         AccessibleContext accessibleContext = getCurrentAccessibleContext();
/* 8997 */         if (accessibleContext != null) {
/* 8998 */           accessibleContext.addPropertyChangeListener(param2PropertyChangeListener);
/*      */         } else {
/* 9000 */           super.addPropertyChangeListener(param2PropertyChangeListener);
/*      */         } 
/*      */       }
/*      */ 
/*      */ 
...
/*      */       
/*      */       public void removePropertyChangeListener(PropertyChangeListener param2PropertyChangeListener) {
/* 9013 */         AccessibleContext accessibleContext = getCurrentAccessibleContext();
/* 9014 */         if (accessibleContext != null) {
/* 9015 */           accessibleContext.removePropertyChangeListener(param2PropertyChangeListener);
/*      */         } else {
/* 9017 */           super.removePropertyChangeListener(param2PropertyChangeListener);
/*      */         } 
/*      */       }
/*      */ 
/*      */ 
...
/*      */       
/*      */       public Color getBackground() {
/* 9083 */         AccessibleContext accessibleContext = getCurrentAccessibleContext();
/* 9084 */         if (accessibleContext instanceof AccessibleComponent) {
/* 9085 */           return ((AccessibleComponent)accessibleContext).getBackground();
/*      */         }
/* 9087 */         Component component = getCurrentComponent();
/* 9088 */         if (component != null) {
/* 9089 */           return component.getBackground();
/*      */         }
/* 9091 */         return null;
/*      */       }
/*      */ 
...
/*      */       
/*      */       public void setBackground(Color param2Color) {
/* 9102 */         AccessibleContext accessibleContext = getCurrentAccessibleContext();
/* 9103 */         if (accessibleContext instanceof AccessibleComponent) {
/* 9104 */           ((AccessibleComponent)accessibleContext).setBackground(param2Color);
/*      */         } else {
/* 9106 */           Component component = getCurrentComponent();
/* 9107 */           if (component != null) {
/* 9108 */             component.setBackground(param2Color);
/*      */           }
/*      */         } 
/*      */       }
/*      */ 
...
/*      */       
/*      */       public Color getForeground() {
/* 9120 */         AccessibleContext accessibleContext = getCurrentAccessibleContext();
/* 9121 */         if (accessibleContext instanceof AccessibleComponent) {
/* 9122 */           return ((AccessibleComponent)accessibleContext).getForeground();
/*      */         }
/* 9124 */         Component component = getCurrentComponent();
/* 9125 */         if (component != null) {
/* 9126 */           return component.getForeground();
/*      */         }
/* 9128 */         return null;
/*      */       }
/*      */ 
...
/*      */       
/*      */       public void setForeground(Color param2Color) {
/* 9139 */         AccessibleContext accessibleContext = getCurrentAccessibleContext();
/* 9140 */         if (accessibleContext instanceof AccessibleComponent) {
/* 9141 */           ((AccessibleComponent)accessibleContext).setForeground(param2Color);
/*      */         } else {
/* 9143 */           Component component = getCurrentComponent();
/* 9144 */           if (component != null) {
/* 9145 */             component.setForeground(param2Color);
/*      */           }
/*      */         } 
/*      */       }
/*      */ 
...
/*      */       
/*      */       public Cursor getCursor() {
/* 9157 */         AccessibleContext accessibleContext = getCurrentAccessibleContext();
/* 9158 */         if (accessibleContext instanceof AccessibleComponent) {
/* 9159 */           return ((AccessibleComponent)accessibleContext).getCursor();
/*      */         }
/* 9161 */         Component component = getCurrentComponent();
/* 9162 */         if (component != null) {
/* 9163 */           return component.getCursor();
/*      */         }
/* 9165 */         Accessible accessible = getAccessibleParent();
/* 9166 */         if (accessible instanceof AccessibleComponent) {
/* 9167 */           return ((AccessibleComponent)accessible).getCursor();
/*      */         }
/* 9169 */         return null;
/*      */       }
/*      */ 
...
/*      */       
/*      */       public void setCursor(Cursor param2Cursor) {
/* 9181 */         AccessibleContext accessibleContext = getCurrentAccessibleContext();
/* 9182 */         if (accessibleContext instanceof AccessibleComponent) {
/* 9183 */           ((AccessibleComponent)accessibleContext).setCursor(param2Cursor);
/*      */         } else {
/* 9185 */           Component component = getCurrentComponent();
/* 9186 */           if (component != null) {
/* 9187 */             component.setCursor(param2Cursor);
/*      */           }
/*      */         } 
/*      */       }
/*      */ 
...
/*      */       
/*      */       public Font getFont() {
/* 9199 */         AccessibleContext accessibleContext = getCurrentAccessibleContext();
/* 9200 */         if (accessibleContext instanceof AccessibleComponent) {
/* 9201 */           return ((AccessibleComponent)accessibleContext).getFont();
/*      */         }
/* 9203 */         Component component = getCurrentComponent();
/* 9204 */         if (component != null) {
/* 9205 */           return component.getFont();
/*      */         }
/* 9207 */         return null;
/*      */       }
/*      */ 
...
/*      */       
/*      */       public void setFont(Font param2Font) {
/* 9218 */         AccessibleContext accessibleContext = getCurrentAccessibleContext();
/* 9219 */         if (accessibleContext instanceof AccessibleComponent) {
/* 9220 */           ((AccessibleComponent)accessibleContext).setFont(param2Font);
/*      */         } else {
/* 9222 */           Component component = getCurrentComponent();
/* 9223 */           if (component != null) {
/* 9224 */             component.setFont(param2Font);
/*      */           }
/*      */         } 
/*      */       }
/*      */ 
...
/*      */       
/*      */       public FontMetrics getFontMetrics(Font param2Font) {
/* 9238 */         AccessibleContext accessibleContext = getCurrentAccessibleContext();
/* 9239 */         if (accessibleContext instanceof AccessibleComponent) {
/* 9240 */           return ((AccessibleComponent)accessibleContext).getFontMetrics(param2Font);
/*      */         }
/* 9242 */         Component component = getCurrentComponent();
/* 9243 */         if (component != null) {
/* 9244 */           return component.getFontMetrics(param2Font);
/*      */         }
/* 9246 */         return null;
/*      */       }
/*      */ 
...
/*      */       
/*      */       public boolean isEnabled() {
/* 9257 */         AccessibleContext accessibleContext = getCurrentAccessibleContext();
/* 9258 */         if (accessibleContext instanceof AccessibleComponent) {
/* 9259 */           return ((AccessibleComponent)accessibleContext).isEnabled();
/*      */         }
/* 9261 */         Component component = getCurrentComponent();
/* 9262 */         if (component != null) {
/* 9263 */           return component.isEnabled();
/*      */         }
/* 9265 */         return false;
/*      */       }
/*      */ 
...
/*      */       
/*      */       public void setEnabled(boolean param2Boolean) {
/* 9276 */         AccessibleContext accessibleContext = getCurrentAccessibleContext();
/* 9277 */         if (accessibleContext instanceof AccessibleComponent) {
/* 9278 */           ((AccessibleComponent)accessibleContext).setEnabled(param2Boolean);
/*      */         } else {
/* 9280 */           Component component = getCurrentComponent();
/* 9281 */           if (component != null) {
/* 9282 */             component.setEnabled(param2Boolean);
/*      */           }
/*      */         } 
/*      */       }
/*      */ 
...
/* 9299 */           return ((AccessibleComponent)accessibleContext).isVisible();
/*      */         }
/* 9301 */         Component component = getCurrentComponent();
/* 9302 */         if (component != null) {
/* 9303 */           return component.isVisible();
/*      */         }
/* 9305 */         return false;
/*      */       }
/*      */ 
...
/* 9318 */           ((AccessibleComponent)accessibleContext).setVisible(param2Boolean);
/*      */         } else {
/* 9320 */           Component component = getCurrentComponent();
/* 9321 */           if (component != null) {
/* 9322 */             component.setVisible(param2Boolean);
/*      */           }
/*      */         } 
/*      */       }
/*      */ 
...
/* 9339 */           if (accessibleContext.getAccessibleParent() != null) {
/* 9340 */             return ((AccessibleComponent)accessibleContext).isShowing();
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/*      */         } 
/*      */         
/* 9348 */         Component component = getCurrentComponent();
/* 9349 */         if (component != null) {
/* 9350 */           return component.isShowing();
/*      */         }
/* 9352 */         return false;
/*      */       }
/*      */ 
...
/*      */       
/*      */       public boolean contains(Point param2Point) {
/* 9369 */         AccessibleContext accessibleContext = getCurrentAccessibleContext();
/* 9370 */         if (accessibleContext instanceof AccessibleComponent) {
/* 9371 */           Rectangle rectangle = ((AccessibleComponent)accessibleContext).getBounds();
/* 9372 */           return rectangle.contains(param2Point);
/*      */         } 
/* 9374 */         Component component = getCurrentComponent();
/* 9375 */         if (component != null) {
/* 9376 */           Rectangle rectangle = component.getBounds();
/* 9377 */           return rectangle.contains(param2Point);
/*      */         } 
/* 9379 */         return getBounds().contains(param2Point);
/*      */       }
/*      */ 
/*      */ 
/*      */ 
...
/*      */       
/*      */       public Point getLocationOnScreen() {
/* 9391 */         if (this.parent != null && this.parent.isShowing()) {
/* 9392 */           Point point1 = this.parent.getLocationOnScreen();
/* 9393 */           Point point2 = getLocation();
/* 9394 */           point2.translate(point1.x, point1.y);
/* 9395 */           return point2;
/*      */         } 
/* 9397 */         return null;
/*      */       }
...
/*      */       
/*      */       public Point getLocation() {
/* 9412 */         if (this.parent != null) {
/* 9413 */           Rectangle rectangle = this.parent.getHeaderRect(this.column);
/* 9414 */           if (rectangle != null) {
/* 9415 */             return rectangle.getLocation();
/*      */           }
/*      */         } 
/* 9418 */         return null;
/*      */       }
...
/*      */       
/*      */       public Rectangle getBounds() {
/* 9439 */         if (this.parent != null) {
/* 9440 */           return this.parent.getHeaderRect(this.column);
/*      */         }
/* 9442 */         return null;
/*      */       }
/*      */ 
...
/*      */       
/*      */       public void setBounds(Rectangle param2Rectangle) {
/* 9455 */         AccessibleContext accessibleContext = getCurrentAccessibleContext();
/* 9456 */         if (accessibleContext instanceof AccessibleComponent) {
/* 9457 */           ((AccessibleComponent)accessibleContext).setBounds(param2Rectangle);
/*      */         } else {
/* 9459 */           Component component = getCurrentComponent();
/* 9460 */           if (component != null) {
/* 9461 */             component.setBounds(param2Rectangle);
/*      */           }
/*      */         } 
/*      */       }
/*      */ 
...
/*      */       
/*      */       public Dimension getSize() {
/* 9477 */         if (this.parent != null) {
/* 9478 */           Rectangle rectangle = this.parent.getHeaderRect(this.column);
/* 9479 */           if (rectangle != null) {
/* 9480 */             return rectangle.getSize();
/*      */           }
/*      */         } 
/* 9483 */         return null;
/*      */       }
...
/*      */       
/*      */       public void setSize(Dimension param2Dimension) {
/* 9493 */         AccessibleContext accessibleContext = getCurrentAccessibleContext();
/* 9494 */         if (accessibleContext instanceof AccessibleComponent) {
/* 9495 */           ((AccessibleComponent)accessibleContext).setSize(param2Dimension);
/*      */         } else {
/* 9497 */           Component component = getCurrentComponent();
/* 9498 */           if (component != null) {
/* 9499 */             component.setSize(param2Dimension);
/*      */           }
/*      */         } 
/*      */       }
/*      */ 
...
/*      */       
/*      */       public Accessible getAccessibleAt(Point param2Point) {
/* 9513 */         AccessibleContext accessibleContext = getCurrentAccessibleContext();
/* 9514 */         if (accessibleContext instanceof AccessibleComponent) {
/* 9515 */           return ((AccessibleComponent)accessibleContext).getAccessibleAt(param2Point);
/*      */         }
/* 9517 */         return null;
/*      */       }
/*      */ 
...
/* 9535 */           return ((AccessibleComponent)accessibleContext).isFocusTraversable();
/*      */         }
/* 9537 */         Component component = getCurrentComponent();
/* 9538 */         if (component != null) {
/* 9539 */           return component.isFocusTraversable();
/*      */         }
/* 9541 */         return false;
/*      */       }
/*      */ 
...
/* 9555 */           ((AccessibleComponent)accessibleContext).requestFocus();
/*      */         } else {
/* 9557 */           Component component = getCurrentComponent();
/* 9558 */           if (component != null) {
/* 9559 */             component.requestFocus();
/*      */           }
/*      */         } 
/*      */       }
/*      */ 
...
/*      */       
/*      */       public void addFocusListener(FocusListener param2FocusListener) {
/* 9572 */         AccessibleContext accessibleContext = getCurrentAccessibleContext();
/* 9573 */         if (accessibleContext instanceof AccessibleComponent) {
/* 9574 */           ((AccessibleComponent)accessibleContext).addFocusListener(param2FocusListener);
/*      */         } else {
/* 9576 */           Component component = getCurrentComponent();
/* 9577 */           if (component != null) {
/* 9578 */             component.addFocusListener(param2FocusListener);
/*      */           }
/*      */         } 
/*      */       }
/*      */ 
...
/*      */       
/*      */       public void removeFocusListener(FocusListener param2FocusListener) {
/* 9591 */         AccessibleContext accessibleContext = getCurrentAccessibleContext();
/* 9592 */         if (accessibleContext instanceof AccessibleComponent) {
/* 9593 */           ((AccessibleComponent)accessibleContext).removeFocusListener(param2FocusListener);
/*      */         } else {
/* 9595 */           Component component = getCurrentComponent();
/* 9596 */           if (component != null)
/* 9597 */             component.removeFocusListener(param2FocusListener); 
/*      */         } 
/*      */       }
/*      */     }
/*      */   }
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\javax\swing\JTable.class
