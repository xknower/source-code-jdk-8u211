...
/*      */     } 
/*      */     
/*  471 */     return (String[])hashSet.toArray((Object[])new String[hashSet.size()]);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     }
/*      */     
/* 1304 */     ImageInputStream imageInputStream = createImageInputStream(paramFile);
/* 1305 */     if (imageInputStream == null) {
/* 1306 */       throw new IIOException("Can't create an ImageInputStream!");
/*      */     }
/* 1308 */     BufferedImage bufferedImage = read(imageInputStream);
/* 1309 */     if (bufferedImage == null) {
/* 1310 */       imageInputStream.close();
/*      */     }
/* 1312 */     return bufferedImage;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     }
/*      */     
/* 1351 */     ImageInputStream imageInputStream = createImageInputStream(paramInputStream);
/* 1352 */     BufferedImage bufferedImage = read(imageInputStream);
/* 1353 */     if (bufferedImage == null) {
/* 1354 */       imageInputStream.close();
/*      */     }
/* 1356 */     return bufferedImage;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     }
/*      */     
/* 1391 */     InputStream inputStream = null;
/*      */     try {
/* 1393 */       inputStream = paramURL.openStream();
/* 1394 */     } catch (IOException iOException) {
/* 1395 */       throw new IIOException("Can't get input stream from URL!", iOException);
/*      */     } 
/* 1397 */     ImageInputStream imageInputStream = createImageInputStream(inputStream);
/*      */     
/*      */     try {
/* 1400 */       bufferedImage = read(imageInputStream);
/* 1401 */       if (bufferedImage == null) {
/* 1402 */         imageInputStream.close();
/*      */       }
/*      */     } finally {
/* 1405 */       inputStream.close();
/*      */     } 
/* 1407 */     return bufferedImage;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     }
/*      */     
/* 1438 */     Iterator<ImageReader> iterator = getImageReaders(paramImageInputStream);
/* 1439 */     if (!iterator.hasNext()) {
/* 1440 */       return null;
/*      */     }
/*      */     
/* 1443 */     ImageReader imageReader = iterator.next();
/* 1444 */     ImageReadParam imageReadParam = imageReader.getDefaultReadParam();
/* 1445 */     imageReader.setInput(paramImageInputStream, true, true);
/*      */     
/*      */     try {
/* 1448 */       bufferedImage = imageReader.read(0, imageReadParam);
/*      */     } finally {
/* 1450 */       imageReader.dispose();
/* 1451 */       paramImageInputStream.close();
/*      */     } 
/* 1453 */     return bufferedImage;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     }
/* 1518 */     ImageOutputStream imageOutputStream = null;
/*      */     
/* 1520 */     ImageWriter imageWriter = getWriter(paramRenderedImage, paramString);
/* 1521 */     if (imageWriter == null)
/*      */     {
/*      */ 
/*      */       
/* 1525 */       return false;
...
/* 1530 */       imageOutputStream = createImageOutputStream(paramFile);
/* 1531 */     } catch (IOException iOException) {
/* 1532 */       throw new IIOException("Can't create output stream!", iOException);
/*      */     } 
/*      */     
/*      */     try {
/* 1536 */       return doWrite(paramRenderedImage, imageWriter, imageOutputStream);
/*      */     } finally {
/* 1538 */       imageOutputStream.close();
/*      */     } 
/*      */   }
/*      */ 
/*      */ 
...
/*      */     }
/* 1570 */     ImageOutputStream imageOutputStream = null;
/*      */     try {
/* 1572 */       imageOutputStream = createImageOutputStream(paramOutputStream);
/* 1573 */     } catch (IOException iOException) {
/* 1574 */       throw new IIOException("Can't create output stream!", iOException);
/*      */     } 
/*      */     
/*      */     try {
/* 1578 */       return doWrite(paramRenderedImage, getWriter(paramRenderedImage, paramString), imageOutputStream);
/*      */     } finally {
/* 1580 */       imageOutputStream.close();
/*      */     } 
/*      */   }
/*      */ 
/*      */ 
...
/* 1592 */     ImageTypeSpecifier imageTypeSpecifier = ImageTypeSpecifier.createFromRenderedImage(paramRenderedImage);
/* 1593 */     Iterator<ImageWriter> iterator = getImageWriters(imageTypeSpecifier, paramString);
/*      */     
/* 1595 */     if (iterator.hasNext()) {
/* 1596 */       return iterator.next();
/*      */     }
/* 1598 */     return null;
/*      */   }
/*      */ 
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\javax\imageio\ImageIO.class
