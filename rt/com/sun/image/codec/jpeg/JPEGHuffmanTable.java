...
/* 167 */       throw new IllegalArgumentException("lengths array is too long");  byte b;
/* 168 */     for (b = 1; b < paramArrayOfshort1.length; b++) {
/* 169 */       if (paramArrayOfshort1[b] < 0) {
...
/* 176 */     for (b = 0; b < paramArrayOfshort2.length; b++) {
/* 177 */       if (paramArrayOfshort2[b] < 0) {
...
/* 198 */     int i = 2;
/* 199 */     int j = 0;
/* 200 */     for (byte b = 1; b < this.lengths.length; b++) {
/* 201 */       j += this.lengths[b];
/* 202 */       i -= this.lengths[b];
/* 203 */       i *= 2;
/*     */     } 
/*     */ 
/*     */ 
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\image\codec\jpeg\JPEGHuffmanTable.class
