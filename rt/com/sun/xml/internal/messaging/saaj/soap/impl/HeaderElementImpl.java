...
/*  97 */   public String getRole() { String role = getAttributeValue(getRoleAttributeName());
/*  98 */     return role; }
...
/*     */   public void setParentElement(SOAPElement element) throws SOAPException { if (!(element instanceof javax.xml.soap.SOAPHeader)) { log.severe("SAAJ0130.impl.header.elem.parent.mustbe.header"); throw new SOAPException("Parent of a SOAPHeaderElement has to be a SOAPHeader"); }  super.setParentElement(element); } public void setActor(String actorUri) { try { removeAttribute(getActorAttributeName()); addAttribute(getActorAttributeName(), actorUri); }
/* 103 */     catch (SOAPException sOAPException) {} } public void setRole(String roleUri) throws SOAPException { removeAttribute(getRoleAttributeName()); addAttribute(getRoleAttributeName(), roleUri); } public String getActor() { String actor = getAttributeValue(getActorAttributeName()); return actor; } public void setMustUnderstand(boolean mustUnderstand) { try { removeAttribute(getMustunderstandAttributeName());
/* 104 */       addAttribute(
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\messaging\saaj\soap\impl\HeaderElementImpl.class
