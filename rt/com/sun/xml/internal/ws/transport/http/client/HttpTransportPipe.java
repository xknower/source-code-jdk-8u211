...
/*  96 */     HttpConfigFeature configFeature = binding.<HttpConfigFeature>getFeature(HttpConfigFeature.class);
...
/*     */       
/* 166 */       HttpClientTransport con = getTransport(request, reqHeaders);
...
/*     */         
/* 173 */         ct = this.codec.encode(request, buf);
/*     */         
...
/* 201 */           this.codec.encode(request, buf);
...
/*     */     
/* 261 */     Packet reply = request.createClientResponse((Message)null);
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\ws\transport\http\client\HttpTransportPipe.class
