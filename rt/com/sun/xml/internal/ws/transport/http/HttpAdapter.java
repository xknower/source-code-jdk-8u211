...
/*     */     
/* 258 */     HttpToolkit tk = currentPool.take();
/*     */     try {
...
/* 270 */         HttpMetadataPublisher spi = c.<HttpMetadataPublisher>getSPI(HttpMetadataPublisher.class);
...
/* 283 */       if (!(binding instanceof javax.xml.ws.http.HTTPBinding)) {
/*     */         
...
/* 298 */         return true;
/* 299 */       }  if (!(binding instanceof javax.xml.ws.http.HTTPBinding)) {
...
/* 407 */         Message faultMsg = SOAPFaultBuilder.createSOAPFaultMessage(soapVersion, (CheckedExceptionImpl)null, re);
/* 408 */         packet = packet.createServerResponse(faultMsg, packet.endpoint.getPort(), (SEIModel)null, packet.endpoint.getBinding());
/*     */       } 
/*     */     }
/*     */     
/* 412 */     if (con.isClosed()) {
...
/*     */ 
/*     */     
/* 903 */     Module module = getEndpoint().getContainer().<Module>getSPI(Module.class);
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\ws\transport\http\HttpAdapter.class
