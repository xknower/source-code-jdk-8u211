...
/*     */     }
/*     */     
/* 142 */     ComponentFeature cf = binding.<ComponentFeature>getFeature(ComponentFeature.class);
/* 143 */     if (cf != null) {
...
/*     */       } 
/*     */     }
/* 155 */     ComponentsFeature csf = binding.<ComponentsFeature>getFeature(ComponentsFeature.class);
/* 156 */     if (csf != null) {
...
/*     */     
/* 188 */     this.tubePool = new Pool.TubePool(this.masterTubeline);
/* 189 */     terminalTube.setEndpoint(this);
/* 190 */     this.engine = new Engine(toString(), container);
/* 191 */     this.wsdlProperties = (port == null) ? new WSDLDirectProperties(serviceName, portName, seiModel) : new WSDLPortProperties(port, seiModel);
/*     */     
...
/*     */       } 
/*     */       
/* 205 */       EndpointReferenceExtensionContributor[] eprExtnContributors = ServiceFinder.<EndpointReferenceExtensionContributor>find(EndpointReferenceExtensionContributor.class).toArray();
...
/* 227 */     ServerTubeAssemblerContext ctx = new ServerPipeAssemblerContext(this.seiModel, this.port, this, terminalTube, isSynchronous);
/*     */     
/* 229 */     return ctx;
/*     */   }
/*     */ 
...
/* 252 */     this.context = new ServerPipeAssemblerContext(seiModel, port, this, null, false);
/*     */ 
/*     */     
/* 255 */     this.tubePool = new Pool.TubePool(masterTubeline);
/* 256 */     this.engine = new Engine(toString(), container);
/* 257 */     this.wsdlProperties = (port == null) ? new WSDLDirectProperties(serviceName, portName, seiModel) : new WSDLPortProperties(port, seiModel);
/*     */   }
/*     */   
...
/* 316 */       request.addSatellite(this.wsdlProperties);
/*     */       
...
/*     */       }
/* 323 */       final Tube tube = this.tubePool.take();
/* 324 */       Fiber.CompletionCallback cbak = new Fiber.CompletionCallback() {
/*     */           public void onCompletion(@NotNull Packet response) {
/* 326 */             ThrowableContainerPropertySet tc = response.<ThrowableContainerPropertySet>getSatellite(ThrowableContainerPropertySet.class);
/* 327 */             if (tc == null)
/*     */             {
/*     */               
...
/* 354 */           .isFeatureEnabled((Class)SyncStartForAsyncFeature.class) || !schedule));
/*     */     } finally {
/*     */       
...
/*     */     
/* 372 */     Message faultMessage = SOAPFaultBuilder.createSOAPFaultMessage(soapVersion, (CheckedExceptionImpl)null, tc.getThrowable());
...
/* 399 */             request.addSatellite(WSEndpointImpl.this.wsdlProperties);
/*     */             
...
/*     */ 
/*     */               
/* 411 */               Message faultMsg = SOAPFaultBuilder.createSOAPFaultMessage(WSEndpointImpl.this.soapVersion, (CheckedExceptionImpl)null, re);
/* 412 */               response = request.createServerResponse(faultMsg, request.endpoint
/* 413 */                   .getPort(), (SEIModel)null, request.endpoint
/* 414 */                   .getBinding());
/*     */             } 
/* 416 */             return response;
/*     */           } finally {
...
/* 522 */       return this.component.getSPI(spiType);
/*     */     }
/*     */ 
/*     */     
/*     */     public int hashCode() {
...
/*     */     
/*     */     public <S> S getSPI(Class<S> spiType) {
/* 544 */       return this.component.getSPI(spiType);
/*     */     }
/*     */ 
/*     */     
/*     */     public int hashCode() {
...
/* 580 */     return (new WSEndpointReference(av, address, this.serviceName, this.portName, portType, metadata, wsdlAddress, referenceParameters, this.endpointReferenceExtensions
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\ws\server\WSEndpointImpl.class
