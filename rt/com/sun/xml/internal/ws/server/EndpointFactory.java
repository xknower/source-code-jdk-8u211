...
/* 140 */     EndpointFactory factory = (container != null) ? container.<EndpointFactory>getSPI(EndpointFactory.class) : null;
/* 141 */     if (factory == null) {
...
/*     */     
/* 188 */     if (invoker == null) {
/* 189 */       invoker = InstanceResolver.<T>createDefault(implType).createInvoker();
/*     */     }
/*     */     
...
/*     */       {
/* 272 */         ((SOAPBindingImpl)binding).setPortKnownHeaders(((SOAPSEIModel)seiModel)
/* 273 */             .getKnownHeaders());
/*     */       }
/*     */       
...
/*     */     
/* 301 */     return create(serviceName, portName, binding, container, seiModel, wsdlPort, implType, serviceDefiniton, terminal, isTransportSynchronous, policyMap);
/*     */   }
/*     */ 
/*     */   
...
/*     */     }
/*     */     
/* 421 */     WebServiceProvider wsProvider = metadataReader.<WebServiceProvider>getAnnotation(WebServiceProvider.class, clz);
/* 422 */     WebService ws = metadataReader.<WebService>getAnnotation(WebService.class, clz);
...
/* 458 */     ExternalMetadataFeature ef = binding.<ExternalMetadataFeature>getFeature(ExternalMetadataFeature.class);
/*     */ 
/*     */     
/* 461 */     if (ef != null)
...
/*     */     }
/*     */     
/* 506 */     WebServiceProvider wsProvider = metadataReader.<WebServiceProvider>getAnnotation(WebServiceProvider.class, implType);
...
/*     */     }
/*     */     
/* 541 */     WebServiceProvider wsProvider = metadataReader.<WebServiceProvider>getAnnotation(WebServiceProvider.class, implType);
...
/*     */     }
/*     */     
/* 581 */     WebService ws = metadataReader.<WebService>getAnnotation(WebService.class, implType);
/* 582 */     if (ws != null) {
...
/* 619 */     wsdlGenInfo.setExtensions(ServiceFinder.<WSDLGeneratorExtension>find(WSDLGeneratorExtension.class).toArray());
...
/*     */           
/* 721 */           ServiceFinder.<WSDLParserExtension>find(WSDLParserExtension.class).toArray());
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\ws\server\EndpointFactory.class
