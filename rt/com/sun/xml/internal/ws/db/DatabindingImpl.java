...
/*  97 */       this.operationDispatcherNoWsdl = new OperationDispatcher(null, this.seiModel.getWSBinding(), this.seiModel);
/*     */     }
/*     */     
...
/* 128 */         this.operationDispatcher = (port == null) ? null : new OperationDispatcher(port, this.seiModel.getWSBinding(), this.seiModel);
/*     */       }
/*     */     } 
/*     */   }
/*     */   
/*     */   public SEIModel getModel() {
/* 134 */     return this.seiModel;
/*     */   }
/*     */ 
/*     */   
...
/* 229 */     return this.stubHandlers.get(method);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 248 */     return this.wsdlOpMap.get(wsdlOp);
/*     */   }
/*     */   
/*     */   Codec getCodec() {
...
/* 270 */     return new JavaCallInfo(method, args);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\ws\db\DatabindingImpl.class
