...
/* 123 */     if (this.binding.isFeatureEnabled((Class)AddressingFeature.class))
/* 124 */       return new WsaTubeHelperImpl(this.wsdlPort, null, this.binding); 
/* 125 */     if (this.binding.isFeatureEnabled((Class)MemberSubmissionAddressingFeature.class))
/*     */     {
/* 127 */       return new WsaTubeHelperImpl(this.wsdlPort, null, this.binding);
/*     */     }
/*     */     
...
/* 148 */           .getInvalidMapText() + ", Problem header:" + e.getProblemHeader() + ", Reason: " + e.getSubsubcode(), e);
...
/* 152 */       LOGGER.log(Level.WARNING, this.addressingVersion.getMapRequiredText() + ", Problem header:" + e.getMissingHeaderQName(), e);
...
/* 160 */         return packet.createServerResponse((Message)null, this.wsdlPort, (SEIModel)null, this.binding);
/*     */       }
/*     */       
...
/*     */       }
/*     */       
/* 168 */       return packet.createServerResponse(m, this.wsdlPort, (SEIModel)null, this.binding);
/*     */     } 
/*     */     
/* 171 */     return packet;
/*     */   }
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\ws\addressing\WsaTube.class
