...
/*  99 */       Attribute a = this.attributes.get(i);
...
/* 140 */     return new StreamReaderDelegate(this.infoset.readAsXMLStreamReader()) {
/* 141 */         int state = 0;
/*     */         
...
/* 246 */     this.infoset.writeToXMLStreamWriter(new XMLStreamWriterFilter(w) {
...
/*     */       }
/* 319 */       Element node = (Element)this.infoset.writeTo(header);
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\ws\api\addressing\OutboundReferenceParameterHeader.class
