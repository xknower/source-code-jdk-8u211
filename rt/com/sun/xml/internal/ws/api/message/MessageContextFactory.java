...
/*  67 */     this(new WebServiceFeatureList(wsf));
/*     */   }
/*     */   
/*     */   public MessageContextFactory(WSFeatureList wsf) {
/*  71 */     this.features = wsf;
/*  72 */     this.envelopeStyle = this.features.<EnvelopeStyleFeature>get(EnvelopeStyleFeature.class);
...
/*  75 */       this.features.mergeFeatures(new WebServiceFeature[] { this.envelopeStyle }, false);
/*     */     } 
...
/*     */       } else {
/*  81 */         if (this.soapCodec == null) this.soapCodec = Codecs.createSOAPBindingCodec(this.features); 
...
/* 161 */     MTOMFeature mf = this.features.<MTOMFeature>get(MTOMFeature.class);
/* 162 */     if (mf != null) {
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\ws\api\message\MessageContextFactory.class
