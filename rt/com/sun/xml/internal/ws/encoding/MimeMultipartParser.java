...
/* 108 */       this.root = new PartAttachment((this.start != null) ? this.message.getPart(this.start) : this.message.getPart(0));
/*     */     }
...
/* 149 */       this.attachments.put(contentId, attach);
/*     */     } 
/* 151 */     return attach;
/*     */   }
/*     */   
...
/* 197 */         this
/* 198 */           .streamingDataHandler = (this.buf != null) ? new DataSourceStreamingDataHandler(new ByteArrayDataSource(this.buf, getContentType())) : new MIMEPartStreamingDataHandler(this.part);
/*     */       }
/*     */       
/* 201 */       return this.streamingDataHandler;
/*     */     }
/*     */ 
/*     */     
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\ws\encoding\MimeMultipartParser.class
