...
/*  56 */     this.flavors[0] = new ActivationDataFlavor(StreamSource.class, "text/xml", "XML");
/*  57 */     this.flavors[1] = new ActivationDataFlavor(StreamSource.class, "application/xml", "XML");
/*  58 */     this.flavors[2] = new ActivationDataFlavor(String.class, "text/xml", "XML String");
/*     */   }
/*     */   
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\ws\encoding\XmlDataContentHandler.class
