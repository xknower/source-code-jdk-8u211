...
/*  97 */     return new EndpointImpl((bindingId != null) ? 
...
/* 104 */     return new WSServiceDelegate(wsdlDocumentLocation, serviceName, serviceClass, new WebServiceFeature[0]);
/*     */   }
/*     */ 
/*     */   
...
/* 117 */     return new WSServiceDelegate(wsdlSource, serviceName, serviceClass, new WebServiceFeature[0]);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 124 */     Endpoint endpoint = new EndpointImpl(BindingID.parse(implementor.getClass()), implementor, new WebServiceFeature[0]);
/*     */     
...
/* 131 */     return new EndpointImpl((bindingId != null) ? 
...
/* 138 */     Endpoint endpoint = new EndpointImpl(BindingID.parse(implementor.getClass()), implementor, features);
...
/* 144 */     return new EndpointImpl((bindingId != null) ? 
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\ws\spi\ProviderImpl.class
