...
/*  176 */         readStructure();
/*      */         
/*  178 */         XMLStreamBufferMark mark = new XMLStreamBufferMark(new HashMap<>(this._namespaceAIIsEnd), this);
/*  179 */         next();
/*  180 */         return mark;
/*      */       } 
/*      */       
...
/*      */     
/*  803 */     if (inscope) {
/*  804 */       for (Map.Entry<String, String> e : this._buffer.getInscopeNamespaces().entrySet()) {
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\stream\buffer\stax\StreamReaderBufferProcessor.class
