...
/* 101 */             .readAnnotation((Class)XmlMimeType.class)));
/*     */       
/* 103 */       mt = null;
/*     */     } 
/* 105 */     this.expectedMimeType = mt;
/* 106 */     this.inlineBinary = this.seed.hasAnnotation((Class)XmlInlineBinaryData.class);
/*     */     
...
/* 122 */       if (xjta == null) {
/*     */         
/* 124 */         XmlAttachmentRef xsa = this.seed.<XmlAttachmentRef>readAnnotation(XmlAttachmentRef.class);
/* 125 */         if (xsa != null) {
...
/*     */ 
/*     */           
/* 133 */           xjta = this.seed.<XmlJavaTypeAdapter>readAnnotation(XmlJavaTypeAdapter.class);
/* 134 */           if (xjta != null) {
...
/* 211 */     XmlJavaTypeAdapter jta = this.seed.<XmlJavaTypeAdapter>readAnnotation(XmlJavaTypeAdapter.class);
/* 212 */     if (jta != null && isApplicable(jta, type)) {
/* 213 */       return jta;
/*     */     }
/*     */     
/* 216 */     XmlJavaTypeAdapters jtas = reader().<XmlJavaTypeAdapters>getPackageAnnotation(XmlJavaTypeAdapters.class, this.parent.clazz, this.seed);
/* 217 */     if (jtas != null)
...
/*     */         }
/*     */       }  
/* 223 */     jta = reader().<XmlJavaTypeAdapter>getPackageAnnotation(XmlJavaTypeAdapter.class, this.parent.clazz, this.seed);
...
/* 229 */     if (refType != null) {
/* 230 */       jta = reader().<XmlJavaTypeAdapter>getClassAnnotation(XmlJavaTypeAdapter.class, refType, this.seed);
...
/*     */   
/*     */   private ID calcId() {
/* 256 */     if (this.seed.hasAnnotation((Class)XmlID.class)) {
/*     */       
...
/* 262 */       return ID.ID;
/*     */     } 
/* 264 */     if (this.seed.hasAnnotation((Class)XmlIDREF.class)) {
/* 265 */       return ID.IDREF;
/*     */     }
/* 267 */     return ID.NONE;
/*     */   }
...
/* 350 */       XmlSchema xs = reader().<XmlSchema>getPackageAnnotation(XmlSchema.class, this.parent.getClazz(), this);
/*     */ 
/*     */       
/* 353 */       if (xs != null) {
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\bind\v2\model\impl\PropertyInfoImpl.class
