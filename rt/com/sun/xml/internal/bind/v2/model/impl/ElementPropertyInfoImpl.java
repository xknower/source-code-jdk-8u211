...
/*  63 */         return ((TypeRefImpl<TypeT, ClassDeclT>)ElementPropertyInfoImpl.this.getTypes().get(index)).getTarget();
/*     */       }
/*     */       
/*     */       public int size() {
...
/*     */     
/*  87 */     this.isValueList = this.seed.hasAnnotation((Class)XmlList.class);
/*     */   }
/*     */ 
/*     */   
...
/*     */       
/*  96 */       XmlElement xe = this.seed.<XmlElement>readAnnotation(XmlElement.class);
/*  97 */       XmlElements xes = this.seed.<XmlElements>readAnnotation(XmlElements.class);
/*     */       
...
/* 189 */                       nav().getTypeName((TypeT)ref.getTarget().getType())
/*     */                     }, ), this));
/*     */             break;
/*     */           } 
/*     */         } 
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\bind\v2\model\impl\ElementPropertyInfoImpl.class
