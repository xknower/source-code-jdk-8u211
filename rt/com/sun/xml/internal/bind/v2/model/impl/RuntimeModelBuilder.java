...
/*  77 */     super(annotationReader, Utils.REFLECTION_NAVIGATOR, subclassReplacements, defaultNamespaceRemap);
...
/*     */     }
/* 137 */     if (id == ID.ID) {
/* 138 */       t = new IDTransducerImpl(t);
/*     */     }
/* 140 */     MimeType emt = src.getExpectedMimeType();
/* 141 */     if (emt != null) {
/* 142 */       t = new MimeTypedTransducer(t, emt);
/*     */     }
/* 144 */     if (src.inlineBinaryData()) {
/* 145 */       t = new InlineBinaryTransducer(t);
/*     */     }
...
/*     */       }
/* 151 */       t = new SchemaTypeTransducer(t, src.getSchemaType());
/*     */     } 
/*     */     
/* 154 */     return t;
/*     */   }
...
/* 176 */       return this.core.parse(value);
/*     */     }
/*     */   }
/*     */ }


/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\bind\v2\model\impl\RuntimeModelBuilder.class
