...
/* 442 */         out = new IndentingUTF8XmlOutput(os, this.indent, table, this.escapeHandler);
/*     */       }
/* 444 */       else if (this.c14nSupport) {
/* 445 */         out = new C14nXmlOutput(os, table, this.context.c14nSupport, this.escapeHandler);
/*     */       } else {
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\bind\v2\runtime\MarshallerImpl.class
