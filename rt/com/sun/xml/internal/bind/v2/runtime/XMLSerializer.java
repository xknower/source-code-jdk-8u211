...
/*  246 */     ValidationEvent ve = new ValidationEventImpl(1, t.getMessage(), getCurrentLocation(fieldName), t);
/*  247 */     reportError(ve);
/*      */   }
/*      */   
...
/*  357 */     leafElement(tagName, this.intData, fieldName);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  449 */       reportError((String)null, e);
/*  450 */       return null;
/*      */     } 
/*  452 */     this.idReferencedObjects.add(obj);
/*  453 */     if (id == null) {
/*  454 */       reportError(new NotIdentifiableEventImpl(1, Messages.NOT_IDENTIFIABLE
/*      */             
/*  456 */             .format(new Object[0]), new ValidationEventLocatorImpl(obj)));
/*      */     }
/*      */     
/*  459 */     return id;
/*      */   }
...
/*  508 */               return XMLSerializer.this.marshaller;
/*      */             }
/*      */           });
/*  511 */       if (obj != null) {
/*      */ 
...
/*      */ 
/*      */     
/*  522 */     reportError(new ValidationEventImpl(1, Messages.CYCLE_IN_MARSHALLER
/*      */           
...
/*  648 */             reportError(new ValidationEventImpl(1, Messages.SUBSTITUTED_BY_ANONYMOUS_TYPE
/*      */                   
...
/*      */     
/*  832 */     out.startDocument(this, fragment, this.knownUri2prefixIndexMap, this.nsContext);
/*      */   }
/*      */   
...
/*  991 */         reportError(new NotIdentifiableEventImpl(1, Messages.DANGLING_IDREF
/*      */               
/*  993 */               .format(new Object[] { id }, ), new ValidationEventLocatorImpl(idObj)));
/*      */       }
...
/* 1010 */     return handleEvent(new ValidationEventImpl(1, e
/*      */ 
/*      */           
/* 1013 */           .getMessage(), new ValidationEventLocatorExImpl(source, fieldName), e));
/*      */   }
/*      */ 
/*      */ 
/*      */   
...
/* 1028 */     reportError(new ValidationEventImpl(1, Messages.MISSING_OBJECT
/*      */           
...
/* 1039 */     reportError(new ValidationEventImpl(1, Messages.MISSING_ID
/*      */           
/* 1041 */           .format(new Object[] { obj }, ), new ValidationEventLocatorImpl(obj)));
/*      */   }
/*      */ 
/*      */   
/*      */   public ValidationEventLocator getCurrentLocation(String fieldName) {
/* 1046 */     return new ValidationEventLocatorExImpl(this.cycleDetectionStack.peek(), fieldName);
/*      */   }
/*      */   
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\bind\v2\runtime\XMLSerializer.class
