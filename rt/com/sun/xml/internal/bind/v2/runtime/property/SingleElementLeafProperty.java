...
/*     */     
/*  79 */     this.xacc = TransducedAccessor.get(context, ref);
...
/* 161 */       return false; 
/* 162 */     return this.acc.isAbstractable(declaredTypeClass);
/*     */   }
/*     */   
/*     */   public void buildChildElementUnmarshallers(UnmarshallerChain chain, QNameMap<ChildLoader> handlers) {
/* 166 */     Loader l = new LeafPropertyLoader(this.xacc);
/* 167 */     if (this.defaultValue != null)
/* 168 */       l = new DefaultValueLoaderDecorator(l, this.defaultValue); 
/* 169 */     if (this.nillable || chain.context.allNillable) {
/* 170 */       l = new XsiNilLoader.Single(l, this.acc);
/*     */     }
/*     */     
/* 173 */     if (this.improvedXsiTypeHandling) {
/* 174 */       l = new LeafPropertyXsiLoader(l, this.xacc, this.acc);
/*     */     }
/* 176 */     handlers.put(this.tagName, new ChildLoader(l, null));
/*     */   }
/*     */ 
/*     */   
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\bind\v2\runtime\property\SingleElementLeafProperty.class
