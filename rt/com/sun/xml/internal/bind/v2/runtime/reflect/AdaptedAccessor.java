...
/*  94 */       return coordinator.getAdapter((Class)this.adapter);
/*     */     }
/*  96 */     synchronized (this) {
/*  97 */       if (this.staticAdapter == null)
/*  98 */         this.staticAdapter = ClassFactory.<XmlAdapter<OnWireValueT, InMemValueT>>create((Class)this.adapter); 
/*     */     } 
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\bind\v2\runtime\reflect\AdaptedAccessor.class
