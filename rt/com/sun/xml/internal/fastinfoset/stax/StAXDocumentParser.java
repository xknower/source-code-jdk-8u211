...
/* 1598 */           this._v.otherString.add(new CharArrayString(this._piData));
/*      */         }
/*      */         break;
/*      */       case 2:
...
/*      */       } 
/* 1676 */       ea = BuiltInEncodingAlgorithmFactory.getAlgorithm(this._identifier);
/*      */     } 
/*      */ 
/*      */ 
/*      */     
/* 1681 */     if (ea != null) {
/* 1682 */       algorithmData = ea.decodeFromBytes(this._octetBuffer, this._octetBufferStart, this._octetBufferLength);
/*      */     } else {
/*      */       
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\xml\internal\fastinfoset\stax\StAXDocumentParser.class
