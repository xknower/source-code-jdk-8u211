...
/*     */     } else {
/* 233 */       throw new RuntimeException(XSLMessages.createXPATHMessage("ER_CANNOT_DEAL_XPATH_TYPE", new Object[] {
/*     */               
/* 235 */               Integer.toString(type)
/*     */             }));
/*     */     } 
/*     */     
...
/* 305 */     return execute(xctxt, xctxt
/* 306 */         .getDTMHandleFromNode(contextNode), namespaceContext);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */       
/* 368 */       TransformerException te = new TransformerException(msg, getLocator(), e);
...
/*     */ 
/*     */       
/* 444 */       TransformerException te = new TransformerException(msg, getLocator(), e);
...
/*     */ 
/*     */       
/* 537 */       ehandler.warning(new TransformerException(fmsg, xctxt.getSAXLocator()));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */       
/* 588 */       ehandler.fatalError(new TransformerException(fmsg, xctxt
/* 589 */             .getSAXLocator()));
/*     */     }
/*     */     else {
/*     */       
/* 593 */       SourceLocator slocator = xctxt.getSAXLocator();
/* 594 */       System.out.println(fmsg + "; file " + slocator.getSystemId() + "; line " + slocator
/* 595 */           .getLineNumber() + "; column " + slocator
/* 596 */           .getColumnNumber());
/*     */     } 
/*     */   }
/*     */ 
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\org\apache\xpath\internal\XPath.class
