...
/*     */         
/* 147 */         if (Modifier.isPublic(mods) && Modifier.isStatic(mods) && methods[i]
/* 148 */           .getName().equals(methodName))
/*     */         {
/* 150 */           return true;
/*     */         }
/*     */       }
...
/* 171 */       this
/* 172 */         ._isFunctionAvailable = parser.functionSupported(Util.getLocalName(this._nameOfFunct));
/*     */     } 
...
/* 181 */     return (this._namespaceOfFunct == null || this._namespaceOfFunct
/* 182 */       .equals("") || this._namespaceOfFunct
/* 183 */       .equals("http://xml.apache.org/xalan/xsltc"));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\org\apache\xalan\internal\xsltc\compiler\FunctionAvailableCall.class
