...
/*      */         
/*  333 */         messageMediator = this.contactInfo.createMessageMediator(this.orb, this);
/*  334 */       } else if (this.acceptor != null) {
/*  335 */         messageMediator = this.acceptor.createMessageMediator(this.orb, this);
/*      */       } else {
...
/*      */       }
/*      */       try {
/*  347 */         purgeCalls(this.wrapper.connectionAbort(threadDeath), false, false);
...
/*      */       }
/*      */       
/*  375 */       purgeCalls(this.wrapper.connectionAbort(throwable), true, false);
/*      */ 
/*      */ 
/*      */     
/*      */     }
...
/*      */         
/*  402 */         paramMessageMediator = this.contactInfo.finishCreatingMessageMediator(this.orb, this, paramMessageMediator);
/*  403 */       } else if (this.acceptor != null) {
/*      */         
/*  405 */         paramMessageMediator = this.acceptor.finishCreatingMessageMediator(this.orb, this, paramMessageMediator);
/*      */       } else {
...
/*      */       }
/*      */       try {
/*  417 */         purgeCalls(this.wrapper.connectionAbort(threadDeath), false, false);
...
/*      */       
/*  442 */       purgeCalls(this.wrapper.connectionAbort(throwable), true, false);
/*      */ 
/*      */ 
/*      */     
/*      */     }
...
/*      */ 
/*      */       
/*  474 */       boolean bool = paramCorbaMessageMediator.getProtocolHandler().handleRequest(paramCorbaMessageMediator);
/*      */       
/*  476 */       return bool;
/*      */     }
...
/*      */       }
/*      */       try {
/*  483 */         purgeCalls(this.wrapper.connectionAbort(threadDeath), false, false);
...
/*      */         }
/*      */       } 
/*  504 */       purgeCalls(this.wrapper.connectionAbort(throwable), false, false);
/*      */     }
/*      */     finally {
/*      */       
...
/*      */ 
/*      */         
/*  798 */         purgeCalls(this.wrapper.connectionRebind(), false, true);
/*      */       }
...
/* 1091 */       purgeCalls(cOMM_FAILURE, false, true);
...
/* 1169 */         iNTERNAL.initCause(noSuchWorkQueueException);
/* 1170 */         throw iNTERNAL;
/*      */       } 
/*      */     } else {
...
/*      */ 
/*      */         
/* 1232 */         corbaMessageMediator = finishReadingBits(corbaMessageMediator);
/*      */         
...
/* 1279 */     return this.responseWaitingRoom;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1533 */         ((OutboundConnectionCache)getConnectionCache()).remove(this.contactInfo);
...
/* 1589 */     sendHelper(paramGIOPVersion, cancelRequestMessage);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     
/* 1599 */     paramMessage.write(cDROutputObject);
/*      */     
...
/* 1641 */     return this.cachedCodeBase;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\corba\se\impl\transport\SocketOrChannelConnectionImpl.class
