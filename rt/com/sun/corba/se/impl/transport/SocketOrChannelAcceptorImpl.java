...
/* 238 */         .setAcceptedSocketOptions(this, this.serverSocket, socket);
...
/*     */       }
/*     */       
/* 246 */       SocketOrChannelConnectionImpl socketOrChannelConnectionImpl = new SocketOrChannelConnectionImpl(this.orb, this, socket);
/*     */       
...
/*     */ 
/*     */       
/* 262 */       getConnectionCache().stampTime(socketOrChannelConnectionImpl);
/* 263 */       getConnectionCache().put(this, socketOrChannelConnectionImpl);
/*     */       
...
/* 359 */         taggedProfileTemplate.add((E)alternateIIOPAddressComponent);
/*     */       } 
/*     */     } else {
...
/* 377 */         iIOPProfileTemplate.add((E)IIOPFactories.makeCodeSetsComponent(this.orb));
/* 378 */         iIOPProfileTemplate.add((E)IIOPFactories.makeMaxStreamFormatVersionComponent());
/*     */         
...
/* 384 */               (E)IIOPFactories.makeRequestPartitioningComponent(requestPartitioningPolicy
/* 385 */                 .getValue()));
/*     */         }
/* 387 */         if (paramString != null && paramString != "") {
/* 388 */           iIOPProfileTemplate.add((E)IIOPFactories.makeJavaCodebaseComponent(paramString));
/*     */         }
/* 390 */         if (this.orb.getORBData().isJavaSerializationEnabled()) {
/* 391 */           iIOPProfileTemplate.add(
/* 392 */               (E)IIOPFactories.makeJavaSerializationComponent());
/*     */         }
/*     */       } 
/* 395 */       paramIORTemplate.add((E)iIOPProfileTemplate);
/*     */     } 
/*     */   }
/*     */ 
/*     */   
...
/*     */     
/* 545 */     return new CDRInputObject((ORB)paramBroker, (CorbaConnection)paramMessageMediator
...
/*     */     
/* 556 */     return OutputStreamFactory.newCDROutputObject((ORB)paramBroker, corbaMessageMediator, corbaMessageMediator
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\corba\se\impl\transport\SocketOrChannelAcceptorImpl.class
