...
/*  250 */     doBind(namingContextImpl, paramArrayOfNameComponent, paramNamingContext, false, BindingType.ncontext);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  325 */       doBind(namingContextImpl, paramArrayOfNameComponent, paramNamingContext, true, BindingType.ncontext);
...
/*      */     
/*      */     try {
/* 1053 */       PersistentBindingIterator persistentBindingIterator = new PersistentBindingIterator(this.orb, (Hashtable)this.theHashtable.clone(), biPOA);
/*      */       
/* 1055 */       persistentBindingIterator.list(paramInt, paramBindingListHolder);
/*      */       
/* 1057 */       byte[] arrayOfByte = biPOA.activate_object(persistentBindingIterator);
...
/* 1083 */       arrayOfPolicy[b++] = pOA.create_lifespan_policy(LifespanPolicyValue.TRANSIENT);
/*      */       
/* 1085 */       arrayOfPolicy[b++] = pOA.create_id_assignment_policy(IdAssignmentPolicyValue.SYSTEM_ID);
/*      */       
/* 1087 */       arrayOfPolicy[b++] = pOA.create_servant_retention_policy(ServantRetentionPolicyValue.RETAIN);
/*      */       
