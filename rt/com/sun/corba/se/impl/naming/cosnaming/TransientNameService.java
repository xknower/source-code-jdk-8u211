...
/* 119 */       arrayOfPolicy[b++] = pOA1.create_lifespan_policy(LifespanPolicyValue.TRANSIENT);
/*     */       
/* 121 */       arrayOfPolicy[b++] = pOA1.create_id_assignment_policy(IdAssignmentPolicyValue.SYSTEM_ID);
/*     */       
/* 123 */       arrayOfPolicy[b++] = pOA1.create_servant_retention_policy(ServantRetentionPolicyValue.RETAIN);
/*     */ 
/*     */       
...
/*     */       
/* 132 */       byte[] arrayOfByte = pOA2.activate_object(transientNamingContext);
