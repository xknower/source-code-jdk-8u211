...
/*  70 */       doLog(Level.WARNING, "NAMING.transientNameServerBadPort", arrayOfObject, NamingSystemException.class, bAD_PARAM);
/*     */     } 
/*     */ 
/*     */     
/*  74 */     return bAD_PARAM;
...
/*  98 */       doLog(Level.WARNING, "NAMING.transientNameServerBadHost", arrayOfObject, NamingSystemException.class, bAD_PARAM);
/*     */     } 
/*     */ 
/*     */     
...
/* 126 */       doLog(Level.WARNING, "NAMING.objectIsNull", arrayOfObject, NamingSystemException.class, bAD_PARAM);
/*     */     } 
/*     */ 
/*     */     
...
/* 154 */       doLog(Level.WARNING, "NAMING.insBadAddress", arrayOfObject, NamingSystemException.class, bAD_PARAM);
/*     */     } 
/*     */ 
/*     */     
...
/* 186 */       doLog(Level.WARNING, "NAMING.bindUpdateContextFailed", arrayOfObject, NamingSystemException.class, uNKNOWN);
/*     */     } 
/*     */ 
/*     */     
/* 190 */     return uNKNOWN;
...
/* 214 */       doLog(Level.WARNING, "NAMING.bindFailure", arrayOfObject, NamingSystemException.class, uNKNOWN);
/*     */     } 
/*     */ 
/*     */     
/* 218 */     return uNKNOWN;
...
/* 242 */       doLog(Level.WARNING, "NAMING.resolveConversionFailure", arrayOfObject, NamingSystemException.class, uNKNOWN);
/*     */     } 
/*     */ 
/*     */     
/* 246 */     return uNKNOWN;
...
/* 270 */       doLog(Level.WARNING, "NAMING.resolveFailure", arrayOfObject, NamingSystemException.class, uNKNOWN);
/*     */     } 
/*     */ 
/*     */     
/* 274 */     return uNKNOWN;
...
/* 298 */       doLog(Level.WARNING, "NAMING.unbindFailure", arrayOfObject, NamingSystemException.class, uNKNOWN);
/*     */     } 
/*     */ 
/*     */     
/* 302 */     return uNKNOWN;
...
/* 330 */       doLog(Level.WARNING, "NAMING.transNsCannotCreateInitialNcSys", arrayOfObject, NamingSystemException.class, iNITIALIZE);
/*     */     } 
/*     */ 
/*     */     
...
/* 358 */       doLog(Level.WARNING, "NAMING.transNsCannotCreateInitialNc", arrayOfObject, NamingSystemException.class, iNITIALIZE);
/*     */     } 
/*     */ 
/*     */     
...
/* 390 */       doLog(Level.WARNING, "NAMING.namingCtxRebindAlreadyBound", arrayOfObject, NamingSystemException.class, iNTERNAL);
/*     */     } 
/*     */ 
/*     */     
/* 394 */     return iNTERNAL;
...
/* 418 */       doLog(Level.WARNING, "NAMING.namingCtxRebindctxAlreadyBound", arrayOfObject, NamingSystemException.class, iNTERNAL);
/*     */     } 
/*     */ 
/*     */     
/* 422 */     return iNTERNAL;
...
/* 446 */       doLog(Level.WARNING, "NAMING.namingCtxBadBindingtype", arrayOfObject, NamingSystemException.class, iNTERNAL);
/*     */     } 
/*     */ 
/*     */     
/* 450 */     return iNTERNAL;
...
/* 474 */       doLog(Level.WARNING, "NAMING.namingCtxResolveCannotNarrowToCtx", arrayOfObject, NamingSystemException.class, iNTERNAL);
/*     */     } 
/*     */ 
/*     */     
/* 478 */     return iNTERNAL;
...
/* 502 */       doLog(Level.WARNING, "NAMING.namingCtxBindingIteratorCreate", arrayOfObject, NamingSystemException.class, iNTERNAL);
/*     */     } 
/*     */ 
/*     */     
/* 506 */     return iNTERNAL;
...
/* 530 */       doLog(Level.WARNING, "NAMING.transNcBindAlreadyBound", arrayOfObject, NamingSystemException.class, iNTERNAL);
/*     */     } 
/*     */ 
/*     */     
/* 534 */     return iNTERNAL;
...
/* 558 */       doLog(Level.WARNING, "NAMING.transNcListGotExc", arrayOfObject, NamingSystemException.class, iNTERNAL);
/*     */     } 
/*     */ 
/*     */     
/* 562 */     return iNTERNAL;
...
/* 586 */       doLog(Level.WARNING, "NAMING.transNcNewctxGotExc", arrayOfObject, NamingSystemException.class, iNTERNAL);
/*     */     } 
/*     */ 
/*     */     
/* 590 */     return iNTERNAL;
...
/* 614 */       doLog(Level.WARNING, "NAMING.transNcDestroyGotExc", arrayOfObject, NamingSystemException.class, iNTERNAL);
/*     */     } 
/*     */ 
/*     */     
/* 618 */     return iNTERNAL;
...
/* 642 */       doLog(Level.WARNING, "NAMING.insBadSchemeName", arrayOfObject, NamingSystemException.class, iNTERNAL);
/*     */     } 
/*     */ 
/*     */     
/* 646 */     return iNTERNAL;
...
/* 670 */       doLog(Level.WARNING, "NAMING.insBadSchemeSpecificPart", arrayOfObject, NamingSystemException.class, iNTERNAL);
/*     */     } 
/*     */ 
/*     */     
/* 674 */     return iNTERNAL;
...
/* 698 */       doLog(Level.WARNING, "NAMING.insOther", arrayOfObject, NamingSystemException.class, iNTERNAL);
/*     */     } 
/*     */ 
/*     */     
/* 702 */     return iNTERNAL;
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\corba\se\impl\logging\NamingSystemException.class
