...
/* 222 */     EncapsInputStream encapsInputStream = EncapsInputStreamFactory.newEncapsInputStream(this.orb, paramArrayOfbyte, paramArrayOfbyte.length);
/*     */     
/* 224 */     ObjectKeyTemplate objectKeyTemplate = create(encapsInputStream, this.fullKey, octetSeqHolder);
/* 225 */     if (objectKeyTemplate == null) {
/* 226 */       objectKeyTemplate = new WireObjectKeyTemplate(encapsInputStream, octetSeqHolder);
/*     */     }
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\corba\se\impl\ior\ObjectKeyFactoryImpl.class
