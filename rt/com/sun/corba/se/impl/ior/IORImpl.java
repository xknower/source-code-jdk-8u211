...
/* 149 */     this.iortemps.add((E)paramIORTemplate);
/*     */     
...
/* 159 */     Iterator<E> iterator = paramIORTemplate.iterator();
/*     */     
/* 161 */     while (iterator.hasNext()) {
/*     */       
/* 163 */       TaggedProfileTemplate taggedProfileTemplate = (TaggedProfileTemplate)iterator.next();
/*     */       
/* 165 */       TaggedProfile taggedProfile = taggedProfileTemplate.create(objectKeyTemplate, paramObjectId);
/*     */       
/* 167 */       add((E)taggedProfile);
/*     */     } 
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 180 */     Iterator<E> iterator = paramIORTemplateList.iterator();
/* 181 */     while (iterator.hasNext()) {
/* 182 */       IORTemplate iORTemplate = (IORTemplate)iterator.next();
...
/*     */     
/* 196 */     EncapsulationUtility.readIdentifiableSequence(this, identifiableFactoryFinder, paramInputStream);
/*     */     
/* 198 */     makeImmutable();
/*     */   }
/*     */ 
...
/* 219 */     write(encapsOutputStream);
/* 220 */     StringWriter stringWriter = new StringWriter();
/*     */     try {
/* 222 */       encapsOutputStream.writeTo(new HexOutputStream(stringWriter));
...
/* 260 */     Iterator<E> iterator1 = iterator();
/* 261 */     Iterator<E> iterator2 = paramIOR.iterator();
/* 262 */     while (iterator1.hasNext() && iterator2.hasNext()) {
/* 263 */       TaggedProfile taggedProfile1 = (TaggedProfile)iterator1.next();
/* 264 */       TaggedProfile taggedProfile2 = (TaggedProfile)iterator2.next();
...
/* 278 */     Iterator<E> iterator = iterator();
/* 279 */     ObjectId objectId = null;
/* 280 */     while (iterator.hasNext()) {
/* 281 */       TaggedProfile taggedProfile = (TaggedProfile)iterator.next();
...
/* 297 */         this.iortemps.add((E)iORTemplate);
/*     */       } 
/*     */       
/* 300 */       iORTemplate.add((E)taggedProfileTemplate);
/*     */     } 
/*     */     
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\corba\se\impl\ior\IORImpl.class
