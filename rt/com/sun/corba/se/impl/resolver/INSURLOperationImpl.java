...
/*     */     } 
/* 119 */     EncapsInputStream encapsInputStream = EncapsInputStreamFactory.newEncapsInputStream(this.orb, arrayOfByte, arrayOfByte.length, this.orb
...
/*     */     } else {
/* 166 */       object = getIORUsingCorbaloc(paramCorbalocURL);
/*     */     } 
/*     */     
/* 169 */     return object;
/*     */   }
...
/*     */       else {
/*     */         
/* 189 */         Object object1 = getIORUsingCorbaloc(paramCorbanameURL);
/* 190 */         if (object1 == null) {
/* 191 */           return null;
/*     */         }
/*     */ 
...
/* 256 */       iIOPProfileTemplate1.add((E)alternateIIOPAddressComponent);
/*     */     } 
/*     */ 
/*     */ 
/*     */     
...
/* 264 */       iORTemplate.add((E)iIOPProfileTemplate);
...
/* 285 */       iORTemplate.add((E)iIOPProfileTemplate1);
/*     */     } 
/*     */ 
/*     */     
/* 289 */     iORTemplate.addAll((Collection)arrayList);
/*     */     
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\corba\se\impl\resolver\INSURLOperationImpl.class
