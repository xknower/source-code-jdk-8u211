...
/* 219 */       return new MarshalException(str4, paramSystemException); 
...
/* 222 */       noSuchObjectException.detail = paramSystemException;
/* 223 */       return noSuchObjectException;
/* 224 */     }  if (paramSystemException instanceof org.omg.CORBA.NO_PERMISSION)
/* 225 */       return new AccessException(str4, paramSystemException); 
/* 226 */     if (paramSystemException instanceof org.omg.CORBA.MARSHAL)
/* 227 */       return new MarshalException(str4, paramSystemException); 
...
/* 230 */       noSuchObjectException.detail = paramSystemException;
...
/* 234 */       transactionRequiredException.detail = paramSystemException;
/* 235 */       return transactionRequiredException;
...
/* 238 */       transactionRolledbackException.detail = paramSystemException;
/* 239 */       return transactionRolledbackException;
...
/* 242 */       invalidTransactionException.detail = paramSystemException;
/* 243 */       return invalidTransactionException;
...
/*     */         } 
/* 257 */         notSerializableException.initCause(paramSystemException);
/*     */       } 
/*     */       
...
/* 268 */         Constructor<?> constructor = clazz.getConstructor(arrayOfClass);
/* 269 */         Object[] arrayOfObject = new Object[2];
/* 270 */         arrayOfObject[0] = str4;
/* 271 */         arrayOfObject[1] = paramSystemException;
/* 272 */         return (RemoteException)constructor.newInstance(arrayOfObject);
...
/* 284 */         Constructor<?> constructor = clazz.getConstructor(arrayOfClass);
/* 285 */         Object[] arrayOfObject = new Object[2];
/* 286 */         arrayOfObject[0] = str4;
/* 287 */         arrayOfObject[1] = paramSystemException;
/* 288 */         return (RemoteException)constructor.newInstance(arrayOfObject);
...
/* 300 */         Constructor<?> constructor = clazz.getConstructor(arrayOfClass);
/* 301 */         Object[] arrayOfObject = new Object[2];
/* 302 */         arrayOfObject[0] = str4;
/* 303 */         arrayOfObject[1] = paramSystemException;
/* 304 */         return (RemoteException)constructor.newInstance(arrayOfObject);
...
/*     */ 
/*     */     
/* 312 */     return new RemoteException(str4, paramSystemException);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 410 */         ORBVersionFactory.getNEWER().compareTo((T)oRB.getORBVersion()) > 0)
/*     */       {
...
/*     */       } else {
/*     */         
/* 642 */         bool = delegate.is_local(paramStub);
/*     */       } 
...
/* 739 */         remoteException.initCause(reflectiveCopyException);
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\corba\se\impl\javax\rmi\CORBA\Util.class
