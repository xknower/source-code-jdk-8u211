...
/* 514 */         Class<?> clazz1 = paramUserException.getClass();
/* 515 */         String str1 = clazz1.getName();
/* 516 */         String str2 = str1 + "Helper";
/*     */         
/* 518 */         Class<?> clazz2 = SharedSecrets.getJavaCorbaAccess().loadClass(str2);
/*     */ 
/*     */         
/* 521 */         Class[] arrayOfClass = new Class[2];
/* 522 */         arrayOfClass[0] = Any.class;
/* 523 */         arrayOfClass[1] = clazz1;
/* 524 */         Method method = clazz2.getMethod("insert", arrayOfClass);
/*     */ 
/*     */ 
/*     */         
...
/*     */ 
/*     */         
/* 617 */         ORBUtility.insertSystemException(uNKNOWN, any);
/*     */       } 
...
/* 624 */         ORBUtility.insertSystemException(uNKNOWN, any);
/*     */       } 
/*     */     } 
/*     */ 
/*     */     
...
/*     */       
/* 665 */       serviceContext1.write(encapsOutputStream, GIOPVersion.V1_2);
...
/* 703 */     ServiceContextHelper.write(encapsOutputStream, paramServiceContext);
...
/*     */       }  
/* 719 */     paramServiceContexts.put(unknownServiceContext);
/*     */ 
/*     */     
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\corba\se\impl\interceptors\RequestInfoImpl.class
