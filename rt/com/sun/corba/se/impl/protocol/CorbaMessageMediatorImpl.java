...
/*  453 */           any.read_value(paramInputStream, typeCode);
/*      */           
/*  455 */           return new UnknownUserException(any);
/*      */         } 
/*      */       } 
...
/*  803 */       this
/*      */         
/*  805 */         .inputObject = (CDRInputObject)getConnection().getContactInfo().createInputObject(this.orb, this);
/*  806 */     } else if (getConnection().getAcceptor() != null) {
/*  807 */       this
/*      */         
/*  809 */         .inputObject = (CDRInputObject)getConnection().getAcceptor().createInputObject(this.orb, this);
/*      */     } else {
...
/*  823 */       .responseReceived(this.inputObject);
/*      */   }
/*      */ 
/*      */ 
/*      */   
...
/*      */     try {
/*      */       try {
/* 1033 */         this.messageHeader = this.replyHeader = paramReplyMessage_1_2;
/*      */ 
/*      */         
...
/*      */     try {
/*      */       try {
/* 1197 */         this.messageHeader = paramLocateReplyMessage_1_2;
/*      */ 
/*      */         
...
/* 1269 */           .processFragment(this.dispatchByteBuffer, paramFragmentMessage_1_1);
/*      */         
...
/*      */     try {
/*      */       try {
/* 1296 */         this.messageHeader = paramFragmentMessage_1_2;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */         
/* 1312 */         MessageMediator messageMediator = null;
/* 1313 */         InputObject inputObject = null;
/*      */         
/* 1315 */         if (this.connection.isServer()) {
/*      */           
/* 1317 */           messageMediator = this.connection.serverRequestMapGet(paramFragmentMessage_1_2.getRequestId());
/*      */         } else {
/*      */           
...
/* 1339 */           .getBufferManager().processFragment(this.dispatchByteBuffer, paramFragmentMessage_1_2);
/*      */ 
/*      */ 
/*      */ 
/*      */         
...
/*      */ 
/*      */         
/* 1356 */         setWorkThenReadOrResumeSelect(paramFragmentMessage_1_2);
/*      */       } 
...
/*      */ 
/*      */     
/* 1483 */     MessageMediator messageMediator = this.connection.serverRequestMapGet(paramInt);
/*      */     
/* 1485 */     if (messageMediator == null) {
/*      */       
...
/* 1700 */       corbaServerRequestDispatcher.dispatch(paramCorbaMessageMediator);
/*      */     } finally {
...
/*      */ 
/*      */     
/* 1774 */     CDROutputObject cDROutputObject = createAppropriateOutputObject(paramCorbaMessageMediator, locateRequestMessage, locateReplyMessage);
/*      */     
/* 1776 */     paramCorbaMessageMediator.setOutputObject(cDROutputObject);
/* 1777 */     cDROutputObject.setMessageMediator(paramCorbaMessageMediator);
/*      */     
/* 1779 */     locateReplyMessage.write(cDROutputObject);
/*      */     
/* 1781 */     if (iOR != null) {
/* 1782 */       iOR.write(cDROutputObject);
/*      */     }
/* 1784 */     if (s != -1) {
/* 1785 */       AddressingDispositionHelper.write(cDROutputObject, s);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */ 
/*      */           
/* 1801 */           .getConnection(), paramLocateReplyMessage, (byte)1);
/*      */     
/*      */     }
/*      */     else {
/*      */       
/* 1806 */       cDROutputObject = OutputStreamFactory.newCDROutputObject((ORB)paramCorbaMessageMediator
/* 1807 */           .getBroker(), paramCorbaMessageMediator, paramLocateReplyMessage, (byte)1);
/*      */     } 
/*      */ 
/*      */ 
/*      */     
...
/* 1965 */             .getConnection(), replyMessage, (byte)1);
/*      */ 
/*      */         
/* 1968 */         paramCorbaMessageMediator.setOutputObject(cDROutputObject);
/* 1969 */         cDROutputObject.setMessageMediator(paramCorbaMessageMediator);
/* 1970 */         replyMessage.write(cDROutputObject);
/* 1971 */         AddressingDispositionHelper.write(cDROutputObject, paramAddressingDispositionException
...
/*      */ 
/*      */         
/* 1988 */         cDROutputObject = createAppropriateOutputObject(paramCorbaMessageMediator, paramCorbaMessageMediator
/* 1989 */             .getRequestHeader(), locateReplyMessage);
/*      */         
/* 1991 */         paramCorbaMessageMediator.setOutputObject(cDROutputObject);
/* 1992 */         cDROutputObject.setMessageMediator(paramCorbaMessageMediator);
/* 1993 */         locateReplyMessage.write(cDROutputObject);
/* 1994 */         iOR = null;
/* 1995 */         if (iOR != null) {
/* 1996 */           iOR.write(cDROutputObject);
/*      */         }
/* 1998 */         if (s != -1) {
/* 1999 */           AddressingDispositionHelper.write(cDROutputObject, s);
/*      */         }
/*      */         return;
/*      */     } 
/*      */   }
...
/* 2037 */     UEInfoServiceContext uEInfoServiceContext = new UEInfoServiceContext(uNKNOWN);
/* 2038 */     serviceContexts.put(uEInfoServiceContext);
/* 2039 */     return createSystemExceptionResponse(paramCorbaMessageMediator, uNKNOWN, serviceContexts);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 2093 */           opAndId(paramCorbaMessageMediator), paramSystemException);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/* 2134 */     paramServiceContexts.put(unknownServiceContext);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */       
/* 2206 */       outputObject = OutputStreamFactory.newCDROutputObject(this.orb, paramCorbaMessageMediator, paramCorbaMessageMediator
/* 2207 */           .getReplyHeader(), paramCorbaMessageMediator
/* 2208 */           .getStreamFormatVersion(), 0);
/*      */     }
/*      */     else {
/*      */       
/* 2212 */       outputObject = paramCorbaMessageMediator.getConnection().getAcceptor().createOutputObject(paramCorbaMessageMediator.getBroker(), paramCorbaMessageMediator);
/*      */     } 
...
/*      */       }
/* 2327 */       paramServiceContexts.put(sendingContextServiceContext);
/*      */       
...
/*      */     }
/* 2343 */     paramServiceContexts.put(oRBVersionServiceContext);
/*      */     
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\corba\se\impl\protocol\CorbaMessageMediatorImpl.class
