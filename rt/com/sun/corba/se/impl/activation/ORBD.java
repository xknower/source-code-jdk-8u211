...
/*  76 */       socketOrChannelAcceptorImpl = new SocketOrChannelAcceptorImpl(paramORB, this.initSvcPort, "BOOT_NAMING", "IIOP_CLEAR_TEXT");
/*     */ 
/*     */     
/*     */     }
/*     */     else {
/*     */ 
/*     */       
/*  83 */       socketOrChannelAcceptorImpl = new SocketFactoryAcceptorImpl(paramORB, this.initSvcPort, "BOOT_NAMING", "IIOP_CLEAR_TEXT");
/*     */     } 
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */     
/*  90 */     paramORB.getCorbaTransportManager().registerAcceptor(socketOrChannelAcceptorImpl);
/*     */   }
/*     */ 
/*     */   
...
/*     */ 
/*     */     
/* 282 */     ServerManagerImpl serverManagerImpl = new ServerManagerImpl(paramORB, paramORB.getCorbaTransportManager(), this.repository, getDbDirName(), paramORB.orbdDebugFlag);
/*     */ 
/*     */     
/* 285 */     this.locator = LocatorHelper.narrow(serverManagerImpl);
/* 286 */     paramORB.register_initial_reference("ServerLocator", this.locator);
/*     */     
/* 288 */     this.activator = ActivatorHelper.narrow(serverManagerImpl);
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\corba\se\impl\activation\ORBD.class
