...
/*  66 */     super(paramSnmpEngine, paramSnmpIncomingRequest, paramSnmpMibAgent, paramSnmpPdu);
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */     
/* 333 */     this.nonRepeat = 0;
/*     */     
/* 335 */     this.maxRepeat = 0;
/*     */ 
/*     */ 
/*     */ 
/*     */     
/* 340 */     this.globalR = 0;
/*     */     
/* 342 */     this.size = 0; init(paramSnmpAdaptorServer, paramSnmpPdu, paramInt1, paramInt2, paramInt3); } protected SnmpSubBulkRequestHandler(SnmpAdaptorServer paramSnmpAdaptorServer, SnmpMibAgent paramSnmpMibAgent, SnmpPdu paramSnmpPdu, int paramInt1, int paramInt2, int paramInt3) { super(paramSnmpMibAgent, paramSnmpPdu); this.nonRepeat = 0; this.maxRepeat = 0; this.globalR = 0; this.size = 0;
...
/*     */     SnmpSubRequestHandler.NonSyncVector<SnmpVarBind> nonSyncVector = (SnmpSubRequestHandler.NonSyncVector)this.varBind;
/*     */     for (byte b = 0; b < i; b++) {
...
/*     */     Enumeration<SnmpVarBind> enumeration = this.varBind.elements();
...
/*     */         int k = (b - 1) * this.globalR + this.translation[this.nonRepeat + b1];
/*     */         if (k >= i)
/*     */           return; 
/*     */         if (!enumeration.hasMoreElements())
/*     */           return; 
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\jmx\snmp\daemon\SnmpSubBulkRequestHandler.class
