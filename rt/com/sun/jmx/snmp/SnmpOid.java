...
/*     */   
/*     */   public SnmpOid() {
/* 618 */     this.components = null;
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */     
/* 624 */     this.componentCount = 0; this.components = new long[15]; this.componentCount = 0; } public SnmpOid(long[] paramArrayOflong) { this.components = null; this.componentCount = 0; this.components = (long[])paramArrayOflong.clone(); this.componentCount = this.components.length; } public SnmpOid(long paramLong) { this.components = null; this.componentCount = 0; this.components = new long[1]; this.components[0] = paramLong; this.componentCount = this.components.length; } public SnmpOid(long paramLong1, long paramLong2, long paramLong3, long paramLong4) { this.components = null; this.componentCount = 0; this.components = new long[4]; this.components[0] = paramLong1; this.components[1] = paramLong2; this.components[2] = paramLong3; this.components[3] = paramLong4; this.componentCount = this.components.length; } public SnmpOid(String paramString) throws IllegalArgumentException { this.components = null; this.componentCount = 0; String str = paramString; if (!paramString.startsWith("."))
/*     */       try { str = resolveVarName(paramString); }
/*     */       catch (SnmpStatusException snmpStatusException) { throw new IllegalArgumentException(snmpStatusException.getMessage()); }
/*     */         StringTokenizer stringTokenizer = new StringTokenizer(str, ".", false); this.componentCount = stringTokenizer.countTokens(); if (this.componentCount == 0) { this.components = new long[15]; }
/*     */     else { this.components = new long[this.componentCount]; try { for (byte b = 0; b < this.componentCount; b++) { try {
...
/*     */        }
/* 635 */      } private static SnmpOidTable meta = null;
/*     */   
...
/*     */     for (byte b = 0; b < paramSnmpOid.componentCount; b++)
/*     */       this.components[this.componentCount + b] = paramSnmpOid.components[b]; 
...
/*     */   }
/*     */   
/*     */   public void addToOid(String paramString) throws SnmpStatusException {
/*     */     SnmpOid snmpOid = new SnmpOid(paramString);
/*     */     append(snmpOid);
/*     */   }
/*     */   
/*     */   public void addToOid(long[] paramArrayOflong) throws SnmpStatusException {
...
/*     */           b++; 
/*     */         bool = (b == this.componentCount) ? true : false;
/*     */       } 
/*     */     } 
/*     */     return bool;
/*     */   }
...
/*     */     while (this.componentCount + paramInt > i)
/*     */       i *= 2; 
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\jmx\snmp\SnmpOid.class
