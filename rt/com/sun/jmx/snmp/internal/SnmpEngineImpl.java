...
/*     */ 
/*     */       
/* 137 */       if (this.boot != Integer.MAX_VALUE) {
/* 138 */         this.boot++;
/*     */       }
...
/* 236 */       JmxProperties.SNMP_LOGGER.logp(Level.FINER, SnmpEngineImpl.class.getName(), "SnmpEngineImpl(SnmpEngineFactory,SnmpLcd,InetAddress,int)", "LOCAL ENGINE ID: " + this.engineid + " / LOCAL ENGINE NB BOOTS: " + this.boot + " / LOCAL ENGINE START TIME: " + 
/*     */ 
/*     */ 
/*     */           
/* 240 */           getEngineTime());
...
/* 268 */       JmxProperties.SNMP_LOGGER.logp(Level.FINER, SnmpEngineImpl.class.getName(), "SnmpEngineImpl(SnmpEngineFactory,SnmpLcd,int)", "LOCAL ENGINE ID: " + this.engineid + " / LOCAL ENGINE NB BOOTS: " + this.boot + " / LOCAL ENGINE START TIME: " + 
/*     */ 
/*     */ 
/*     */           
/* 272 */           getEngineTime());
...
/* 298 */       JmxProperties.SNMP_LOGGER.logp(Level.FINER, SnmpEngineImpl.class.getName(), "SnmpEngineImpl(SnmpEngineFactory,SnmpLcd)", "LOCAL ENGINE ID: " + this.engineid + " / LOCAL ENGINE NB BOOTS: " + this.boot + " / LOCAL ENGINE START TIME: " + 
/*     */ 
/*     */ 
/*     */           
/* 302 */           getEngineTime());
...
/* 329 */     if (paramInt < 0 || paramInt == Integer.MAX_VALUE) {
/* 330 */       paramInt = Integer.MAX_VALUE;
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\jmx\snmp\internal\SnmpEngineImpl.class
