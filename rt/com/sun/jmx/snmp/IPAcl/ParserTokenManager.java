...
/*      */       
/*      */       case 0:
/*   37 */         if ((paramLong & 0x8000L) != 0L)
/*   38 */           return 0; 
/*   39 */         if ((paramLong & 0xFE5000L) != 0L) {
/*      */           
/*   41 */           this.jjmatchedKind = 31;
/*   42 */           return 47;
/*      */         } 
/*   44 */         if ((paramLong & 0xD80L) != 0L) {
/*      */           
...
/*   49 */         return -1;
/*      */       case 1:
/*   51 */         if ((paramLong & 0xFE5C00L) != 0L) {
/*      */           
/*   53 */           this.jjmatchedKind = 31;
/*   54 */           this.jjmatchedPos = 1;
/*   55 */           return 49;
/*      */         } 
/*   57 */         if ((paramLong & 0x180L) != 0L) {
/*      */           
...
/*   63 */         return -1;
/*      */       case 2:
/*   65 */         if ((paramLong & 0xFE5C00L) != 0L) {
/*      */           
/*   67 */           this.jjmatchedKind = 31;
/*   68 */           this.jjmatchedPos = 2;
/*   69 */           return 49;
/*      */         } 
/*   71 */         if ((paramLong & 0x100L) != 0L)
/*   72 */           return 49; 
/*   73 */         if ((paramLong & 0x80L) != 0L) {
/*      */           
...
/*   88 */           return 49;
/*      */         } 
/*   90 */         if ((paramLong & 0xA80000L) != 0L)
/*   91 */           return 49; 
/*   92 */         if ((paramLong & 0x80L) != 0L) {
/*      */           
...
/*  101 */         return -1;
/*      */       case 4:
/*  103 */         if ((paramLong & 0xA00000L) != 0L)
/*  104 */           return 51; 
/*  105 */         if ((paramLong & 0x60000L) != 0L) {
/*      */           
...
/*  112 */           return 51;
/*      */         } 
/*  114 */         if ((paramLong & 0x1000L) != 0L)
/*  115 */           return 49; 
/*  116 */         if ((paramLong & 0x504C80L) != 0L) {
/*      */           
...
/*  122 */         return -1;
/*      */       case 5:
/*  124 */         if ((paramLong & 0x500080L) != 0L)
/*  125 */           return 49; 
/*  126 */         if ((paramLong & 0x4C00L) != 0L) {
/*      */           
...
/*  144 */         return -1;
/*      */       case 6:
/*  146 */         if ((paramLong & 0x400000L) != 0L)
/*  147 */           return 51; 
/*  148 */         if ((paramLong & 0x4C00L) != 0L) {
/*      */           
/*  150 */           this.jjmatchedKind = 31;
/*  151 */           this.jjmatchedPos = 6;
/*  152 */           return 49;
/*      */         } 
/*  154 */         if ((paramLong & 0xA60000L) != 0L) {
/*      */           
...
/*  160 */         return -1;
/*      */       case 7:
/*  162 */         if ((paramLong & 0x660000L) != 0L) {
/*      */           
/*  164 */           this.jjmatchedKind = 31;
/*  165 */           this.jjmatchedPos = 7;
/*  166 */           return 51;
/*      */         } 
/*  168 */         if ((paramLong & 0x800000L) != 0L)
/*  169 */           return 51; 
/*  170 */         if ((paramLong & 0x4000L) != 0L)
/*  171 */           return 49; 
/*  172 */         if ((paramLong & 0xC00L) != 0L) {
/*      */           
...
/*  178 */         return -1;
/*      */       case 8:
/*  180 */         if ((paramLong & 0x20000L) != 0L)
/*  181 */           return 51; 
/*  182 */         if ((paramLong & 0xC00L) != 0L) {
/*      */           
/*  184 */           this.jjmatchedKind = 31;
/*  185 */           this.jjmatchedPos = 8;
/*  186 */           return 49;
/*      */         } 
/*  188 */         if ((paramLong & 0x640000L) != 0L) {
/*      */           
...
/*  194 */         return -1;
/*      */       case 9:
/*  196 */         if ((paramLong & 0x40000L) != 0L)
/*  197 */           return 51; 
/*  198 */         if ((paramLong & 0x800L) != 0L)
/*  199 */           return 49; 
/*  200 */         if ((paramLong & 0x600000L) != 0L) {
/*      */           
/*  202 */           this.jjmatchedKind = 31;
/*  203 */           this.jjmatchedPos = 9;
/*  204 */           return 51;
/*      */         } 
/*  206 */         if ((paramLong & 0x400L) != 0L) {
/*      */           
...
/*  212 */         return -1;
/*      */       case 10:
/*  214 */         if ((paramLong & 0x600000L) != 0L) {
/*      */           
/*  216 */           this.jjmatchedKind = 31;
/*  217 */           this.jjmatchedPos = 10;
/*  218 */           return 51;
/*      */         } 
/*  220 */         if ((paramLong & 0x400L) != 0L)
/*  221 */           return 49; 
/*  222 */         return -1;
/*      */       case 11:
/*  224 */         if ((paramLong & 0x600000L) != 0L) {
/*      */           
...
/*  238 */         return -1;
/*      */       case 13:
/*  240 */         if ((paramLong & 0x400000L) != 0L) {
/*      */           
/*  242 */           this.jjmatchedKind = 31;
/*  243 */           this.jjmatchedPos = 13;
/*  244 */           return 51;
/*      */         } 
/*  246 */         if ((paramLong & 0x200000L) != 0L)
/*  247 */           return 51; 
/*  248 */         return -1;
/*      */       case 14:
/*  250 */         if ((paramLong & 0x400000L) != 0L) {
/*      */           
...
/*  276 */     catch (IOException iOException) { return paramInt1 + 1; }
...
/*      */ 
/*      */     
/*  343 */     return jjStartNfa_0(0, paramLong);
/*      */   }
/*      */   
...
/*      */ 
/*      */     
/*  377 */     return jjStartNfa_0(1, paramLong2);
/*      */   }
/*      */   
...
/*      */ 
/*      */     
/*  412 */     return jjStartNfa_0(2, paramLong2);
/*      */   }
/*      */   
...
/*      */       case 'm':
/*  458 */         if ((paramLong2 & 0x100000L) != 0L) {
/*      */           
...
/*      */ 
/*      */     
/*  479 */     return jjStartNfa_0(4, paramLong2);
/*      */   }
/*      */   
...
/*      */ 
/*      */     
/*  539 */     return jjStartNfa_0(6, paramLong2);
/*      */   }
/*      */   
...
/*      */       case 'y':
/*  563 */         if ((paramLong2 & 0x20000L) != 0L) {
/*  564 */           return jjStartNfaWithStates_0(8, 17, 51);
/*      */         }
/*      */         break;
/*      */     } 
/*      */     
/*  569 */     return jjStartNfa_0(7, paramLong2);
/*      */   }
/*      */   
...
/*      */       
/*      */       case 'e':
/*  583 */         if ((paramLong2 & 0x800L) != 0L)
/*  584 */           return jjStartNfaWithStates_0(9, 11, 49); 
/*  585 */         if ((paramLong2 & 0x40000L) != 0L)
...
/*      */       case 'y':
/*  675 */         if ((paramLong2 & 0x200000L) != 0L) {
...
/*      */       
/*      */       case 'y':
/*  713 */         if ((paramLong2 & 0x400000L) != 0L) {
...
/*      */   }
/*  751 */   static final long[] jjbitVec0 = new long[] { 0L, 0L, -1L, -1L };
/*      */ 
/*      */ 
/*      */ 
/*      */   
...
/*  884 */                 if (k > 24)
/*  885 */                   k = 24; 
/*  886 */                 jjCheckNAddTwoStates(12, 13); break;
/*      */               } 
/*  888 */               if (this.curChar == '0') {
/*      */                 
/*  890 */                 if (k > 24)
/*  891 */                   k = 24; 
...
/*  923 */                 this.jjstateSet[this.jjnewStateCnt++] = 3; 
/*      */               break;
/*      */             case 6:
/*  926 */               if (this.curChar == '#')
...
/*  943 */                 this.jjstateSet[this.jjnewStateCnt++] = 9; 
/*      */               break;
/*      */             case 11:
...
/*      */         
/* 1120 */         long l = 1L << (this.curChar & 0x3F);
/*      */         
/*      */         do {
...
/*      */               break;
/*      */             case 13:
/* 1236 */               if ((0x100000001000L & l) != 0L && k > 24)
/* 1237 */                 k = 24; 
/*      */               break;
/*      */             case 15:
...
/*      */       else {
/*      */         
/* 1328 */         int m = (this.curChar & 0xFF) >> 6;
/* 1329 */         long l = 1L << (this.curChar & 0x3F);
/*      */         
/*      */         do {
/* 1332 */           switch (this.jjstateSet[--j]) {
/*      */             
/*      */             case 1:
/* 1335 */               if ((jjbitVec0[m] & l) != 0L)
/* 1336 */                 jjAddStates(21, 23); 
/*      */               break;
/*      */             case 7:
/* 1339 */               if ((jjbitVec0[m] & l) != 0L)
/* 1340 */                 jjAddStates(12, 14); 
/*      */               break;
/*      */             case 15:
/* 1343 */               if ((jjbitVec0[m] & l) != 0L) {
...
/* 1348 */         } while (j != i);
/*      */       } 
/* 1350 */       if (k != Integer.MAX_VALUE) {
/*      */         
/* 1352 */         this.jjmatchedKind = k;
/* 1353 */         this.jjmatchedPos = paramInt2;
/* 1354 */         k = Integer.MAX_VALUE;
/*      */       } 
/* 1356 */       paramInt2++;
/* 1357 */       if ((j = this.jjnewStateCnt) == (i = 47 - (this.jjnewStateCnt = i)))
/* 1358 */         return paramInt2;  
/* 1359 */       try { this.curChar = this.input_stream.readChar(); }
/* 1360 */       catch (IOException iOException) { return paramInt2; }
/*      */     
/*      */     } 
/* 1363 */   } static final int[] jjnextStates = new int[] { 18, 19, 21, 28, 29, 39, 23, 24, 26, 27, 41, 42, 7, 8, 10, 18, 20, 21, 44, 46, 13, 1, 2, 4, 37, 28, 38, 26, 27, 37, 28, 38, 15, 16 };
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 1368 */   public static final String[] jjstrLiteralImages = new String[] { "", null, null, null, null, null, null, "access", "acl", "=", "communities", "enterprise", "hosts", "{", "managers", "-", "}", "read-only", "read-write", "trap", "inform", "trap-community", "inform-community", "trap-num", null, null, null, null, null, null, null, null, null, null, null, null, ",", ".", "!", "/" };
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/* 1377 */   public static final String[] lexStateNames = new String[] { "DEFAULT" };
/*      */ 
/*      */   
/* 1380 */   static final long[] jjtoToken = new long[] { 1067601362817L };
/*      */ 
/*      */   
/* 1383 */   static final long[] jjtoSkip = new long[] { 126L };
/*      */   
...
/* 1412 */     for (byte b = 47; b-- > 0;)
/* 1413 */       this.jjrounds[b] = Integer.MIN_VALUE; 
/*      */   }
/*      */   
...
/* 1430 */     Token token = Token.newToken(this.jjmatchedKind);
/* 1431 */     token.kind = this.jjmatchedKind;
/* 1432 */     String str = jjstrLiteralImages[this.jjmatchedKind];
/* 1433 */     token.image = (str == null) ? this.input_stream.GetImage() : str;
/* 1434 */     token.beginLine = this.input_stream.getBeginLine();
/* 1435 */     token.beginColumn = this.input_stream.getBeginColumn();
/* 1436 */     token.endLine = this.input_stream.getEndLine();
/* 1437 */     token.endColumn = this.input_stream.getEndColumn();
/* 1438 */     return token;
/*      */   }
/*      */   public ParserTokenManager(ASCII_CharStream paramASCII_CharStream) {
/* 1441 */     this.curLexState = 0;
/* 1442 */     this.defaultLexState = 0;
...
/*      */       }
/* 1462 */       catch (IOException iOException) {
/*      */         
...
/*      */ 
/*      */       
/* 1469 */       try { this.input_stream.backup(0);
/* 1470 */         while (this.curChar <= ' ' && (0x100002600L & 1L << this.curChar) != 0L) {
/* 1471 */           this.curChar = this.input_stream.BeginToken();
/*      */         } }
/* 1473 */       catch (IOException iOException) { continue; }
/* 1474 */        this.jjmatchedKind = Integer.MAX_VALUE;
/* 1475 */       this.jjmatchedPos = 0;
/* 1476 */       i = jjMoveStringLiteralDfa0_0();
/* 1477 */       if (this.jjmatchedKind != Integer.MAX_VALUE) {
/*      */         
/* 1479 */         if (this.jjmatchedPos + 1 < i)
/* 1480 */           this.input_stream.backup(i - this.jjmatchedPos - 1); 
/* 1481 */         if ((jjtoToken[this.jjmatchedKind >> 6] & 1L << (this.jjmatchedKind & 0x3F)) != 0L)
/*      */         {
/* 1483 */           return jjFillToken();
/*      */         }
/*      */         
/*      */         continue;
/*      */       } 
...
/* 1494 */     boolean bool = false; try {
/* 1495 */       this.input_stream.readChar(); this.input_stream.backup(1);
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\jmx\snmp\IPAcl\ParserTokenManager.class
