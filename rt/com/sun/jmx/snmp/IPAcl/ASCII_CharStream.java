...
/*     */       
/*  97 */       throw new Error(throwable.getMessage());
/*     */     } 
/*     */ 
/*     */     
...
/*     */       
/* 204 */       this.inBuf--;
/* 205 */       return (char)(0xFF & this.buffer[(this.bufpos == this.bufsize - 1) ? (this.bufpos = 0) : ++this.bufpos]);
/*     */     } 
/*     */     
...
/*     */     } 
/* 290 */     this.prevCharIsLF = this.prevCharIsCR = false;
...
/*     */     } 
/*     */     
/* 371 */     byte b = 0; int k = 0, m = 0;
/* 372 */     int n = 0, i1 = 0;
/*     */     
/* 374 */     while (b < j && this.bufline[k = i % this.bufsize] == this.bufline[m = ++i % this.bufsize]) {
/*     */ 
/*     */       
/* 377 */       this.bufline[k] = paramInt1;
/* 378 */       n = i1 + this.bufcolumn[m] - this.bufcolumn[k];
/* 379 */       this.bufcolumn[k] = paramInt2 + i1;
/* 380 */       i1 = n;
/* 381 */       b++;
/*     */     } 
/*     */     
/* 384 */     if (b < j) {
/*     */       
/* 386 */       this.bufline[k] = paramInt1++;
/* 387 */       this.bufcolumn[k] = paramInt2 + i1;
/*     */       
/* 389 */       while (b++ < j) {
/*     */         
/* 391 */         if (this.bufline[k = i % this.bufsize] != this.bufline[++i % this.bufsize]) {
/* 392 */           this.bufline[k] = paramInt1++; continue;
/*     */         } 
/* 394 */         this.bufline[k] = paramInt1;
/*     */       } 
/*     */     } 
/*     */     
/* 398 */     this.line = this.bufline[k];
/* 399 */     this.column = this.bufcolumn[k];
/*     */   }
/*     */ }


/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\jmx\snmp\IPAcl\ASCII_CharStream.class
