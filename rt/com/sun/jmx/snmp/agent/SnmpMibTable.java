...
/*      */ 
/*      */     
/* 2492 */     this.creationEnabled = false;
/*      */ 
/*      */ 
/*      */ 
/*      */     
/* 2497 */     this.factory = null;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */     
/* 2521 */     this.tablecount = 0;
/* 2522 */     this.tablesize = 16;
/* 2523 */     this.tableoids = new SnmpOid[this.tablesize];
/*      */ 
/*      */ 
/*      */ 
/*      */ 
/*      */     
/* 2529 */     this.entries = new Vector();
/*      */ 
/*      */ 
/*      */ 
/*      */ 
/*      */     
/* 2535 */     this.entrynames = new Vector<>();
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */     
/* 2545 */     this.handbackTable = new Hashtable<>();
/*      */ 
/*      */ 
/*      */ 
/*      */ 
/*      */     
/* 2551 */     this.filterTable = new Hashtable<>();
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */     if (bool)
/*      */       for (Enumeration<SnmpVarBind> enumeration = snmpMibSubRequest.getElements(); enumeration.hasMoreElements(); ) {
...
/*      */   }
/*      */   
/*      */   public void addEntry(SnmpOid paramSnmpOid, Object paramObject) throws SnmpStatusException {
...
/*      */   }
/*      */   
/*      */   public synchronized void removeEntry(SnmpOid paramSnmpOid, Object paramObject) throws SnmpStatusException {
...
/*      */     if (i == -1)
/*      */       return; 
/*      */     removeEntry(i, (Object)null);
/*      */   }
/*      */   
/*      */   public synchronized void removeEntry(int paramInt, Object paramObject) throws SnmpStatusException {
/*      */     if (paramInt == -1)
/*      */       return; 
...
/*      */       objectName = this.entrynames.elementAt(paramInt);
...
/*      */   }
/*      */   
/*      */   public synchronized Object getEntry(SnmpOid paramSnmpOid) throws SnmpStatusException {
/*      */     int i = findObject(paramSnmpOid);
/*      */     if (i == -1)
...
/*      */   }
/*      */   
/*      */   public synchronized ObjectName getEntryName(SnmpOid paramSnmpOid) throws SnmpStatusException {
/*      */     int i = findObject(paramSnmpOid);
/*      */     if (this.entrynames == null)
/*      */       return null; 
/*      */     if (i == -1 || i >= this.entrynames.size())
/*      */       throw new SnmpStatusException(224); 
/*      */     return this.entrynames.elementAt(i);
/*      */   }
/*      */   
...
/*      */     Vector<Object> vector = this.handbackTable.get(paramNotificationListener);
/*      */     Vector<NotificationFilter> vector1 = this.filterTable.get(paramNotificationListener);
/*      */     if (vector == null) {
/*      */       vector = new Vector();
/*      */       vector1 = new Vector();
/*      */       this.handbackTable.put(paramNotificationListener, vector);
/*      */       this.filterTable.put(paramNotificationListener, vector1);
/*      */     } 
/*      */     vector.addElement(paramObject);
/*      */     vector1.addElement(paramNotificationFilter);
/*      */   }
/*      */   
...
/*      */     Vector vector = this.handbackTable.get(paramNotificationListener);
/*      */     if (vector == null)
...
/*      */   }
/*      */   
/*      */   protected SnmpValue setRowStatus(SnmpOid paramSnmpOid, int paramInt, Object paramObject) throws SnmpStatusException {
/*      */     return null;
/*      */   }
/*      */   
/*      */   protected boolean isRowReady(SnmpOid paramSnmpOid, Object paramObject) throws SnmpStatusException {
/*      */     return true;
/*      */   }
/*      */   
...
/*      */   
/*      */   protected void removeTableRow(SnmpMibSubRequest paramSnmpMibSubRequest, SnmpOid paramSnmpOid, int paramInt) throws SnmpStatusException {
/*      */     removeEntry(paramSnmpOid);
/*      */   }
/*      */   
/*      */   protected synchronized void beginRowAction(SnmpMibSubRequest paramSnmpMibSubRequest, SnmpOid paramSnmpOid, int paramInt1, int paramInt2) throws SnmpStatusException {
/*      */     boolean bool = paramSnmpMibSubRequest.isNewEntry();
...
/*      */   
/*      */   protected abstract boolean isReadableEntryId(SnmpOid paramSnmpOid, long paramLong, Object paramObject) throws SnmpStatusException;
/*      */   
...
/*      */   }
/*      */   
/*      */   final synchronized void findHandlingNode(SnmpVarBind paramSnmpVarBind, long[] paramArrayOflong, int paramInt, SnmpRequestTree paramSnmpRequestTree) throws SnmpStatusException {
...
/*      */   }
/*      */   
/*      */   final synchronized long[] findNextHandlingNode(SnmpVarBind paramSnmpVarBind, long[] paramArrayOflong, int paramInt1, int paramInt2, SnmpRequestTree paramSnmpRequestTree, AcmChecker paramAcmChecker) throws SnmpStatusException {
/*      */     SnmpOid snmpOid;
/*      */     int i = paramArrayOflong.length;
/*      */     if (paramSnmpRequestTree == null)
...
/*      */       Vector vector1 = this.handbackTable.get(notificationListener);
/*      */       Vector vector2 = this.filterTable.get(notificationListener);
/*      */       Enumeration<NotificationFilter> enumeration1 = vector2.elements();
/*      */       Enumeration<Object> enumeration2 = vector1.elements();
/*      */       while (enumeration2.hasMoreElements()) {
/*      */         Object object = enumeration2.nextElement();
/*      */         NotificationFilter notificationFilter = enumeration1.nextElement();
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\jmx\snmp\agent\SnmpMibTable.class
