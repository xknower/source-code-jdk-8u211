...
/*      */ {
/*      */   private Hashtable<Object, Handler> hashtable;
...
/* 1079 */     this.hashtable = null;
/*      */     
/* 1081 */     this.request = null;
/* 1082 */     this.version = 0;
/* 1083 */     this.creationflag = false;
/*      */     
/* 1085 */     this.getnextflag = false;
/*      */     
/* 1087 */     this.type = 0;
/*      */     
/* 1089 */     this.setreqflag = false;
...
/*      */     }
/*      */     
/*      */     public int getVarIndex(SnmpVarBind param1SnmpVarBind) {
/*      */       if (param1SnmpVarBind == null)
/*      */         return 0; 
/*      */       return this.global.getVarIndex(param1SnmpVarBind);
/*      */     }
/*      */     
...
/*      */         this.entrylists = (Vector<SnmpVarBind>[])new Vector[10];
...
/*      */         Vector<SnmpVarBind>[] arrayOfVector = this.entrylists;
...
/*      */         this.entrylists = (Vector<SnmpVarBind>[])new Vector[this.entrysize];
...
/*      */       Vector<SnmpVarBind> vector = null;
...
/*      */     }
/*      */     
/*      */     public int getEntryPos(SnmpOid param1SnmpOid) {
/*      */       return SnmpRequestTree.findOid(this.entryoids, this.entrycount, param1SnmpOid);
/*      */     }
/*      */     
/*      */     public SnmpOid getEntryOid(int param1Int) {
/*      */       if (this.entryoids == null)
/*      */         return null; 
/*      */       if (param1Int == -1 || param1Int >= this.entrycount)
/*      */         return null; 
/*      */       return this.entryoids[param1Int];
/*      */     }
/*      */     
/*      */     public boolean isNewEntry(int param1Int) {
/*      */       if (this.entryoids == null)
/*      */         return false; 
/*      */       if (param1Int == -1 || param1Int >= this.entrycount)
/*      */         return false; 
/*      */       return this.isentrynew[param1Int];
/*      */     }
/*      */     
/*      */     public SnmpVarBind getRowStatusVarBind(int param1Int) {
/*      */       if (this.entryoids == null)
/*      */         return null; 
/*      */       if (param1Int == -1 || param1Int >= this.entrycount)
/*      */         return null; 
/*      */       return this.rowstatus[param1Int];
/*      */     }
/*      */     
/*      */     public Vector<SnmpVarBind> getEntrySubList(int param1Int) {
/*      */       if (this.entrylists == null)
/*      */         return null; 
/*      */       if (param1Int == -1 || param1Int >= this.entrycount)
/*      */         return null; 
/*      */       return this.entrylists[param1Int];
/*      */     }
/*      */     
/*      */     public Iterator<SnmpOid> getEntryOids() {
/*      */       if (this.entryoids == null)
/*      */         return null; 
/*      */       return Arrays.<SnmpOid>asList(this.entryoids).iterator();
/*      */     }
/*      */     
...
/*      */   }
/*      */   
/*      */   public void add(SnmpMibNode paramSnmpMibNode, int paramInt, SnmpVarBind paramSnmpVarBind) throws SnmpStatusException {
/*      */     registerNode(paramSnmpMibNode, paramInt, null, paramSnmpVarBind, false, null);
/*      */   }
/*      */   
/*      */   public void add(SnmpMibNode paramSnmpMibNode, int paramInt, SnmpOid paramSnmpOid, SnmpVarBind paramSnmpVarBind, boolean paramBoolean) throws SnmpStatusException {
/*      */     registerNode(paramSnmpMibNode, paramInt, paramSnmpOid, paramSnmpVarBind, paramBoolean, null);
/*      */   }
/*      */   
/*      */   public void add(SnmpMibNode paramSnmpMibNode, int paramInt, SnmpOid paramSnmpOid, SnmpVarBind paramSnmpVarBind1, boolean paramBoolean, SnmpVarBind paramSnmpVarBind2) throws SnmpStatusException {
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\com\sun\jmx\snmp\agent\SnmpRequestTree.class
