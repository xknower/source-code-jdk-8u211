...
/*     */     
/* 268 */     List<Object> list = x509Data.getContent();
...
/* 275 */       Object object = this.content.get(b);
/* 276 */       byte[] arrayOfByte = (byte[])list.get(b);
/* 277 */       if (object instanceof byte[]) {
/* 278 */         if (!(arrayOfByte instanceof byte[]) || 
/* 279 */           !Arrays.equals((byte[])object, arrayOfByte)) {
/* 280 */           return false;
/*     */         }
/*     */       }
/* 283 */       else if (!object.equals(arrayOfByte)) {
/* 284 */         return false;
/*     */       } 
/*     */     } 
/*     */ 
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\org\jcp\xml\dsig\internal\dom\DOMX509Data.class
