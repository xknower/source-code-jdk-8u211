...
/*     */     
/*  78 */     if (paramInt2 <= 0) {
/*  79 */       int j = connect0(i, paramInetAddress, paramInt1);
/*     */     } else {
/*  81 */       configureBlocking(i, false);
/*     */       try {
/*  83 */         int j = connect0(i, paramInetAddress, paramInt1);
/*  84 */         if (j == -2) {
...
/*     */     
/* 147 */     InetSocketAddress inetSocketAddress = arrayOfInetSocketAddress[0];
/* 148 */     paramSocketImpl.port = inetSocketAddress.getPort();
/* 149 */     paramSocketImpl.address = inetSocketAddress.getAddress();
...
/*     */       case 128:
/* 206 */         if (paramBoolean) {
/* 207 */           j = ((Integer)paramObject).intValue(); break;
/*     */         } 
/* 209 */         j = -1;
/*     */         break;
/*     */       
