...
/* 594 */     if (this.declaredAnnotations == null) {
/* 595 */       Executable executable = getRoot();
/* 596 */       if (executable != null) {
/* 597 */         this.declaredAnnotations = executable.declaredAnnotations();
/*     */       } else {
/* 599 */         this.declaredAnnotations = AnnotationParser.parseAnnotations(
...
/*     */       } 
/*     */     } 
/* 606 */     return this.declaredAnnotations;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 635 */         .getConstantPool(getDeclaringClass()), this, 
/*     */         
/* 637 */         getDeclaringClass(), paramType, TypeAnnotation.TypeAnnotationTarget.METHOD_RETURN);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 662 */     if (Modifier.isStatic(getModifiers()))
/* 663 */       return null; 
/* 664 */     return TypeAnnotationParser.buildAnnotatedType(getTypeAnnotationBytes0(), 
/* 665 */         SharedSecrets.getJavaLangAccess()
/* 666 */         .getConstantPool(getDeclaringClass()), this, 
/*     */         
/* 668 */         getDeclaringClass(), 
/* 669 */         getDeclaringClass(), TypeAnnotation.TypeAnnotationTarget.METHOD_RECEIVER);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 689 */         SharedSecrets.getJavaLangAccess()
/* 690 */         .getConstantPool(getDeclaringClass()), this, 
/*     */         
/* 692 */         getDeclaringClass(), 
/* 693 */         getAllGenericParameterTypes(), TypeAnnotation.TypeAnnotationTarget.METHOD_FORMAL_PARAMETER);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 713 */         SharedSecrets.getJavaLangAccess()
/* 714 */         .getConstantPool(getDeclaringClass()), this, 
/*     */         
/* 716 */         getDeclaringClass(), 
/* 717 */         getGenericExceptionTypes(), TypeAnnotation.TypeAnnotationTarget.THROWS);
/*     */   }
/*     */ }


/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\java\lang\reflect\Executable.class
