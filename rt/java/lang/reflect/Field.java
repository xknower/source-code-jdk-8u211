...
/* 1145 */     if (this.declaredAnnotations == null) {
/* 1146 */       Field field = this.root;
/* 1147 */       if (field != null) {
/* 1148 */         this.declaredAnnotations = field.declaredAnnotations();
/*      */       } else {
/* 1150 */         this.declaredAnnotations = AnnotationParser.parseAnnotations(this.annotations, 
/*      */             
/* 1152 */             SharedSecrets.getJavaLangAccess().getConstantPool(getDeclaringClass()), 
/* 1153 */             getDeclaringClass());
/*      */       } 
/*      */     } 
/* 1156 */     return this.declaredAnnotations;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1171 */         SharedSecrets.getJavaLangAccess()
/* 1172 */         .getConstantPool(getDeclaringClass()), this, 
/*      */         
/* 1174 */         getDeclaringClass(), 
/* 1175 */         getGenericType(), TypeAnnotation.TypeAnnotationTarget.FIELD);
/*      */   }
/*      */ }


/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\java\lang\reflect\Field.class
