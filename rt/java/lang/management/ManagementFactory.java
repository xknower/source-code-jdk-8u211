...
/*     */       } 
/*     */       
/* 489 */       HashMap<ObjectName, DynamicMBean> hashMap = ManagementFactoryHelper.getPlatformDynamicMBeans();
/* 490 */       for (Map.Entry<ObjectName, DynamicMBean> entry : hashMap.entrySet()) {
...
/* 666 */       T t = (T)ExtendedPlatformComponent.getMXBean((Class)paramClass);
/* 667 */       if (t != null) {
/* 668 */         return t;
/*     */       }
...
/* 706 */       T t = (T)ExtendedPlatformComponent.getMXBean((Class)paramClass);
/* 707 */       if (t != null) {
/* 708 */         return Collections.singletonList(t);
/*     */       }
...
/* 758 */       PlatformManagedObject platformManagedObject = (PlatformManagedObject)ExtendedPlatformComponent.getMXBean((Class)paramClass);
...
/* 809 */       PlatformManagedObject platformManagedObject = (PlatformManagedObject)ExtendedPlatformComponent.getMXBean((Class)paramClass);
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\java\lang\management\ManagementFactory.class
