...
/* 3521 */     Map<Class<? extends Annotation>, Annotation> map2, map1 = AnnotationParser.parseAnnotations(getRawAnnotations(), getConstantPool(), this);
/* 3522 */     Class<? super T> clazz = getSuperclass();
/* 3523 */     LinkedHashMap<Object, Object> linkedHashMap = null;
/* 3524 */     if (clazz != null) {
/*      */       
...
/* 3530 */           if (linkedHashMap == null) {
/* 3531 */             linkedHashMap = new LinkedHashMap<>((Math.max(map1
/* 3532 */                   .size(), 
/* 3533 */                   Math.min(12, map1.size() + map.size())) * 4 + 2) / 3);
/*      */           }
/*      */ 
/*      */           
/* 3537 */           linkedHashMap.put(clazz1, entry.getValue());
/*      */         } 
/*      */       } 
/*      */     } 
/* 3541 */     if (linkedHashMap == null) {
/*      */       
/* 3543 */       map2 = map1;
/*      */     } else {
/*      */       
...
/* Location:              D:\tools\env\Java\jdk1.8.0_211\rt.jar!\java\lang\Class.class
